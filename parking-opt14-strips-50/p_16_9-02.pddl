(define   (problem parking)
 ...
 (:utility 
    ...
    (= (at-curb-num car_12 curb_3) 3) 
    (= (at-curb-num car_00 curb_5) 5) 
    (= (at-curb-num car_13 curb_6) 4) 
    (= (behind-car car_04 car_00) 4) 
    (= (behind-car car_08 car_11) 1) 
    (= (behind-car car_06 car_00) 2) 
    (= (behind-car car_00 car_00) 4) 
    (= (behind-car car_05 car_08) 1) 
    (= (at-curb-num car_09 curb_0) 2) 
    (= (at-curb-num car_13 curb_5) 1) 
    (= (at-curb-num car_08 curb_7) 5) 
    (= (at-curb-num car_05 curb_4) 5) 
    (= (behind-car car_09 car_04) 3) 
    (= (at-curb-num car_06 curb_2) 3) 
    (= (behind-car car_02 car_10) 3) 
    (= (at-curb-num car_15 curb_1) 5) 
    (= (behind-car car_13 car_09) 2) 
    (= (behind-car car_12 car_10) 1) 
    (= (behind-car car_02 car_09) 1) 
    (= (behind-car car_10 car_14) 4) 
    (= (behind-car car_05 car_04) 4) 
 )
 (:bound 20)
 (:use-cost-metric)
 )
