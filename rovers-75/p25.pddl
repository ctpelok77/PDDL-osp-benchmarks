...
(:init
 ...
 (:utility 
    ...
    (= (have_image rover4 objective4 colour) 5) 
    (= (have_image rover7 objective0 high_res) 2) 
    (= (at rover6 waypoint21) 4) 
    (= (at rover7 waypoint18) 3) 
    (= (empty rover1store) 4) 
    (= (communicated_soil_data waypoint1) 5) 
    (= (at_rock_sample waypoint1) 2) 
    (= (have_rock_analysis rover2 waypoint19) 3) 
    (= (communicated_image_data objective5 high_res) 4) 
    (= (at rover6 waypoint7) 2) 
    (= (have_rock_analysis rover2 waypoint24) 5) 
    (= (communicated_soil_data waypoint23) 3) 
    (= (have_soil_analysis rover2 waypoint11) 1) 
    (= (have_rock_analysis rover9 waypoint19) 5) 
    (= (calibrated camera1 rover5) 1) 
    (= (at rover0 waypoint11) 4) 
    (= (have_soil_analysis rover9 waypoint11) 2) 
    (= (at rover5 waypoint0) 1) 
    (= (communicated_rock_data waypoint5) 1) 
    (= (at rover5 waypoint4) 3) 
    (= (communicated_image_data objective0 low_res) 3) 
    (= (have_rock_analysis rover6 waypoint7) 2) 
    (= (have_rock_analysis rover1 waypoint9) 2) 
    (= (at_rock_sample waypoint14) 3) 
    (= (have_soil_analysis rover8 waypoint17) 4) 
    (= (at rover7 waypoint11) 2) 
    (= (have_rock_analysis rover6 waypoint5) 1) 
    (= (at rover5 waypoint9) 4) 
    (= (at rover6 waypoint12) 1) 
    (= (at rover9 waypoint17) 5) 
    (= (have_rock_analysis rover0 waypoint13) 4) 
 )
 (:bound 22)
 )
