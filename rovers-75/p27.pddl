...
(:init
 ...
 (:utility 
    ...
    (= (at rover3 waypoint0) 2) 
    (= (at rover5 waypoint1) 2) 
    (= (have_image rover8 objective4 colour) 4) 
    (= (have_image rover6 objective5 high_res) 4) 
    (= (at rover8 waypoint32) 2) 
    (= (at rover5 waypoint24) 3) 
    (= (at rover4 waypoint15) 5) 
    (= (at_rock_sample waypoint3) 5) 
    (= (at rover4 waypoint21) 5) 
    (= (at rover3 waypoint16) 4) 
    (= (have_soil_analysis rover7 waypoint27) 3) 
    (= (have_image rover6 objective6 low_res) 3) 
    (= (at rover7 waypoint27) 1) 
    (= (have_rock_analysis rover1 waypoint14) 1) 
    (= (have_soil_analysis rover2 waypoint0) 1) 
    (= (at rover4 waypoint12) 4) 
    (= (at rover0 waypoint29) 5) 
    (= (have_soil_analysis rover2 waypoint24) 3) 
    (= (at rover8 waypoint25) 3) 
    (= (have_image rover8 objective0 low_res) 3) 
    (= (available rover8) 2) 
    (= (at rover5 waypoint16) 1) 
    (= (have_image rover3 objective4 colour) 3) 
    (= (at rover8 waypoint23) 5) 
    (= (have_soil_analysis rover7 waypoint21) 4) 
    (= (communicated_rock_data waypoint3) 5) 
    (= (have_image rover1 objective2 colour) 1) 
    (= (at rover1 waypoint34) 2) 
    (= (at rover0 waypoint21) 5) 
    (= (at rover1 waypoint14) 2) 
    (= (have_soil_analysis rover6 waypoint27) 1) 
    (= (have_image rover4 objective7 colour) 2) 
    (= (at rover5 waypoint32) 1) 
    (= (at rover4 waypoint26) 4) 
    (= (at rover3 waypoint9) 3) 
    (= (at rover7 waypoint17) 1) 
    (= (at rover6 waypoint12) 2) 
    (= (have_soil_analysis rover6 waypoint18) 5) 
 )
 (:bound 69)
 )
