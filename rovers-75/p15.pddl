...
(:init
 ...
 (:utility 
    ...
    (= (empty rover2store) 1) 
    (= (communicated_image_data objective3 high_res) 4) 
    (= (have_image rover1 objective4 colour) 5) 
    (= (have_image rover0 objective0 colour) 3) 
    (= (have_image rover1 objective4 low_res) 1) 
    (= (have_image rover1 objective2 colour) 3) 
    (= (at rover2 waypoint5) 2) 
 )
 (:bound 30)
 )
