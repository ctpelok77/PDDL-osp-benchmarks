...
(:init
 ...
 (:utility 
    ...
    (= (at rover3 waypoint6) 1) 
    (= (have_rock_analysis rover1 waypoint2) 3) 
    (= (at rover0 waypoint10) 4) 
    (= (at rover4 waypoint13) 5) 
    (= (have_image rover2 objective4 high_res) 5) 
    (= (at_soil_sample waypoint3) 1) 
    (= (communicated_soil_data waypoint9) 3) 
    (= (at rover4 waypoint8) 5) 
    (= (have_rock_analysis rover0 waypoint5) 2) 
    (= (at rover2 waypoint17) 2) 
    (= (communicated_image_data objective4 high_res) 5) 
    (= (at rover2 waypoint34) 3) 
    (= (have_rock_analysis rover2 waypoint28) 1) 
    (= (at rover4 waypoint33) 4) 
    (= (at rover3 waypoint30) 4) 
    (= (have_image rover4 objective1 low_res) 5) 
    (= (at rover3 waypoint29) 2) 
    (= (have_soil_analysis rover1 waypoint37) 1) 
    (= (have_image rover1 objective7 high_res) 2) 
    (= (have_soil_analysis rover0 waypoint18) 2) 
    (= (have_rock_analysis rover0 waypoint21) 4) 
    (= (at rover5 waypoint8) 2) 
    (= (at_soil_sample waypoint38) 4) 
    (= (have_image rover2 objective6 colour) 5) 
    (= (at_rock_sample waypoint24) 1) 
    (= (at rover3 waypoint21) 1) 
    (= (at rover5 waypoint39) 4) 
    (= (have_soil_analysis rover1 waypoint14) 3) 
    (= (have_soil_analysis rover4 waypoint38) 3) 
    (= (have_image rover1 objective9 low_res) 3) 
    (= (at rover1 waypoint23) 5) 
 )
 (:bound 50)
 )
