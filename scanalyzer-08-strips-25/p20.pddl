(define (problem scanalyzer3d-42)
 ...
 (:utility 
    ...
    (= (analyzed car-in-7) 10) 
    (= (analyzed car-in-8) 10) 
    (= (analyzed car-in-9) 10) 
    ...
    (= (analyzed car-out-7) 10) 
    (= (analyzed car-out-8) 10) 
    (= (analyzed car-out-9) 10) 
    ...
    (= (on car-in-7 seg-in-7) 10) 
    (= (on car-in-8 seg-in-8) 10) 
    (= (on car-in-9 seg-in-9) 10) 
    ...
    (= (on car-out-7 seg-out-7) 10) 
    (= (on car-out-8 seg-out-8) 10) 
    (= (on car-out-9 seg-out-9) 10) 
    (= (on car-out-8 seg-out-5) 4) 
    (= (on car-in-6 seg-out-6) 5) 
    (= (on car-in-4 seg-out-5) 2) 
    (= (on car-out-8 seg-in-8) 3) 
    (= (on car-out-6 seg-out-2) 3) 
    (= (on car-out-7 seg-in-3) 4) 
    (= (on car-out-5 seg-in-4) 1) 
    (= (on car-out-9 seg-out-5) 1) 
    (= (on car-in-2 seg-in-9) 2) 
    (= (on car-out-4 seg-in-3) 4) 
    (= (on car-out-3 seg-out-4) 3) 
    (= (on car-out-9 seg-out-8) 2) 
    (= (on car-out-9 seg-out-3) 5) 
    (= (on car-out-3 seg-in-4) 5) 
    (= (on car-out-1 seg-out-5) 1) 
 )
 (:bound 21)
 (:use-cost-metric)
 )
