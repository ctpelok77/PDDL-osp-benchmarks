(define 
 ...
 (:utility 
    ...
    (= (cart-pos cart x4 y0) 3) 
    (= (base-obstacle x6 y8) 4) 
    (= (base-obstacle x3 y4) 1) 
    (= (base-pos pr2 x8 y6) 2) 
    (= (base-pos pr2 x0 y5) 2) 
    (= (cart-pos cart x3 y0) 4) 
    (= (gripper-obstacle x7 y8) 3) 
    (= (object-pos object3 x3 y5) 5) 
    (= (base-obstacle x5 y1) 3) 
    (= (cart-pos cart x8 y1) 2) 
    (= (base-obstacle x6 y6) 1) 
    (= (base-pos pr2 x4 y2) 2) 
    (= (base-pos pr2 x8 y4) 5) 
    (= (object-pos object0 x2 y5) 4) 
    (= (cart-pos cart x0 y1) 5) 
    (= (gripper-rel pr2 xrel0 yrel0) 1) 
    (= (cart-pos cart x4 y4) 4) 
    (= (gripper-rel pr2 xrel0 yrel1) 3) 
 )
 (:bound 6)
 )
