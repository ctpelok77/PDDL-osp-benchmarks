(define 
 ...
 (:utility 
    ...
    (= (gripper-obstacle x3 y0) 1) 
    (= (base-obstacle x0 y4) 5) 
    (= (base-obstacle x8 y2) 5) 
    (= (gripper-obstacle x5 y1) 3) 
    (= (cart-pos cart x2 y7) 5) 
    (= (cart-pos cart x0 y4) 4) 
    (= (base-obstacle x5 y0) 1) 
    (= (base-pos pr2 x6 y3) 4) 
    (= (cart-pos cart x0 y8) 2) 
    (= (cart-pos cart x4 y0) 5) 
    (= (base-obstacle x1 y7) 1) 
    (= (object-pos object1 x5 y5) 2) 
    (= (base-obstacle x0 y5) 4) 
    (= (cart-pos cart x5 y8) 3) 
    (= (gripper-obstacle x7 y4) 4) 
    (= (base-pos pr2 x0 y5) 3) 
    (= (cart-pos cart x4 y6) 3) 
    (= (base-pos pr2 x4 y0) 1) 
    (= (not-pushed cart) 2) 
 )
 (:bound 8)
 )
