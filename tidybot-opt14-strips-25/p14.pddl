(define 
 ...
 (:utility 
    ...
    (= (cart-pos cart x7 y1) 4) 
    (= (base-pos pr2 x6 y4) 5) 
    (= (cart-pos cart x7 y0) 2) 
    (= (cart-pos cart x3 y1) 2) 
    (= (gripper-obstacle x8 y2) 5) 
    (= (base-pos pr2 x1 y1) 1) 
    (= (cart-pos cart x6 y5) 3) 
    (= (gripper-obstacle x8 y5) 4) 
    (= (gripper-obstacle x7 y0) 1) 
    (= (base-pos pr2 x8 y4) 4) 
    (= (base-pos pr2 x2 y7) 3) 
    (= (on-cart object0 cart) 3) 
    (= (base-obstacle x4 y0) 3) 
    (= (base-obstacle x8 y4) 2) 
    (= (object-pos object2 x5 y3) 5) 
    (= (base-obstacle x5 y5) 2) 
    (= (gripper-obstacle x3 y2) 5) 
    (= (cart-pos cart x1 y5) 1) 
 )
 (:bound 6)
 )
