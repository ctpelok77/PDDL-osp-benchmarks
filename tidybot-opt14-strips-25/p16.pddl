(define 
 ...
 (:utility 
    ...
    (= (base-pos pr2 x7 y1) 2) 
    (= (object-pos object2 x4 y3) 1) 
    (= (base-obstacle x3 y4) 3) 
    (= (base-pos pr2 x1 y1) 4) 
    (= (object-pos object0 x4 y6) 1) 
    (= (base-pos pr2 x5 y1) 5) 
    (= (gripper-obstacle x0 y8) 4) 
    (= (base-pos pr2 x1 y2) 5) 
    (= (gripper-obstacle x0 y3) 5) 
    (= (base-pos pr2 x7 y0) 2) 
    (= (gripper-obstacle x0 y0) 4) 
    (= (gripper-obstacle x1 y6) 3) 
    (= (base-obstacle x6 y1) 1) 
    (= (base-pos pr2 x5 y8) 3) 
    (= (gripper-obstacle x8 y6) 4) 
    (= (cart-pos cart x4 y6) 3) 
    (= (gripper-obstacle x6 y2) 2) 
    (= (cart-pos cart x7 y3) 1) 
    (= (gripper-obstacle x3 y1) 2) 
 )
 (:bound 10)
 )
