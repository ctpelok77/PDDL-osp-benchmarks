...
(:init
 ...
 (:utility 
    ...
    (= (visited loc-x8-y4) 10) 
    (= (visited loc-x8-y5) 10) 
    (= (visited loc-x8-y7) 10) 
    (= (visited loc-x8-y8) 10) 
    (= (at-robot loc-x3-y0) 2) 
    (= (at-robot loc-x0-y6) 4) 
    (= (at-robot loc-x7-y2) 3) 
    (= (visited loc-x8-y0) 3) 
    (= (at-robot loc-x8-y2) 1) 
    (= (at-robot loc-x6-y0) 2) 
 )
 (:bound 27)
 )
