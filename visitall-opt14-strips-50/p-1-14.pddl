...
(:init
 ...
 (:utility 
    ...
    (= (at-robot loc-x11-y7) 5) 
    (= (at-robot loc-x13-y9) 1) 
    (= (at-robot loc-x6-y5) 2) 
    (= (at-robot loc-x0-y8) 5) 
    (= (at-robot loc-x5-y1) 3) 
    (= (at-robot loc-x8-y1) 2) 
    (= (at-robot loc-x0-y0) 4) 
    (= (at-robot loc-x5-y12) 4) 
    (= (at-robot loc-x2-y2) 1) 
 )
 (:bound 97)
 )
