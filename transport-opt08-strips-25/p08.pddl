...
(define (problem transport-city-sequential-24nodes-1000size-4degree-100mindistance-3trucks-9packages-2008seed)
 ...
 (:utility 
    (= (at package-1 city-loc-12) 10) 
    (= (at package-2 city-loc-7) 10) 
    (= (at package-3 city-loc-1) 10) 
    (= (at package-4 city-loc-6) 10) 
    (= (at package-5 city-loc-9) 10) 
    (= (at package-6 city-loc-14) 10) 
    (= (at package-7 city-loc-14) 10) 
    (= (at package-8 city-loc-9) 10) 
    (= (at package-9 city-loc-4) 10) 
    (= (at package-3 city-loc-22) 4) 
    (= (at truck-2 city-loc-5) 3) 
    (= (at truck-2 city-loc-16) 3) 
    (= (at package-4 city-loc-19) 5) 
    (= (in package-9 truck-2) 4) 
    (= (at package-9 city-loc-9) 2) 
    (= (at truck-2 city-loc-6) 5) 
    (= (at package-8 city-loc-6) 1) 
    (= (at package-1 city-loc-9) 5) 
    (= (at package-6 city-loc-24) 1) 
    (= (at package-4 city-loc-13) 4) 
    (= (at truck-3 city-loc-11) 2) 
    (= (at package-8 city-loc-13) 5) 
    (= (at package-8 city-loc-17) 3) 
    (= (at package-8 city-loc-1) 4) 
    (= (at package-9 city-loc-1) 1) 
 )
 (:bound 246)
 (:use-cost-metric)
 )
