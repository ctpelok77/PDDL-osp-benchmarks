...
(define (problem transport-two-cities-sequential-18nodes-1000size-4degree-100mindistance-3trucks-10packages-2008seed)
 ...
 (:utility 
    (= (at package-1 city-2-loc-3) 10) 
    (= (at package-2 city-2-loc-14) 10) 
    (= (at package-3 city-2-loc-5) 10) 
    (= (at package-4 city-2-loc-4) 10) 
    (= (at package-5 city-2-loc-4) 10) 
    (= (at package-6 city-2-loc-8) 10) 
    (= (at package-7 city-2-loc-1) 10) 
    (= (at package-8 city-2-loc-10) 10) 
    (= (at package-9 city-2-loc-7) 10) 
    (= (at package-10 city-2-loc-8) 10) 
    (= (at package-10 city-2-loc-13) 2) 
    (= (at package-8 city-1-loc-5) 1) 
    (= (at truck-2 city-2-loc-12) 4) 
    (= (at package-10 city-2-loc-17) 3) 
    (= (at package-2 city-2-loc-2) 5) 
    (= (at package-9 city-1-loc-14) 4) 
    (= (at package-4 city-2-loc-9) 2) 
    (= (at truck-1 city-1-loc-9) 4) 
    (= (capacity truck-1 capacity-1) 3) 
    (= (at truck-1 city-2-loc-1) 2) 
    (= (at package-6 city-2-loc-17) 2) 
    (= (at package-1 city-1-loc-15) 3) 
    (= (at package-7 city-2-loc-2) 5) 
    (= (at truck-2 city-2-loc-5) 5) 
    (= (in package-8 truck-2) 1) 
    (= (at package-10 city-1-loc-18) 2) 
    (= (at package-2 city-1-loc-3) 3) 
    (= (at truck-1 city-2-loc-17) 1) 
    (= (at package-2 city-2-loc-7) 5) 
    (= (at package-4 city-2-loc-12) 4) 
    (= (at truck-3 city-1-loc-8) 1) 
    (= (at package-1 city-1-loc-3) 1) 
    (= (at truck-3 city-1-loc-6) 4) 
    (= (in package-7 truck-2) 5) 
    (= (at package-2 city-1-loc-17) 3) 
 )
 (:bound 882)
 (:use-cost-metric)
 )
