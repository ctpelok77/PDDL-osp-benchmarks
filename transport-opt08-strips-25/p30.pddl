...
(define (problem transport-three-cities-sequential-10nodes-1000size-4degree-100mindistance-3trucks-11packages-2008seed)
 ...
 (:utility 
    (= (at package-1 city-3-loc-9) 10) 
    (= (at package-2 city-1-loc-4) 10) 
    (= (at package-3 city-2-loc-5) 10) 
    (= (at package-4 city-3-loc-9) 10) 
    (= (at package-5 city-1-loc-7) 10) 
    (= (at package-6 city-3-loc-7) 10) 
    (= (at package-7 city-2-loc-10) 10) 
    (= (at package-8 city-1-loc-2) 10) 
    (= (at package-9 city-2-loc-7) 10) 
    (= (at package-10 city-3-loc-5) 10) 
    (= (at package-11 city-2-loc-10) 10) 
    (= (at truck-2 city-1-loc-3) 2) 
    (= (at package-2 city-3-loc-2) 4) 
    (= (at package-10 city-3-loc-6) 4) 
    (= (at truck-2 city-3-loc-7) 2) 
    (= (at package-11 city-1-loc-5) 3) 
    (= (at package-5 city-3-loc-4) 5) 
    (= (at truck-1 city-1-loc-5) 4) 
    (= (at package-8 city-1-loc-10) 4) 
    (= (at package-7 city-2-loc-6) 5) 
    (= (at package-3 city-3-loc-1) 3) 
    (= (at package-8 city-3-loc-6) 2) 
    (= (at package-7 city-3-loc-8) 1) 
    (= (at truck-1 city-1-loc-10) 1) 
    (= (at truck-2 city-3-loc-4) 4) 
    (= (at package-7 city-1-loc-8) 5) 
    (= (at truck-2 city-1-loc-9) 3) 
    (= (at package-5 city-3-loc-5) 3) 
    (= (at package-9 city-2-loc-2) 1) 
    (= (capacity truck-2 capacity-3) 2) 
    (= (at package-9 city-1-loc-1) 5) 
    (= (at package-7 city-3-loc-6) 3) 
    (= (at package-10 city-2-loc-1) 2) 
 )
 (:bound 793)
 (:use-cost-metric)
 )
