...
(define (problem transport-two-cities-sequential-7nodes-1000size-4degree-100mindistance-3trucks-8packages-2012seed)
 ...
 (:utility 
    ...
    (= (at package-2 city-2-loc-6) 10) 
    (= (at package-3 city-2-loc-5) 10) 
    (= (at package-4 city-2-loc-5) 10) 
    (= (at package-5 city-2-loc-1) 10) 
    (= (at package-6 city-2-loc-4) 10) 
    (= (at package-7 city-2-loc-7) 10) 
    (= (at package-8 city-2-loc-5) 10) 
    (= (at package-4 city-1-loc-4) 5) 
    (= (at package-1 city-2-loc-6) 4) 
    (= (at truck-3 city-1-loc-6) 4) 
    (= (at truck-1 city-1-loc-2) 5) 
    (= (in package-7 truck-2) 1) 
    (= (at truck-2 city-2-loc-4) 3) 
    (= (in package-2 truck-2) 2) 
    (= (at truck-3 city-1-loc-1) 2) 
    (= (at package-8 city-2-loc-6) 1) 
 )
 (:bound 2575)
 (:use-cost-metric)
 )
