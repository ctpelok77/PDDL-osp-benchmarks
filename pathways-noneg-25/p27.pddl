...
(:init
 ...
 (:utility 
    ...
    (= (goal34) 10) 
    (= (goal35) 10) 
    (= (available prbp1-e2f4-dp12-ge2) 1) 
    (= (available gcdc25a) 3) 
    (= (chosen hdac1) 3) 
    (= (available mdm2-e2f13p1-dp12p1) 5) 
    (= (available raf1-prbp1-e2f4-dp12) 2) 
    (= (available p27-cdk46p1p2-cycd) 2) 
    (= (available pcna-gadd45) 3) 
    (= (available hdac1-p130-e2f4p1-dp12-ge2) 1) 
    (= (available hdac1-p130-e2f4p1-dp12) 1) 
    (= (available p130-e2f4-dp12) 5) 
    (= (available cdk2p1-cyca) 3) 
    (= (available c-myc) 5) 
    (= (available p57-cdk2p2-cycep1) 5) 
    (= (chosen cycb) 4) 
    (= (available cycd) 2) 
    (= (available skp2-cdk2p1-cyca) 2) 
    (= (available mdm2) 1) 
    (= (chosen hdac1-p107-e2f4p1-dp12) 3) 
    (= (chosen apc) 4) 
    (= (available sp1-p107) 4) 
    (= (available p27p1-cdk46p2-cycd) 2) 
    (= (num-subs l1) 4) 
    (= (available e2f13) 1) 
    (= (available p53p1-dp12p1) 5) 
    (= (chosen dp12) 5) 
    (= (available raf1-prbp1-e2f13-dp12p1) 1) 
    (= (chosen gercc1) 3) 
 )
 (:bound 60)
 )
