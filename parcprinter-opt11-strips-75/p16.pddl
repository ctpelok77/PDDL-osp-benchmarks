...
(:init
 ...
 (:utility 
    ...
    (= (hasimage sheet7 front image-4) 2) 
    (= (location sheet10 down_topexit-htmovercolor_entry) 5) 
    (= (hasimage sheet4 front image-10) 4) 
    (= (location sheet4 blackprinter_exit-blackcontainer_entryfromime) 4) 
    (= (hasimage sheet1 front image-2) 3) 
    (= (hasimage sheet7 front image-2) 3) 
    (= (hasimage sheet3 back image-10) 1) 
    (= (location sheet9 htmoverblack_entry-endcap_exit) 5) 
    (= (location sheet1 down_bottomentry-colorfeeder_exit) 3) 
    (= (hasimage sheet6 back image-7) 2) 
    (= (hasimage sheet2 back image-3) 2) 
    (= (hasimage sheet4 front image-8) 1) 
    (= (hasimage sheet9 front image-9) 1) 
    (= (location sheet6 blackprinter_exit-blackcontainer_entryfromime) 2) 
    (= (sideup sheet7 back) 4) 
    (= (hasimage sheet4 back image-2) 5) 
    (= (notprintedwith sheet4 back black) 4) 
    (= (stackedin sheet7 finisher1_tray) 4) 
    (= (notprintedwith sheet1 front black) 3) 
    (= (hasimage sheet1 front image-1) 5) 
    (= (location sheet4 finisher2_entry-finisher1_exit) 2) 
    (= (notprintedwith sheet1 back black) 1) 
    (= (location sheet4 some_feeder_tray) 3) 
 )
 (:bound 1867741)
 (:use-cost-metric)
 )
