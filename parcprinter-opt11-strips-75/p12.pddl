...
(:init
 ...
 (:utility 
    ...
    (= (location sheet4 lbe_entry-lc1_offramp) 1) 
    (= (hasimage sheet1 front image-4) 2) 
    (= (notprintedwith sheet4 back black) 1) 
    (= (available sys-rsrc) 2) 
    (= (location sheet1 uc1_entry-im1_topexit) 3) 
    (= (notprintedwith sheet3 front color) 5) 
    (= (location sheet2 rh1_entry-rh2_exit) 5) 
    (= (location sheet1 im1_bottomexit-lc1_entry) 4) 
 )
 (:bound 765384)
 (:use-cost-metric)
 )
