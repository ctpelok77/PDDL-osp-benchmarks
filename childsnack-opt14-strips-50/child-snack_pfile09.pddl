...
(define (problem prob-snack)
 ...
 (:utility 
    ...
    (= (served child13) 10) 
    (= (served child14) 10) 
    (= (at_kitchen_content content5) 1) 
    (= (ontray sandw12 tray3) 1) 
    (= (no_gluten_sandwich sandw4) 2) 
    (= (ontray sandw13 tray3) 4) 
    (= (at_kitchen_bread bread13) 3) 
    (= (at_kitchen_bread bread5) 5) 
    (= (no_gluten_sandwich sandw6) 2) 
 )
 (:bound 22)
 )
