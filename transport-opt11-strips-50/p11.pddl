...
(define (problem transport-two-cities-sequential-7nodes-1000size-4degree-100mindistance-2trucks-8packages-2012seed)
 ...
 (:utility 
    (= (at package-1 city-2-loc-6) 10) 
    (= (at package-2 city-2-loc-2) 10) 
    (= (at package-3 city-2-loc-4) 10) 
    (= (at package-4 city-2-loc-6) 10) 
    (= (at package-5 city-2-loc-5) 10) 
    (= (at package-6 city-2-loc-5) 10) 
    (= (at package-7 city-2-loc-1) 10) 
    (= (at package-8 city-2-loc-4) 10) 
    (= (capacity truck-1 capacity-4) 1) 
    (= (at package-7 city-1-loc-6) 2) 
    (= (at package-8 city-1-loc-4) 5) 
    (= (at package-8 city-1-loc-5) 4) 
    (= (at package-4 city-2-loc-2) 3) 
    (= (at truck-2 city-2-loc-2) 3) 
    (= (at package-4 city-2-loc-7) 1) 
 )
 (:bound 1635)
 (:use-cost-metric)
 )
