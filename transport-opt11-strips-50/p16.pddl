...
(define (problem transport-three-cities-sequential-5nodes-1000size-4degree-100mindistance-3trucks-9packages-2012seed)
 ...
 (:utility 
    (= (at package-1 city-3-loc-3) 10) 
    (= (at package-2 city-1-loc-4) 10) 
    (= (at package-3 city-2-loc-2) 10) 
    (= (at package-4 city-2-loc-2) 10) 
    (= (at package-5 city-2-loc-3) 10) 
    (= (at package-6 city-3-loc-4) 10) 
    (= (at package-7 city-1-loc-5) 10) 
    (= (at package-8 city-3-loc-4) 10) 
    (= (at package-9 city-1-loc-2) 10) 
    (= (at package-7 city-2-loc-5) 2) 
    (= (at package-5 city-2-loc-4) 1) 
    (= (at package-1 city-1-loc-2) 2) 
    (= (at truck-2 city-2-loc-5) 1) 
    (= (in package-5 truck-1) 4) 
    (= (at package-3 city-1-loc-4) 3) 
    (= (at truck-2 city-3-loc-2) 5) 
    (= (at package-2 city-1-loc-3) 4) 
    (= (at package-3 city-2-loc-3) 3) 
    (= (at package-1 city-1-loc-5) 5) 
 )
 (:bound 1434)
 (:use-cost-metric)
 )
