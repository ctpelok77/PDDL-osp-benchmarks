...
(define (problem transport-city-sequential-15nodes-1000size-3degree-100mindistance-2trucks-6packages-2008seed)
 ...
 (:utility 
    (= (at package-1 city-loc-13) 10) 
    (= (at package-2 city-loc-3) 10) 
    (= (at package-3 city-loc-2) 10) 
    (= (at package-4 city-loc-8) 10) 
    (= (at package-5 city-loc-4) 10) 
    (= (at package-6 city-loc-15) 10) 
    (= (at package-3 city-loc-3) 3) 
    (= (at truck-2 city-loc-8) 1) 
    (= (in package-6 truck-1) 5) 
    (= (in package-2 truck-1) 1) 
    (= (capacity truck-1 capacity-2) 5) 
    (= (at truck-2 city-loc-6) 2) 
 )
 (:bound 166)
 (:use-cost-metric)
 )
