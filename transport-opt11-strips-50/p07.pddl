...
(define (problem transport-city-sequential-13nodes-1000size-2degree-100mindistance-2trucks-6packages-2012seed)
 ...
 (:utility 
    ...
    (= (at package-2 city-loc-3) 10) 
    (= (at package-3 city-loc-8) 10) 
    (= (at package-4 city-loc-6) 10) 
    (= (at package-5 city-loc-1) 10) 
    (= (at package-6 city-loc-4) 10) 
    (= (at truck-2 city-loc-5) 5) 
    (= (at package-4 city-loc-3) 2) 
    (= (capacity truck-2 capacity-4) 1) 
    (= (at package-3 city-loc-6) 4) 
    (= (at package-3 city-loc-13) 4) 
    (= (capacity truck-1 capacity-1) 5) 
 )
 (:bound 141)
 (:use-cost-metric)
 )
