...
(define (problem transport-three-cities-sequential-5nodes-1000size-4degree-100mindistance-2trucks-9packages-2012seed)
 ...
 (:utility 
    (= (at package-1 city-1-loc-5) 10) 
    (= (at package-2 city-2-loc-1) 10) 
    (= (at package-3 city-3-loc-2) 10) 
    (= (at package-4 city-1-loc-3) 10) 
    (= (at package-5 city-1-loc-4) 10) 
    (= (at package-6 city-2-loc-5) 10) 
    (= (at package-7 city-3-loc-1) 10) 
    (= (at package-8 city-3-loc-4) 10) 
    (= (at package-9 city-2-loc-4) 10) 
    (= (at package-9 city-2-loc-3) 1) 
    (= (at truck-2 city-1-loc-2) 2) 
    (= (at package-7 city-1-loc-4) 1) 
    (= (at package-2 city-3-loc-3) 5) 
    (= (in package-6 truck-1) 4) 
    (= (in package-2 truck-1) 5) 
    (= (at package-7 city-1-loc-1) 4) 
    (= (at truck-2 city-2-loc-1) 3) 
