(define   (problem parking)
 ...
 (:utility 
    ...
    (= (at-curb-num car_11 curb_3) 3) 
    (= (car-clear car_10) 5) 
    (= (at-curb-num car_09 curb_3) 4) 
    (= (behind-car car_08 car_07) 2) 
    (= (behind-car car_01 car_06) 5) 
    (= (at-curb-num car_01 curb_6) 4) 
    (= (behind-car car_09 car_05) 1) 
    (= (at-curb-num car_08 curb_6) 2) 
    (= (car-clear car_04) 4) 
    (= (behind-car car_06 car_09) 1) 
    (= (behind-car car_05 car_03) 2) 
    (= (car-clear car_06) 5) 
 )
 (:bound 4)
 (:use-cost-metric)
