...
(define (problem p078-microban-sequential)
 ...
 (:utility 
    ...
    (= (clear pos-06-07) 2) 
    (= (clear pos-04-04) 3) 
    (= (at stone-05 pos-09-06) 1) 
    (= (at stone-05 pos-03-02) 4) 
    (= (at stone-05 pos-05-06) 5) 
    (= (at stone-03 pos-04-04) 5) 
    (= (clear pos-10-01) 2) 
    (= (at stone-02 pos-03-05) 5) 
    (= (at stone-02 pos-05-04) 4) 
    (= (at stone-05 pos-10-06) 3) 
    (= (at stone-05 pos-06-03) 4) 
    (= (at stone-05 pos-03-04) 1) 
 )
 (:bound 24)
 (:use-cost-metric)
 )
