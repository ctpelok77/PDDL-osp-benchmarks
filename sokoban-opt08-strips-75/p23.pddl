...
(define (problem p035-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-04) 10) 
    (= (at-goal stone-05) 10) 
    (= (at stone-04 pos-05-03) 1) 
    (= (clear pos-03-08) 2) 
    (= (at stone-01 pos-05-05) 5) 
    (= (at player-01 pos-04-02) 4) 
    (= (at player-01 pos-03-04) 4) 
    (= (at stone-05 pos-05-03) 5) 
    (= (at stone-05 pos-05-09) 2) 
    (= (at stone-03 pos-04-07) 3) 
    (= (at stone-02 pos-03-07) 3) 
 )
 (:bound 23)
 (:use-cost-metric)
 )
