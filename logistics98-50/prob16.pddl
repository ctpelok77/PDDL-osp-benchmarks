(define (problem strips-log-x-16)
   ...
   (:init (obj package7)
          ...
          (at package1 city7-2))
 (:utility 
    (= (at package7 city5-1) 10) 
    (= (at package6 city5-2) 10) 
    (= (at package5 city2-1) 10) 
    (= (at package4 city5-3) 10) 
    (= (at package3 city5-1) 10) 
    (= (at package2 city5-2) 10) 
    (= (at package1 city4-1) 10) 
    (= (in package1 truck49) 4) 
    (= (at truck34 city8-1) 3) 
    (= (at plane9 city8-3) 2) 
    (= (in package6 truck8) 5) 
    (= (at package4 city2-2) 4) 
    (= (at package1 city6-3) 4) 
    (= (in package4 truck52) 2) 
    (= (at package7 city8-1) 3) 
    (= (in package3 truck13) 2) 
    (= (at truck35 city8-2) 2) 
    (= (at package5 city8-1) 4) 
    (= (at truck41 city7-3) 1) 
    (= (at plane1 city3-3) 3) 
    (= (in package6 truck19) 1) 
    (= (at package1 city3-1) 4) 
    (= (in package3 truck33) 2) 
    (= (at plane8 city10-3) 1) 
    (= (at package1 city3-2) 1) 
    (= (in package5 plane8) 2) 
    (= (at plane6 city6-3) 3) 
    (= (at truck40 city6-2) 1) 
    (= (at package1 city1-1) 4) 
    (= (in package4 truck30) 3) 
    (= (at truck26 city7-2) 5) 
    (= (at plane1 city11-3) 3) 
    (= (at package4 city8-1) 5) 
    (= (at plane7 city6-3) 3) 
    (= (at package6 city9-3) 5) 
    (= (in package3 truck34) 4) 
    (= (at package7 city6-3) 2) 
    (= (at package5 city5-3) 1) 
    (= (at package5 city7-3) 5) 
    (= (in package6 truck28) 1) 
    (= (at plane6 city7-3) 5) 
    (= (in package2 truck9) 2) 
    (= (at truck43 city2-1) 3) 
    (= (in package5 truck27) 5) 
    (= (in package4 truck29) 5) 
    (= (at plane7 city4-3) 2) 
    (= (in package3 plane5) 4) 
    (= (in package4 truck35) 5) 
    (= (at package1 city4-3) 1) 
    (= (at truck1 city5-3) 3) 
    (= (at package2 city3-1) 5) 
    (= (in package7 truck41) 3) 
    (= (in package4 truck42) 2) 
    (= (at truck50 city9-1) 1) 
    (= (at plane11 city8-3) 1) 
 )
 (:bound 28)
 )
