(define (problem strips-log-y-4)
   ...
   (:init (obj package6)
          ...
          (at package1 city4-1))
 (:utility 
    (= (at package6 city1-3) 10) 
    (= (at package5 city5-2) 10) 
    (= (at package4 city3-1) 10) 
    (= (at package3 city4-2) 10) 
    (= (at package2 city2-3) 10) 
    (= (at package1 city2-2) 10) 
    (= (at truck4 city1-3) 4) 
    (= (at package4 city2-1) 3) 
    (= (in package6 truck3) 3) 
    (= (in package6 plane1) 2) 
    (= (at package3 city3-3) 2) 
    (= (in package2 truck12) 2) 
    (= (at package2 city4-3) 3) 
    (= (at truck1 city2-2) 1) 
    (= (at truck4 city1-1) 5) 
    (= (in package1 truck11) 5) 
    (= (at package6 city3-1) 1) 
 )
 (:bound 22)
 )
