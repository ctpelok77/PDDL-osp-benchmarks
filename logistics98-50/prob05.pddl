(define (problem strips-log-x-5)
   ...
   (:init (obj package4)
          ...
          (at package1 city6-2))
 (:utility 
    (= (at package4 city2-2) 10) 
    (= (at package3 city7-2) 10) 
    (= (at package2 city3-1) 10) 
    (= (at package1 city9-2) 10) 
    (= (at package3 city8-2) 3) 
    (= (in package1 plane1) 1) 
    (= (in package1 truck6) 4) 
    (= (in package1 truck4) 2) 
    (= (at package2 city2-1) 1) 
    (= (at package2 city3-2) 5) 
    (= (at package2 city6-2) 5) 
 )
 (:bound 11)
 )
