(define (problem strips-log-x-2)
   ...
   (:init (obj package5)
          ...
          (at package1 city2-2))
 (:utility 
    (= (at package5 city4-2) 10) 
    (= (at package4 city6-1) 10) 
    (= (at package3 city1-1) 10) 
    (= (at package2 city9-2) 10) 
    (= (at package1 city3-1) 10) 
    (= (in package2 truck8) 1) 
    (= (in package3 truck1) 5) 
    (= (in package5 plane3) 5) 
    (= (in package3 plane2) 2) 
    (= (at package3 city4-2) 3) 
    (= (at plane4 city5-2) 2) 
    (= (at package3 city2-2) 4) 
    (= (at package4 city10-2) 3) 
    (= (in package5 truck2) 5) 
    (= (at package5 city9-2) 3) 
    (= (at package5 city6-2) 1) 
 )
 (:bound 16)
 )
