(define (problem strips-log-x-24)
   ...
   (:init (obj package11)
          ...
          (at package1 city8-1))
 (:utility 
    (= (at package11 city8-8) 10) 
    (= (at package10 city3-2) 10) 
    (= (at package9 city1-11) 10) 
    (= (at package8 city3-4) 10) 
    (= (at truck38 city2-1) 2) 
    (= (at package2 city3-10) 4) 
    (= (at truck53 city8-1) 3) 
    (= (at package11 city4-8) 4) 
    (= (at package8 city7-11) 1) 
    (= (in package3 truck12) 2) 
    (= (at package3 city4-6) 5) 
    (= (in package11 truck21) 1) 
    (= (at package7 city7-2) 5) 
    (= (at truck53 city8-11) 5) 
    (= (at truck18 city4-4) 4) 
    (= (at plane2 city2-12) 4) 
    (= (at package1 city3-3) 2) 
    (= (at truck23 city1-10) 5) 
    (= (in package7 truck52) 2) 
    (= (at package9 city3-5) 2) 
    (= (at package2 city7-8) 3) 
    (= (at package10 city8-4) 1) 
    (= (at package8 city7-10) 5) 
    (= (at plane5 city4-12) 5) 
    (= (at package9 city5-1) 2) 
    (= (at package8 city1-10) 5) 
    (= (at package7 city1-7) 4) 
    (= (at package6 city4-9) 3) 
    (= (in package4 truck46) 2) 
    (= (at truck50 city5-2) 3) 
    (= (at package3 city5-10) 3) 
    (= (at package1 city1-8) 2) 
    (= (at package10 city7-9) 1) 
    (= (at truck18 city4-7) 1) 
    (= (in package2 truck39) 3) 
    (= (in package1 truck38) 4) 
    (= (at package5 city2-4) 3) 
    (= (at truck43 city8-6) 1) 
    (= (in package7 truck31) 3) 
    (= (at package11 city2-1) 1) 
    (= (at plane5 city1-12) 4) 
    (= (at truck51 city6-3) 2) 
    (= (at package10 city1-3) 4) 
    (= (in package2 truck30) 3) 
    (= (at package11 city2-9) 5) 
    (= (at truck1 city9-7) 5) 
    (= (at plane7 city9-12) 4) 
    (= (at package5 city3-4) 1) 
    (= (in package7 truck25) 1) 
    (= (at truck50 city5-12) 4) 
    (= (in package2 truck41) 1) 
    (= (at package9 city2-5) 2) 
    (= (at truck28 city3-8) 3) 
    (= (at truck10 city6-2) 3) 
    (= (at package4 city7-7) 5) 
    (= (at package9 city1-1) 1) 
    (= (in package6 truck16) 2) 
    (= (in package6 truck9) 3) 
    (= (in package3 truck47) 2) 
    (= (in package5 truck1) 3) 
    (= (at package1 city4-10) 4) 
    (= (at truck51 city6-8) 5) 
    (= (at package7 city5-5) 4) 
    (= (at package11 city8-6) 5) 
    (= (at package11 city4-5) 5) 
    (= (in package7 truck29) 1) 
    (= (in package3 truck6) 4) 
    (= (in package6 truck19) 5) 
    (= (in package5 truck8) 1) 
    (= (in package8 truck23) 5) 
    (= (at truck7 city4-7) 5) 
    (= (at package6 city8-7) 2) 
    (= (in package2 plane5) 2) 
    (= (at plane1 city8-12) 4) 
    (= (in package4 truck14) 1) 
    (= (at package1 city1-12) 2) 
    (= (at package5 city9-8) 2) 
    (= (at package10 city4-12) 3) 
    (= (at truck20 city8-9) 3) 
    (= (at truck46 city1-12) 1) 
    (= (at package5 city1-10) 1) 
    (= (at package3 city7-12) 1) 
    (= (in package6 truck1) 5) 
    (= (at package11 city4-11) 2) 
    (= (at truck2 city1-5) 1) 
    (= (at truck19 city1-4) 3) 
    (= (at truck53 city8-4) 3) 
    (= (in package9 truck38) 4) 
    (= (in package8 truck43) 3) 
    (= (in package9 truck14) 5) 
    (= (at truck15 city9-8) 3) 
    (= (at truck18 city4-12) 4) 
    (= (at truck41 city6-9) 1) 
    (= (at truck39 city2-12) 5) 
    (= (at package1 city8-10) 2) 
    (= (at truck11 city8-9) 3) 
    (= (at package9 city6-1) 3) 
    (= (at package1 city1-4) 4) 
    (= (at package11 city5-3) 4) 
    (= (at package11 city3-3) 1) 
    (= (at truck42 city3-3) 4) 
    (= (at package10 city7-4) 5) 
    (= (at truck7 city4-1) 2) 
    (= (at package8 city9-10) 2) 
    (= (at package2 city7-5) 2) 
    (= (at truck2 city1-9) 1) 
    (= (at package1 city2-4) 4) 
    (= (at truck26 city3-11) 3) 
    (= (at package8 city4-5) 5) 
    (= (at package6 city7-5) 5) 
    (= (in package10 truck15) 2) 
    (= (at truck24 city1-11) 4) 
    (= (at truck20 city8-11) 2) 
    (= (at package7 city2-8) 4) 
    (= (at package9 city3-1) 5) 
    (= (at package9 city5-4) 2) 
    (= (at package1 city7-9) 4) 
    (= (at package1 city5-8) 3) 
    (= (at package3 city8-10) 1) 
    (= (at package10 city6-2) 5) 
    (= (at truck16 city1-6) 5) 
    (= (in package4 truck48) 3) 
    (= (in package8 truck54) 3) 
    (= (at truck35 city1-11) 4) 
    (= (at package6 city7-6) 4) 
    (= (at truck30 city5-1) 5) 
    (= (at package3 city5-12) 1) 
    (= (at package11 city8-11) 1) 
    (= (at package7 city5-9) 2) 
    (= (at package9 city3-4) 2) 
    (= (in package8 plane6) 3) 
    (= (in package11 truck44) 1) 
    (= (at package4 city7-11) 1) 
 )
 (:bound 20)
 )
