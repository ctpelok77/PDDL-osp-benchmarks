...
(:init
 ...
 (:utility 
    ...
    (= (at rover3 waypoint6) 3) 
    (= (at rover6 waypoint21) 3) 
    (= (have_rock_analysis rover3 waypoint7) 5) 
    (= (have_rock_analysis rover4 waypoint21) 3) 
    (= (at rover2 waypoint23) 2) 
    (= (have_soil_analysis rover3 waypoint24) 4) 
    (= (at rover2 waypoint11) 2) 
    (= (at rover5 waypoint21) 4) 
    (= (full rover2store) 1) 
    (= (have_image rover4 objective2 high_res) 4) 
    (= (have_image rover6 objective6 low_res) 4) 
    (= (at rover3 waypoint10) 2) 
    (= (communicated_image_data objective6 high_res) 3) 
    (= (have_image rover0 objective1 high_res) 1) 
    (= (have_image rover4 objective3 low_res) 5) 
    (= (have_rock_analysis rover4 waypoint22) 1) 
    (= (have_image rover1 objective1 high_res) 5) 
    (= (have_rock_analysis rover4 waypoint18) 2) 
    (= (at rover3 waypoint3) 1) 
    (= (available rover6) 3) 
    (= (have_rock_analysis rover2 waypoint18) 5) 
    (= (at rover2 waypoint12) 1) 
    (= (have_image rover5 objective5 high_res) 4) 
 )
 (:bound 87)
 )
