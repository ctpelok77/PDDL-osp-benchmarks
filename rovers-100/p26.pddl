...
(:init
 ...
 (:utility 
    ...
    (= (have_rock_analysis rover6 waypoint14) 4) 
    (= (at rover4 waypoint6) 2) 
    (= (have_image rover9 objective4 low_res) 1) 
    (= (at rover1 waypoint1) 2) 
    (= (at rover5 waypoint3) 4) 
    (= (have_image rover1 objective3 high_res) 2) 
    (= (at rover7 waypoint4) 5) 
    (= (at rover9 waypoint13) 5) 
    (= (at_rock_sample waypoint9) 3) 
    (= (available rover7) 5) 
    (= (full rover6store) 3) 
    (= (at rover9 waypoint26) 1) 
    (= (at rover6 waypoint13) 1) 
    (= (have_rock_analysis rover4 waypoint3) 1) 
    (= (at rover4 waypoint12) 2) 
    (= (at rover9 waypoint6) 5) 
    (= (at rover5 waypoint0) 5) 
    (= (have_soil_analysis rover6 waypoint21) 4) 
    (= (have_image rover4 objective4 high_res) 5) 
    (= (have_image rover7 objective1 high_res) 1) 
    (= (at rover5 waypoint19) 4) 
    (= (have_rock_analysis rover7 waypoint24) 3) 
    (= (have_rock_analysis rover3 waypoint15) 3) 
    (= (have_rock_analysis rover2 waypoint25) 3) 
    (= (at_rock_sample waypoint26) 4) 
    (= (have_rock_analysis rover6 waypoint3) 2) 
    (= (communicated_rock_data waypoint12) 3) 
    (= (have_image rover5 objective3 high_res) 5) 
    (= (at rover4 waypoint2) 1) 
    (= (at rover0 waypoint0) 2) 
    (= (at rover6 waypoint14) 4) 
 )
 (:bound 59)
 )
