...
(:init
 ...
 (:utility 
    ...
    (= (have_image rover5 objective4 colour) 4) 
    (= (at rover7 waypoint19) 4) 
    (= (have_image rover2 objective3 colour) 5) 
    (= (available rover3) 2) 
    (= (at rover4 waypoint13) 4) 
    (= (at rover4 waypoint11) 5) 
    (= (at rover6 waypoint23) 1) 
    (= (have_soil_analysis rover7 waypoint36) 2) 
    (= (at rover4 waypoint17) 4) 
    (= (have_rock_analysis rover3 waypoint21) 3) 
    (= (at rover4 waypoint27) 2) 
    (= (have_image rover1 objective7 low_res) 4) 
    (= (at rover7 waypoint10) 2) 
    (= (have_image rover6 objective1 colour) 2) 
    (= (have_image rover6 objective6 colour) 1) 
    (= (communicated_soil_data waypoint8) 1) 
    (= (have_image rover5 objective1 colour) 4) 
    (= (empty rover6store) 1) 
    (= (have_image rover6 objective4 colour) 5) 
    (= (have_rock_analysis rover4 waypoint34) 5) 
    (= (at rover2 waypoint22) 3) 
    (= (have_soil_analysis rover7 waypoint7) 1) 
    (= (at rover1 waypoint32) 1) 
    (= (at rover3 waypoint31) 2) 
    (= (available rover6) 2) 
    (= (have_soil_analysis rover1 waypoint34) 3) 
    (= (at rover4 waypoint36) 5) 
    (= (at rover7 waypoint17) 3) 
    (= (at rover1 waypoint4) 5) 
    (= (have_rock_analysis rover1 waypoint20) 3) 
    (= (have_rock_analysis rover0 waypoint20) 1) 
    (= (have_rock_analysis rover1 waypoint32) 3) 
    (= (at rover6 waypoint25) 3) 
    (= (communicated_image_data objective0 colour) 5) 
 )
 (:bound 109)
 )
