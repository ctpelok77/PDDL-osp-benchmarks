...
(:init
 ...
 (:utility 
    ...
    (= (have_image rover4 objective4 colour) 4) 
    (= (have_image rover3 objective7 high_res) 4) 
    (= (have_soil_analysis rover2 waypoint12) 1) 
    (= (communicated_soil_data waypoint5) 2) 
    (= (at rover1 waypoint31) 2) 
    (= (at rover1 waypoint23) 4) 
    (= (have_rock_analysis rover3 waypoint27) 3) 
    (= (at_soil_sample waypoint14) 2) 
    (= (at rover0 waypoint16) 3) 
    (= (at_rock_sample waypoint20) 5) 
    (= (communicated_image_data objective0 high_res) 4) 
    (= (at rover3 waypoint23) 4) 
    (= (have_rock_analysis rover5 waypoint27) 5) 
    (= (communicated_soil_data waypoint25) 2) 
    (= (have_rock_analysis rover4 waypoint24) 2) 
    (= (at rover0 waypoint11) 1) 
    (= (at rover4 waypoint28) 1) 
    (= (communicated_rock_data waypoint28) 5) 
    (= (communicated_image_data objective6 colour) 3) 
    (= (calibrated camera0 rover2) 3) 
    (= (have_soil_analysis rover0 waypoint8) 5) 
    (= (have_image rover0 objective4 colour) 2) 
    (= (have_image rover2 objective2 colour) 5) 
    (= (at rover2 waypoint7) 5) 
    (= (have_rock_analysis rover3 waypoint13) 3) 
    (= (at rover3 waypoint11) 1) 
    (= (full rover4store) 4) 
    (= (communicated_image_data objective3 colour) 1) 
    (= (have_rock_analysis rover3 waypoint34) 3) 
 )
 (:bound 63)
 )
