...
(:init
 ...
 (:utility 
    ...
    (= (at rover2 waypoint2) 4) 
    (= (at rover4 waypoint11) 3) 
    (= (at rover0 waypoint1) 4) 
    (= (at rover3 waypoint7) 5) 
    (= (full rover3store) 3) 
    (= (have_rock_analysis rover0 waypoint3) 2) 
    (= (at rover4 waypoint14) 3) 
    (= (have_image rover3 objective3 colour) 2) 
    (= (at rover3 waypoint0) 4) 
    (= (have_image rover2 objective3 high_res) 5) 
    (= (full rover5store) 1) 
    (= (have_rock_analysis rover0 waypoint13) 1) 
 )
 (:bound 49)
 )
