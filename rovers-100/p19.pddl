...
(:init
 ...
 (:utility 
    ...
    (= (have_image rover4 objective4 colour) 2) 
    (= (have_image rover2 objective6 high_res) 5) 
    (= (calibrated camera2 rover1) 5) 
    (= (at_soil_sample waypoint17) 5) 
    (= (at rover3 waypoint2) 1) 
    (= (at_rock_sample waypoint17) 5) 
    (= (at rover4 waypoint14) 3) 
    (= (at rover1 waypoint11) 1) 
    (= (have_soil_analysis rover2 waypoint3) 4) 
    (= (have_image rover1 objective4 low_res) 2) 
    (= (have_image rover3 objective3 colour) 2) 
    (= (have_image rover5 objective1 high_res) 1) 
    (= (have_soil_analysis rover3 waypoint3) 2) 
    (= (have_image rover2 objective3 high_res) 3) 
    (= (communicated_image_data objective1 low_res) 3) 
    (= (have_image rover2 objective1 high_res) 3) 
    (= (at_soil_sample waypoint11) 4) 
 )
 (:bound 68)
 )
