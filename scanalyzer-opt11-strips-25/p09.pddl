(define (problem scanalyzer3d-34)
 ...
 (:utility 
    ...
    (= (on car-out-3 seg-out-6) 5) 
    (= (on car-in-6 seg-out-6) 2) 
    (= (on car-in-7 seg-in-2) 1) 
    (= (on car-out-2 seg-in-7) 2) 
    (= (on car-in-3 seg-in-7) 1) 
    (= (on car-out-4 seg-out-6) 3) 
    (= (on car-out-6 seg-out-7) 4) 
    (= (on car-out-6 seg-in-7) 4) 
    (= (on car-out-2 seg-out-3) 3) 
 )
 (:bound 10)
 (:use-cost-metric)
 )
