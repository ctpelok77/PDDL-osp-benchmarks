(define (problem prob017)
 ...
 (:utility 
    ...
    (= (robot-at robot2 tile_0-4) 5) 
    (= (clear tile_1-2) 4) 
    (= (clear tile_6-4) 3) 
    (= (robot-at robot3 tile_1-2) 2) 
    (= (clear tile_0-3) 2) 
    (= (clear tile_0-2) 1) 
    (= (clear tile_1-3) 1) 
    (= (painted tile_3-2 white) 1) 
    (= (robot-at robot3 tile_0-4) 5) 
    (= (clear tile_7-4) 4) 
    (= (robot-at robot3 tile_4-2) 2) 
    (= (robot-at robot3 tile_7-5) 4) 
 )
 (:bound 90)
 (:use-cost-metric)
 )
