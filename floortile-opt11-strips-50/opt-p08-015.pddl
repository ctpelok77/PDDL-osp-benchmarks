(define (problem prob015)
 ...
 (:utility 
    ...
    (= (robot-at robot3 tile_2-5) 2) 
    (= (robot-at robot2 tile_3-2) 4) 
    (= (clear tile_4-1) 1) 
    (= (robot-at robot3 tile_5-5) 3) 
    (= (robot-at robot1 tile_0-3) 3) 
    (= (painted tile_0-2 black) 4) 
    (= (robot-at robot3 tile_3-4) 5) 
    (= (painted tile_5-5 black) 5) 
    (= (robot-at robot3 tile_3-3) 2) 
 )
 (:bound 81)
 (:use-cost-metric)
 )
