...
(define (problem transport-two-cities-sequential-10nodes-1000size-3degree-100mindistance-2trucks-6packages-2008seed)
 ...
 (:utility 
    (= (at package-1 city-2-loc-1) 10) 
    (= (at package-2 city-2-loc-3) 10) 
    (= (at package-3 city-2-loc-9) 10) 
    (= (at package-4 city-2-loc-2) 10) 
    (= (at package-5 city-2-loc-1) 10) 
    (= (at package-6 city-2-loc-6) 10) 
    (= (at package-2 city-2-loc-10) 5) 
    (= (at truck-2 city-2-loc-8) 1) 
    (= (at truck-2 city-1-loc-3) 1) 
    (= (at package-1 city-2-loc-8) 2) 
    (= (at package-2 city-2-loc-8) 5) 
    (= (at package-5 city-1-loc-6) 3) 
    (= (in package-4 truck-1) 4) 
    (= (at truck-2 city-2-loc-10) 2) 
 )
 (:bound 1422)
 (:use-cost-metric)
 )
