...
(define (problem transport-three-cities-sequential-9nodes-1000size-4degree-100mindistance-3trucks-10packages-2008seed)
 ...
 (:utility 
    (= (at package-1 city-3-loc-5) 10) 
    (= (at package-2 city-2-loc-4) 10) 
    (= (at package-3 city-2-loc-2) 10) 
    (= (at package-4 city-3-loc-5) 10) 
    (= (at package-5 city-3-loc-9) 10) 
    (= (at package-6 city-1-loc-3) 10) 
    (= (at package-7 city-2-loc-5) 10) 
    (= (at package-8 city-3-loc-8) 10) 
    (= (at package-9 city-1-loc-6) 10) 
    (= (at package-10 city-3-loc-6) 10) 
    (= (at package-3 city-2-loc-7) 3) 
    (= (at package-5 city-3-loc-8) 3) 
    (= (at package-8 city-2-loc-3) 4) 
    (= (at truck-2 city-1-loc-2) 1) 
    (= (capacity truck-2 capacity-3) 4) 
    (= (at package-10 city-1-loc-8) 2) 
    (= (at package-2 city-1-loc-8) 2) 
    (= (in package-5 truck-3) 1) 
    (= (at package-6 city-1-loc-2) 5) 
    (= (in package-7 truck-2) 1) 
    (= (at package-6 city-2-loc-6) 5) 
    (= (in package-6 truck-2) 4) 
    (= (at truck-1 city-3-loc-9) 2) 
    (= (at package-4 city-3-loc-4) 1) 
    (= (at package-10 city-3-loc-5) 5) 
    (= (at truck-1 city-1-loc-3) 5) 
    (= (at package-1 city-1-loc-9) 3) 
    (= (at package-2 city-3-loc-7) 2) 
    (= (at package-1 city-1-loc-1) 4) 
 )
 (:bound 1195)
 (:use-cost-metric)
 )
