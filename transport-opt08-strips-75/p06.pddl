...
(define (problem transport-city-sequential-18nodes-1000size-4degree-100mindistance-3trucks-7packages-2008seed)
 ...
 (:utility 
    ...
    (= (at truck-2 city-loc-4) 5) 
    (= (at truck-1 city-loc-9) 5) 
    (= (at package-1 city-loc-17) 1) 
    (= (capacity truck-3 capacity-4) 1) 
    (= (at truck-2 city-loc-3) 3) 
    (= (at truck-2 city-loc-2) 4) 
    (= (at package-2 city-loc-4) 2) 
    (= (at package-2 city-loc-7) 4) 
    (= (at package-1 city-loc-5) 3) 
    (= (at package-1 city-loc-14) 2) 
 )
 (:bound 293)
 (:use-cost-metric)
 )
