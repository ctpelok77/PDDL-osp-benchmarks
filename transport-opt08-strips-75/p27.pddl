...
(define (problem transport-three-cities-sequential-7nodes-1000size-4degree-100mindistance-3trucks-8packages-2008seed)
 ...
 (:utility 
    ...
    (= (at package-2 city-1-loc-5) 10) 
    (= (at package-3 city-3-loc-1) 10) 
    (= (at package-4 city-1-loc-7) 10) 
    (= (at package-5 city-1-loc-1) 10) 
    (= (at package-6 city-2-loc-2) 10) 
    (= (at package-7 city-3-loc-2) 10) 
    (= (at package-8 city-2-loc-3) 10) 
    (= (at package-4 city-1-loc-4) 2) 
    (= (at package-7 city-2-loc-5) 4) 
    (= (at package-6 city-2-loc-5) 1) 
    (= (at package-3 city-3-loc-6) 5) 
    (= (at truck-1 city-1-loc-5) 1) 
    (= (at package-4 city-1-loc-6) 3) 
    (= (at package-2 city-1-loc-7) 2) 
    (= (at package-4 city-3-loc-7) 3) 
    (= (at package-5 city-2-loc-6) 5) 
    (= (capacity truck-2 capacity-0) 2) 
    (= (at package-7 city-3-loc-6) 3) 
    (= (in package-2 truck-3) 1) 
    (= (at package-5 city-1-loc-4) 5) 
 )
 (:bound 1191)
 (:use-cost-metric)
 )
