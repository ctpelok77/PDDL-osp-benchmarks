...
(define (problem transport-three-cities-sequential-5nodes-1000size-3degree-100mindistance-2trucks-6packages-2008seed)
 ...
 (:utility 
    ...
    (= (at package-3 city-1-loc-2) 10) 
    (= (at package-4 city-3-loc-1) 10) 
    (= (at package-5 city-3-loc-3) 10) 
    (= (at package-6 city-1-loc-4) 10) 
    (= (at package-3 city-3-loc-1) 4) 
    (= (at package-1 city-3-loc-1) 3) 
    (= (at truck-2 city-1-loc-2) 5) 
    (= (capacity truck-2 capacity-2) 4) 
    (= (at package-4 city-1-loc-1) 5) 
    (= (at package-5 city-2-loc-1) 2) 
 )
 (:bound 727)
 (:use-cost-metric)
 )
