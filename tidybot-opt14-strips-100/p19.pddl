(define 
 ...
 (:utility 
    ...
    (= (base-obstacle x6 y8) 2) 
    (= (cart-pos cart x8 y3) 5) 
    (= (base-obstacle x7 y3) 2) 
    (= (cart-pos cart x3 y6) 3) 
    (= (base-pos pr2 x4 y6) 4) 
    (= (object-pos object0 x4 y6) 5) 
    (= (cart-pos cart x2 y7) 1) 
    (= (cart-pos cart x1 y3) 3) 
    (= (cart-pos cart x7 y4) 3) 
    (= (base-pos pr2 x4 y5) 5) 
    (= (gripper-obstacle x1 y2) 5) 
    (= (object-pos object3 x4 y2) 4) 
    (= (object-pos object3 x4 y6) 1) 
    (= (gripper-obstacle x0 y1) 1) 
    (= (gripper-obstacle x6 y3) 4) 
    (= (object-pos object2 x6 y6) 2) 
    (= (cart-pos cart x8 y6) 1) 
    (= (base-obstacle x3 y2) 2) 
 )
 (:bound 63)
 )
