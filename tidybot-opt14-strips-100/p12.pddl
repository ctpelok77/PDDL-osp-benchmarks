(define 
 ...
 (:utility 
    ...
    (= (cart-pos cart x5 y0) 1) 
    (= (cart-pos cart x3 y3) 4) 
    (= (base-obstacle x4 y5) 3) 
    (= (cart-pos cart x6 y6) 3) 
    (= (cart-pos cart x0 y3) 4) 
    (= (base-pos pr2 x2 y6) 5) 
    (= (object-pos object1 x4 y3) 3) 
    (= (gripper-obstacle x6 y7) 4) 
    (= (base-pos pr2 x5 y1) 2) 
    (= (base-pos pr2 x3 y6) 1) 
    (= (gripper-obstacle x2 y2) 2) 
    (= (gripper-obstacle x3 y3) 1) 
    (= (base-pos pr2 x1 y7) 5) 
    (= (holding pr2 object0) 2) 
 )
 (:bound 35)
 )
