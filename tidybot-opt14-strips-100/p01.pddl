(define 
 ...
 (:utility 
    ...
    (= (base-pos pr2 x1 y1) 3) 
    (= (not-pushed cart) 1) 
    (= (base-obstacle x7 y3) 4) 
    (= (cart-pos cart x3 y6) 2) 
    (= (cart-pos cart x0 y4) 3) 
    (= (gripper-obstacle x5 y2) 5) 
    (= (object-pos object0 x1 y3) 2) 
    (= (gripper-obstacle x8 y1) 5) 
    (= (gripper-obstacle x0 y2) 4) 
    (= (base-pos pr2 x5 y2) 1) 
    (= (base-pos pr2 x5 y1) 3) 
    (= (object-pos object0 x5 y4) 2) 
    (= (gripper-obstacle x8 y8) 1) 
    (= (base-pos pr2 x1 y5) 2) 
    (= (base-obstacle x4 y1) 3) 
    (= (cart-pos cart x4 y4) 4) 
    (= (pushing pr2 cart) 5) 
    (= (object-pos object2 x1 y5) 1) 
 )
 (:bound 55)
 )
