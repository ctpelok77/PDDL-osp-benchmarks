(define 
 ...
 (:utility 
    ...
    (= (base-pos pr2 x0 y7) 2) 
    (= (gripper-obstacle x3 y6) 1) 
    (= (base-pos pr2 x3 y2) 1) 
    (= (cart-pos cart x4 y7) 3) 
    (= (cart-pos cart x5 y4) 2) 
    (= (cart-pos cart x0 y0) 4) 
    (= (base-pos pr2 x5 y3) 4) 
    (= (cart-pos cart x5 y7) 4) 
    (= (base-obstacle x5 y4) 2) 
    (= (base-pos pr2 x6 y5) 3) 
    (= (gripper-obstacle x5 y5) 1) 
    (= (gripper-rel pr2 xrel0 yrel-1) 5) 
    (= (gripper-obstacle x2 y4) 3) 
    (= (gripper-obstacle x6 y0) 5) 
 )
 (:bound 29)
 )
