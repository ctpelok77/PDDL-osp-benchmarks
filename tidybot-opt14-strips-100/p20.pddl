(define 
 ...
 (:utility 
    ...
    (= (gripper-obstacle x3 y0) 3) 
    (= (base-pos pr2 x1 y6) 5) 
    (= (gripper-obstacle x8 y0) 5) 
    (= (gripper-obstacle x5 y6) 2) 
    (= (cart-pos cart x5 y5) 4) 
    (= (gripper-obstacle x0 y4) 2) 
    (= (base-obstacle x0 y7) 3) 
    (= (base-obstacle x1 y6) 4) 
    (= (object-pos object2 x5 y6) 3) 
    (= (cart-pos cart x2 y8) 1) 
    (= (base-obstacle x2 y7) 2) 
    (= (base-pos pr2 x7 y0) 4) 
    (= (object-pos object0 x6 y1) 5) 
    (= (base-obstacle x0 y5) 1) 
    (= (base-pos pr2 x6 y8) 3) 
    (= (base-obstacle x6 y1) 2) 
    (= (gripper-obstacle x3 y3) 1) 
    (= (base-pos pr2 x5 y6) 1) 
