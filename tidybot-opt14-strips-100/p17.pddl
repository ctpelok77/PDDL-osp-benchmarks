(define 
 ...
 (:utility 
    ...
    (= (base-pos pr2 x3 y3) 5) 
    (= (base-obstacle x1 y4) 3) 
    (= (base-obstacle x4 y6) 5) 
    (= (base-obstacle x2 y8) 3) 
    (= (gripper-obstacle x2 y0) 4) 
    (= (gripper-obstacle x6 y5) 1) 
    (= (cart-pos cart x5 y4) 2) 
    (= (gripper-obstacle x3 y4) 5) 
    (= (base-pos pr2 x2 y7) 3) 
    (= (gripper-obstacle x1 y1) 4) 
    (= (base-pos pr2 x8 y5) 1) 
    (= (cart-pos cart x2 y1) 5) 
    (= (cart-pos cart x8 y8) 3) 
    (= (cart-pos cart x6 y3) 4) 
    (= (base-obstacle x8 y4) 2) 
    (= (base-pos pr2 x2 y3) 2) 
    (= (gripper-obstacle x6 y8) 1) 
    (= (base-pos pr2 x5 y7) 2) 
 )
 (:bound 40)
 )
