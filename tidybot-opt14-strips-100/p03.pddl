(define 
  ...
  (:init 
   ...
   (object-goal object1 x4 y1)
   (object-goal object2 x4 y4)
   (object-goal object2 x3 y1)
   ...
   (object-pos object0 x3 y1)
   (object-pos object1 x3 y4)
   (object-pos object2 x4 y5)
 ...
 (:utility 
    ...
    (= (gripper-obstacle x8 y5) 5) 
    (= (gripper-obstacle x0 y6) 1) 
    (= (gripper-obstacle x1 y0) 2) 
    (= (gripper-obstacle x3 y5) 2) 
    (= (base-obstacle x8 y0) 4) 
    (= (not-pushed cart) 3) 
    (= (base-pos pr2 x3 y2) 5) 
    (= (base-obstacle x5 y0) 5) 
    (= (cart-pos cart x0 y5) 3) 
    (= (cart-pos cart x8 y0) 4) 
    (= (cart-pos cart x3 y4) 2) 
    (= (base-pos pr2 x6 y4) 3) 
    (= (gripper-obstacle x1 y7) 3) 
    (= (base-pos pr2 x6 y8) 1) 
    (= (base-pos pr2 x2 y0) 2) 
    (= (base-obstacle x1 y3) 1) 
    (= (cart-pos cart x2 y3) 4) 
    (= (cart-pos cart x4 y4) 5) 
 )
 (:bound 30)
 )
