(define 
  ...
  (:init 
   ...
   (object-goal object2 x1 y1)
   (object-goal object3 x5 y5)
   (object-goal object3 x1 y3)
   ...
   (object-pos object0 x1 y4)
   (object-pos object1 x4 y4)
   (object-pos object2 x1 y3)
   (object-pos object3 x1 y1)
 ...
 (:utility 
    ...
    (= (base-obstacle x3 y4) 1) 
    (= (gripper-obstacle x2 y7) 2) 
    (= (gripper-obstacle x5 y0) 1) 
    (= (gripper-obstacle x6 y4) 2) 
    (= (cart-pos cart x1 y1) 5) 
    (= (base-pos pr2 x7 y2) 5) 
    (= (base-obstacle x0 y4) 2) 
    (= (cart-pos cart x0 y5) 4) 
    (= (base-pos pr2 x6 y5) 1) 
    (= (holding pr2 object3) 1) 
    (= (gripper-obstacle x8 y7) 5) 
    (= (cart-pos cart x2 y0) 4) 
    (= (gripper-obstacle x2 y8) 3) 
    (= (cart-pos cart x8 y7) 3) 
    (= (base-pos pr2 x6 y6) 2) 
    (= (base-obstacle x8 y5) 5) 
    (= (gripper-obstacle x3 y2) 4) 
    (= (base-pos pr2 x7 y8) 4) 
 )
 (:bound 44)
 )
