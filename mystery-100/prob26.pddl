(define (problem strips-mysty-x-26)
 ...
 (:utility 
    ...
    (= (craves understanding pepper) 1) 
    (= (locale turkey manitoba) 1) 
    (= (craves boils snickers) 5) 
    (= (fears depression entertainment) 5) 
    (= (craves jealousy pistachio) 3) 
    (= (locale scallop quebec) 2) 
    (= (fears hangover understanding) 2) 
    (= (craves satisfaction flounder) 3) 
 )
 (:bound 6)
 )
