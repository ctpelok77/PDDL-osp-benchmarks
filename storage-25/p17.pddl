...
(:init
 ...
 (:utility 
    ...
    (= (in crate5 depot1) 10) 
    (= (in crate6 depot1) 10) 
    (= (on crate5 depot1-2-2) 2) 
    (= (on crate4 depot1-1-3) 4) 
    (= (on crate2 container-1-2) 1) 
    (= (at hoist0 depot0-1-2) 5) 
    (= (lifting hoist0 crate0) 5) 
    (= (lifting hoist1 crate0) 2) 
    (= (at hoist0 depot1-2-3) 4) 
    (= (on crate2 container-0-3) 1) 
    (= (in depot0-2-1 depot0) 5) 
    (= (on crate3 depot1-1-3) 3) 
    (= (on crate4 depot1-1-4) 3) 
    (= (clear depot1-1-3) 2) 
    (= (on crate0 depot1-1-1) 3) 
