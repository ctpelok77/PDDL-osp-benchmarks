...
(:init
 ...
 (:utility 
    ...
    (= (on crate4 container-1-2) 3) 
    (= (in crate2 depot2) 5) 
    (= (at hoist1 depot3-1-1) 2) 
    (= (in depot1-1-2 depot1) 3) 
    (= (at hoist2 container-2-0) 1) 
    (= (in crate2 container0) 4) 
    (= (on crate8 depot3-1-4) 2) 
    (= (on crate7 depot0-2-3) 2) 
    (= (at hoist0 depot1-1-2) 2) 
    (= (at hoist1 loadarea) 5) 
    (= (on crate10 depot1-1-3) 2) 
    (= (on crate1 depot1-2-1) 4) 
    (= (at hoist2 container-0-3) 2) 
    (= (in crate13 depot1) 4) 
    (= (on crate11 depot2-2-2) 1) 
    (= (on crate1 container-3-0) 3) 
    (= (on crate12 depot0-1-4) 3) 
    (= (on crate0 container-3-1) 1) 
    (= (in container-0-0 container0) 5) 
    (= (on crate0 depot1-1-2) 2) 
    (= (at hoist1 depot3-1-2) 2) 
    (= (on crate6 container-1-3) 1) 
    (= (in crate5 depot2) 4) 
    (= (at hoist2 depot3-1-1) 4) 
    (= (in crate12 container3) 4) 
    (= (in crate5 depot0) 2) 
    (= (on crate9 container-2-3) 5) 
    (= (on crate4 container-2-1) 3) 
    (= (on crate0 depot0-1-2) 1) 
    (= (on crate13 depot0-2-1) 3) 
    (= (on crate3 depot1-1-1) 5) 
    (= (on crate11 depot3-2-2) 3) 
    (= (on crate3 depot2-1-1) 3) 
    (= (at hoist1 container-1-0) 4) 
    (= (on crate1 container-3-1) 5) 
    (= (on crate9 depot3-2-4) 5) 
    (= (on crate10 depot1-2-1) 2) 
    (= (on crate8 depot2-1-2) 3) 
    (= (at hoist1 depot1-1-2) 1) 
    (= (at hoist1 container-3-0) 4) 
    (= (lifting hoist2 crate1) 1) 
    (= (on crate13 container-2-1) 5) 
    (= (on crate1 container-0-3) 4) 
    (= (lifting hoist2 crate3) 5) 
    (= (clear depot1-1-2) 4) 
    (= (on crate6 container-0-3) 1) 
    (= (at hoist2 depot3-2-2) 3) 
    (= (on crate11 container-0-3) 1) 
    (= (in crate10 container1) 5) 
    (= (on crate10 depot0-1-2) 1) 
 )
 (:bound 19)
 )
