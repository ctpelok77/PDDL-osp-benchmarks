...
(:init
 ...
 (:utility 
    ...
    (= (on crate7 depot2-2-3) 3) 
    (= (on crate11 depot0-2-2) 3) 
    (= (on crate3 depot0-2-4) 2) 
    (= (on crate0 depot2-2-2) 5) 
    (= (lifting hoist3 crate5) 4) 
    (= (at hoist3 depot2-2-3) 4) 
    (= (on crate0 depot0-1-3) 1) 
    (= (on crate0 depot1-2-2) 1) 
    (= (on crate8 depot0-2-4) 4) 
    (= (on crate1 depot0-2-3) 1) 
    (= (at hoist3 depot0-2-4) 3) 
    (= (in crate2 depot1) 5) 
    (= (on crate3 depot1-1-4) 5) 
    (= (at hoist2 container-0-2) 1) 
    (= (in crate0 depot2) 1) 
    (= (on crate5 depot2-1-3) 1) 
    (= (in container-2-0 container2) 4) 
    (= (in crate8 depot0) 1) 
    (= (on crate7 container-0-2) 3) 
    (= (clear depot0-1-4) 3) 
    (= (on crate5 container-0-1) 5) 
    (= (on crate10 container-0-1) 3) 
    (= (on crate8 depot2-2-1) 5) 
    (= (clear container-0-2) 4) 
    (= (on crate0 depot1-2-1) 4) 
    (= (on crate6 depot0-1-4) 3) 
    (= (clear depot2-2-1) 2) 
    (= (on crate10 depot2-1-2) 2) 
    (= (on crate11 container-1-2) 2) 
    (= (on crate8 depot1-2-3) 2) 
    (= (on crate10 depot2-1-4) 1) 
    (= (on crate10 depot1-1-4) 2) 
    (= (on crate8 container-0-3) 5) 
    (= (on crate7 depot1-1-1) 2) 
    (= (at hoist3 container-1-1) 5) 
    (= (on crate0 container-1-2) 3) 
    (= (on crate0 depot2-2-3) 2) 
    (= (at hoist1 container-2-3) 4) 
 )
 (:bound 15)
 )
