...
(:init
 ...
 (:utility 
    ...
    (= (in crate17 depot4) 10) 
    (= (in crate18 depot4) 10) 
    (= (in crate19 depot4) 10) 
    (= (on crate15 depot4-1-1) 3) 
    (= (on crate1 depot0-1-2) 4) 
    (= (on crate12 container-2-1) 3) 
    (= (on crate17 depot1-1-4) 5) 
    (= (on crate0 depot0-1-3) 5) 
    (= (on crate6 depot3-1-1) 4) 
    (= (in crate18 container2) 3) 
    (= (lifting hoist1 crate19) 2) 
    (= (on crate18 depot4-1-3) 3) 
    (= (at hoist1 depot1-1-3) 1) 
    (= (at hoist0 depot3-1-2) 1) 
    (= (on crate0 container-0-0) 2) 
    (= (in crate5 depot0) 1) 
    (= (on crate10 depot4-1-3) 3) 
    (= (at hoist0 container-3-0) 4) 
    (= (at hoist3 loadarea) 3) 
    (= (lifting hoist1 crate18) 5) 
    (= (on crate4 depot3-2-1) 1) 
    (= (on crate2 depot3-1-3) 4) 
    (= (at hoist1 depot0-2-4) 3) 
    (= (on crate10 container-1-2) 3) 
    (= (on crate18 depot1-2-4) 2) 
    (= (on crate11 depot0-2-2) 4) 
    (= (on crate0 depot2-1-4) 4) 
    (= (on crate1 container-4-2) 5) 
    (= (on crate19 depot4-2-2) 3) 
    (= (on crate1 depot1-2-1) 2) 
    (= (clear depot1-1-2) 1) 
    (= (in crate13 depot1) 2) 
    (= (on crate12 depot3-1-4) 3) 
    (= (on crate18 container-2-1) 5) 
    (= (on crate10 container-0-3) 4) 
    (= (on crate4 depot0-1-3) 4) 
    (= (on crate8 depot1-1-2) 2) 
    (= (on crate11 depot0-2-3) 4) 
    (= (on crate16 depot2-2-1) 3) 
    (= (in crate17 container2) 5) 
    (= (on crate3 depot0-1-4) 1) 
    (= (on crate3 container-2-2) 4) 
    (= (at hoist2 depot1-1-2) 5) 
    (= (on crate2 depot2-2-3) 3) 
    (= (on crate14 container-4-1) 5) 
    (= (on crate2 container-0-0) 2) 
    (= (on crate10 depot0-2-4) 5) 
    (= (on crate7 container-3-1) 1) 
    (= (on crate3 depot1-2-3) 2) 
    (= (at hoist1 container-1-3) 1) 
    (= (in container-1-2 container1) 1) 
    (= (in crate5 container3) 1) 
    (= (at hoist0 depot2-2-2) 3) 
    (= (on crate1 container-0-3) 4) 
    (= (on crate14 container-1-2) 4) 
    (= (on crate17 depot3-2-2) 5) 
    (= (clear depot2-1-2) 4) 
    (= (in crate11 container1) 5) 
    (= (on crate15 depot0-2-1) 1) 
    (= (at hoist4 container-1-3) 4) 
    (= (on crate7 container-1-1) 2) 
    (= (on crate17 container-4-2) 3) 
    (= (on crate19 depot3-1-1) 1) 
    (= (on crate3 depot2-1-1) 1) 
    (= (on crate13 depot4-2-1) 2) 
    (= (at hoist4 depot3-2-4) 5) 
    (= (at hoist0 container-4-0) 5) 
    (= (at hoist3 depot1-1-2) 4) 
    (= (at hoist4 container-4-2) 5) 
    (= (on crate16 depot4-1-3) 4) 
    (= (at hoist1 depot3-1-3) 2) 
    (= (on crate8 depot1-1-3) 2) 
    (= (on crate2 depot0-2-4) 5) 
    (= (in container-3-3 container3) 5) 
    (= (on crate4 depot3-1-2) 2) 
    (= (on crate12 depot3-2-3) 4) 
    (= (on crate8 depot1-2-4) 1) 
    (= (on crate18 depot2-1-1) 2) 
    (= (on crate5 depot2-2-1) 1) 
    (= (at hoist3 container-0-2) 5) 
    (= (clear depot3-1-3) 4) 
    (= (at hoist1 container-1-1) 3) 
    (= (on crate19 container-0-1) 1) 
    (= (in crate18 container4) 2) 
    (= (lifting hoist2 crate2) 1) 
    (= (on crate5 container-3-3) 2) 
    (= (on crate15 depot3-1-3) 2) 
    (= (on crate18 depot3-2-2) 3) 
    (= (on crate4 depot0-1-1) 3) 
    (= (at hoist3 container-0-3) 4) 
    (= (on crate8 depot3-1-1) 5) 
    (= (on crate11 depot3-2-2) 2) 
    (= (on crate12 depot3-1-3) 1) 
    (= (on crate8 depot1-2-3) 5) 
    (= (on crate2 depot4-2-2) 2) 
    (= (in container-3-0 container3) 3) 
    (= (on crate1 depot2-2-2) 1) 
    (= (on crate0 container-0-1) 3) 
 )
 (:bound 25)
 )
