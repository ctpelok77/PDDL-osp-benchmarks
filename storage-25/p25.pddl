...
(:init
 ...
 (:utility 
    ...
    (= (on crate5 depot1-2-2) 5) 
    (= (in crate12 container2) 5) 
    (= (on crate8 depot0-1-3) 3) 
    (= (on crate12 container-3-1) 5) 
    (= (on crate5 container-1-3) 1) 
    (= (at hoist3 depot0-2-2) 3) 
    (= (on crate1 depot1-2-3) 3) 
    (= (at hoist1 container-1-3) 4) 
    (= (on crate7 container-1-0) 3) 
    (= (on crate9 container-3-1) 5) 
    (= (on crate8 depot1-1-3) 1) 
    (= (on crate5 container-0-2) 2) 
    (= (on crate4 depot1-2-1) 2) 
    (= (on crate12 depot0-2-4) 3) 
    (= (lifting hoist2 crate4) 3) 
    (= (at hoist1 container-3-2) 4) 
    (= (on crate4 depot1-2-3) 2) 
    (= (on crate12 depot0-1-4) 5) 
    (= (on crate3 depot2-2-2) 3) 
    (= (on crate7 depot3-2-2) 2) 
    (= (on crate3 depot3-2-3) 4) 
    (= (on crate6 container-2-2) 2) 
    (= (on crate10 depot0-1-1) 5) 
    (= (on crate4 container-1-3) 2) 
    (= (at hoist3 depot3-2-2) 3) 
    (= (on crate8 depot2-2-3) 3) 
    (= (on crate12 container-3-0) 4) 
    (= (in depot3-2-1 depot3) 2) 
    (= (clear depot3-1-2) 4) 
    (= (on crate3 depot1-2-2) 3) 
    (= (on crate10 container-1-3) 5) 
    (= (in crate13 depot2) 5) 
    (= (on crate9 depot2-2-2) 1) 
    (= (on crate5 depot3-1-3) 3) 
    (= (at hoist3 depot3-1-1) 2) 
    (= (in crate14 container2) 4) 
    (= (on crate6 depot1-2-1) 1) 
    (= (on crate14 depot2-2-3) 4) 
    (= (on crate14 container-2-0) 4) 
    (= (clear depot2-2-2) 5) 
    (= (on crate2 depot3-1-3) 2) 
    (= (at hoist1 depot0-2-4) 2) 
    (= (in depot1-2-3 depot1) 5) 
    (= (on crate8 container-0-3) 1) 
    (= (in crate9 container3) 1) 
    (= (at hoist0 depot1-2-3) 4) 
    (= (on crate12 depot3-2-2) 1) 
    (= (on crate6 depot3-1-3) 5) 
    (= (on crate8 depot3-2-3) 1) 
    (= (on crate5 depot2-1-4) 1) 
    (= (on crate0 depot2-2-3) 2) 
    (= (on crate8 depot0-1-2) 1) 
    (= (on crate10 depot0-2-2) 4) 
    (= (on crate6 container-1-2) 4) 
    (= (in crate11 depot0) 1) 
 )
 (:bound 9)
 )
