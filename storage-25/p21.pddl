...
(:init
 ...
 (:utility 
    ...
    (= (on crate0 depot1-2-4) 3) 
    (= (at hoist2 container-2-2) 4) 
    (= (in crate3 container1) 5) 
    (= (on crate7 depot2-1-3) 1) 
    (= (on crate9 depot2-2-1) 2) 
    (= (at hoist2 depot0-1-1) 4) 
    (= (in crate7 container1) 3) 
    (= (on crate0 container-0-3) 2) 
    (= (in crate8 depot0) 2) 
    (= (on crate4 depot2-2-1) 3) 
    (= (on crate2 container-1-1) 1) 
    (= (lifting hoist1 crate2) 3) 
    (= (on crate1 depot2-1-4) 5) 
    (= (at hoist2 depot0-1-2) 5) 
    (= (lifting hoist1 crate0) 4) 
    (= (at hoist2 depot2-2-2) 4) 
    (= (on crate8 depot2-2-3) 1) 
    (= (at hoist2 depot2-2-4) 5) 
    (= (on crate0 container-0-2) 2) 
    (= (at hoist0 depot0-1-1) 2) 
    (= (on crate10 depot1-1-2) 1) 
    (= (at hoist0 depot1-1-1) 5) 
    (= (on crate9 container-0-0) 5) 
    (= (on crate3 depot0-1-4) 4) 
    (= (in crate1 container1) 1) 
    (= (at hoist3 depot0-1-3) 4) 
    (= (on crate2 depot0-1-1) 2) 
    (= (on crate9 depot1-2-1) 4) 
    (= (on crate3 depot1-1-1) 1) 
    (= (in depot2-2-3 depot2) 1) 
    (= (on crate8 container-0-3) 3) 
    (= (on crate1 depot2-1-1) 3) 
    (= (on crate3 depot2-2-3) 5) 
 )
 (:bound 14)
 )
