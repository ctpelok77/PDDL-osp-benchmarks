...
(:init
 ...
 (:utility 
    ...
    (= (in crate3 depot1) 10) 
    (= (in crate4 depot1) 10) 
    (= (on crate3 depot0-2-2) 2) 
    (= (on crate4 depot0-1-1) 5) 
    (= (on crate2 depot0-1-2) 3) 
    (= (clear container-0-1) 2) 
    (= (in crate0 container1) 4) 
    (= (lifting hoist0 crate2) 1) 
    (= (on crate2 container-0-2) 3) 
    (= (at hoist0 depot1-2-1) 5) 
    (= (on crate4 container-0-1) 4) 
 )
 (:bound 4)
 )
