...
(:init
 ...
 (:utility 
    ...
    (= (lifting hoist1 crate1) 2) 
    (= (on crate3 depot3-1-1) 2) 
    (= (on crate5 depot3-1-2) 4) 
    (= (lifting hoist2 crate7) 5) 
    (= (on crate1 depot1-2-3) 1) 
    (= (in container-1-0 container1) 5) 
    (= (on crate9 container-0-1) 2) 
    (= (at hoist2 depot2-1-1) 5) 
    (= (at hoist1 depot2-1-3) 5) 
    (= (on crate11 container-2-3) 4) 
    (= (on crate6 container-2-0) 5) 
    (= (at hoist1 depot3-2-3) 1) 
    (= (on crate5 depot3-2-3) 3) 
    (= (on crate12 depot0-2-2) 2) 
    (= (on crate12 container-1-2) 3) 
    (= (on crate6 container-1-0) 4) 
    (= (at hoist2 depot3-1-3) 5) 
    (= (lifting hoist0 crate5) 4) 
    (= (on crate3 depot0-2-1) 4) 
    (= (on crate11 container-0-2) 2) 
    (= (on crate1 depot2-1-4) 3) 
    (= (on crate2 depot1-1-3) 1) 
    (= (on crate3 depot0-2-3) 4) 
    (= (at hoist0 depot3-2-1) 4) 
    (= (in crate11 container2) 3) 
    (= (on crate10 container-0-1) 4) 
    (= (at hoist0 container-3-0) 1) 
    (= (on crate6 depot1-2-3) 2) 
    (= (on crate8 container-1-2) 5) 
    (= (on crate0 depot3-1-2) 1) 
    (= (in depot0-2-2 depot0) 3) 
    (= (on crate10 depot2-1-4) 3) 
    (= (on crate2 depot3-1-3) 1) 
    (= (on crate2 depot0-1-1) 5) 
    (= (on crate7 depot3-1-1) 2) 
    (= (on crate12 depot2-2-1) 3) 
    (= (in crate7 container2) 5) 
    (= (on crate4 depot2-2-2) 1) 
    (= (on crate10 depot2-2-1) 4) 
    (= (on crate12 depot0-2-3) 3) 
    (= (on crate12 container-1-3) 1) 
    (= (on crate5 depot0-1-3) 1) 
    (= (on crate6 container-1-2) 3) 
    (= (at hoist3 depot2-1-2) 2) 
 )
 (:bound 13)
 )
