...
(define (problem p43-net5-b24-g3_rt0_instance)
 ...
 (:utility 
    ...
    (= (on b0 a1) 4) 
    (= (on b14 a2) 1) 
    (= (not-occupied ta2-4-oc1b) 1) 
    (= (not-occupied ta5-5-gasoleo) 5) 
    (= (follow b13 b21) 1) 
    (= (not-occupied ta3-6-oc1b) 2) 
    (= (first b6 s34) 2) 
    (= (on b14 a3) 4) 
    (= (occupied ta2-3-oc1b) 1) 
    (= (follow b2 b23) 4) 
    (= (follow b13 b9) 1) 
    (= (first b23 s12) 2) 
    (= (not-occupied ta3-7-gasoleo) 4) 
    (= (follow b13 b15) 3) 
    (= (follow b12 b2) 2) 
    (= (follow b23 b3) 4) 
    (= (occupied ta3-3-oc1b) 2) 
    (= (first b12 s34) 2) 
    (= (follow b16 b17) 5) 
    (= (last b22 s34) 5) 
    (= (last b0 s34) 5) 
    ...
    (= (last b23 s15) 1) 
    (= (first b3 s12) 4) 
    (= (occupied ta3-3-gasoleo) 2) 
    (= (last b21 s12) 1) 
    (= (not-occupied ta2-1-oca1) 5) 
    (= (last b11 s13) 2) 
    (= (follow b16 b3) 2) 
    (= (on b23 a4) 3) 
    (= (occupied ta3-1-oc1b) 2) 
    (= (follow b8 b13) 2) 
    (= (first b21 s13) 3) 
    (= (first b8 s13) 5) 
    (= (occupied ta4-4-oc1b) 1) 
    (= (follow b19 b8) 3) 
    (= (follow b10 b9) 5) 
 )
 (:bound 11)
