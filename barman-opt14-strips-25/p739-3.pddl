(define (problem prob)
 ...
 (:utility 
    ...
    (= (contains shot7 cocktail3) 10) 
    (= (contains shot8 ingredient1) 10) 
    (= (used shot5 ingredient2) 2) 
    (= (ontable shot1) 4) 
    (= (contains shot9 cocktail2) 2) 
    (= (contains shot1 cocktail7) 1) 
    (= (ontable shot7) 3) 
    (= (contains shot7 cocktail4) 3) 
    (= (contains shot6 cocktail2) 5) 
    (= (contains shot7 cocktail5) 5) 
 )
 (:bound 23)
 )
