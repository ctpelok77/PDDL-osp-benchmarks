(define (problem prob)
 ...
 (:utility 
    ...
    (= (contains shot7 ingredient3) 10) 
    (= (contains shot7 cocktail1) 5) 
    (= (contains shot4 cocktail2) 1) 
    (= (contains shot7 cocktail6) 3) 
    (= (contains shot1 cocktail1) 2) 
    (= (contains shot6 ingredient2) 3) 
    (= (contains shot1 ingredient1) 4) 
    (= (contains shot8 cocktail6) 1) 
 )
 (:bound 20)
 )
