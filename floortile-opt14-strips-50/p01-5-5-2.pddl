(define (problem p01-642)
 ...
 (:utility 
    ...
    (= (painted tile_3-3 black) 5) 
    (= (robot-has robot1 black) 2) 
    (= (robot-at robot2 tile_4-2) 4) 
    (= (robot-at robot2 tile_1-1) 3) 
    (= (robot-at robot1 tile_2-1) 1) 
    (= (robot-at robot1 tile_2-5) 5) 
 )
 (:bound 76)
 (:use-cost-metric)
 )
