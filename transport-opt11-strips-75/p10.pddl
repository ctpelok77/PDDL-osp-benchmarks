...
(define (problem transport-city-sequential-14nodes-1000size-3degree-100mindistance-3trucks-7packages-2012seed)
 ...
 (:utility 
    (= (at package-1 city-loc-1) 10) 
    (= (at package-2 city-loc-9) 10) 
    (= (at package-3 city-loc-8) 10) 
    (= (at package-4 city-loc-5) 10) 
    (= (at package-5 city-loc-1) 10) 
    (= (at package-6 city-loc-4) 10) 
    (= (at package-7 city-loc-9) 10) 
    (= (at package-5 city-loc-6) 3) 
    (= (at truck-2 city-loc-4) 3) 
    (= (at package-2 city-loc-11) 1) 
    (= (at package-7 city-loc-1) 2) 
    (= (in package-3 truck-1) 1) 
    (= (at package-3 city-loc-9) 5) 
    (= (in package-2 truck-2) 5) 
