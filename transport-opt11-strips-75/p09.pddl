...
(define (problem transport-city-sequential-14nodes-1000size-2degree-100mindistance-2trucks-7packages-2012seed)
 ...
 (:utility 
    ...
    (= (at package-2 city-loc-4) 10) 
    (= (at package-3 city-loc-8) 10) 
    (= (at package-4 city-loc-7) 10) 
    (= (at package-5 city-loc-1) 10) 
    (= (at package-6 city-loc-4) 10) 
    (= (at package-7 city-loc-2) 10) 
    (= (at package-5 city-loc-6) 2) 
    (= (at package-2 city-loc-1) 4) 
    (= (in package-5 truck-2) 4) 
    (= (at package-5 city-loc-8) 5) 
    (= (at package-3 city-loc-10) 5) 
    (= (at package-3 city-loc-7) 3) 
    (= (at package-6 city-loc-9) 1) 
 )
 (:bound 373)
 (:use-cost-metric)
 )
