...
(define (problem transport-city-sequential-18nodes-1000size-4degree-100mindistance-3trucks-7packages-2008seed)
 ...
 (:utility 
    (= (at package-1 city-loc-6) 10) 
    (= (at package-2 city-loc-13) 10) 
    (= (at package-3 city-loc-1) 10) 
    (= (at package-4 city-loc-18) 10) 
    (= (at package-5 city-loc-9) 10) 
    (= (at package-6 city-loc-2) 10) 
    (= (at package-7 city-loc-14) 10) 
    (= (capacity truck-1 capacity-3) 3) 
    (= (capacity truck-2 capacity-3) 5) 
    (= (at package-7 city-loc-1) 3) 
    (= (in package-6 truck-1) 4) 
    (= (capacity truck-2 capacity-2) 1) 
    (= (at package-4 city-loc-7) 4) 
    (= (at package-5 city-loc-2) 2) 
    (= (at package-2 city-loc-4) 1) 
    (= (at package-4 city-loc-10) 2) 
    (= (at truck-1 city-loc-13) 5) 
 )
 (:bound 499)
 (:use-cost-metric)
 )
