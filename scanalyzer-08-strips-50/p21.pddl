(define (problem scanalyzer3d-41)
 ...
 (:utility 
    ...
    (= (on car-out-3 seg-out-1) 5) 
    (= (on car-in-9 seg-in-8) 4) 
    (= (on car-out-5 seg-out-6) 2) 
    (= (on car-in-3 seg-in-8) 4) 
    (= (on car-in-7 seg-out-3) 2) 
    (= (on car-out-5 seg-out-8) 1) 
    (= (on car-in-3 seg-out-2) 5) 
    (= (on car-out-8 seg-in-6) 5) 
    (= (on car-in-5 seg-out-3) 3) 
    (= (on car-out-9 seg-out-6) 3) 
    (= (on car-out-9 seg-in-9) 4) 
    (= (on car-out-8 seg-in-9) 3) 
    (= (on car-in-5 seg-out-4) 1) 
    (= (on car-in-7 seg-in-8) 2) 
    (= (on car-out-4 seg-out-8) 1) 
 )
 (:bound 56)
 (:use-cost-metric)
 )
