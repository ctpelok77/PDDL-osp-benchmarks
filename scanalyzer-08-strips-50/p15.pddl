(define (problem scanalyzer3d-31)
 ...
 (:utility 
    ...
    (= (on car-in-1 seg-in-6) 4) 
    (= (on car-out-2 seg-out-7) 5) 
    (= (on car-in-5 seg-out-6) 5) 
    (= (on car-out-4 seg-out-7) 2) 
    (= (on car-in-3 seg-out-5) 1) 
    (= (on car-in-6 seg-in-5) 1) 
    (= (on car-out-4 seg-out-5) 3) 
    (= (on car-in-5 seg-out-4) 4) 
    (= (on car-out-5 seg-in-6) 2) 
 )
 (:bound 35)
 (:use-cost-metric)
 )
