(define (problem scanalyzer3d-64)
 ...
 (:utility 
    ...
    (= (on car-in-3b seg-out-3a) 4) 
    (= (on car-in-3b seg-out-2b) 2) 
    (= (on car-out-3a seg-out-3b) 4) 
    (= (on car-out-1a seg-out-3b) 3) 
    (= (on car-in-1b seg-in-2b) 5) 
    (= (on car-out-3b seg-in-1a) 3) 
 )
 (:bound 19)
 (:use-cost-metric)
 )
