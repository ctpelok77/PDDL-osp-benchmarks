(define (problem scanalyzer3d-32)
 ...
 (:utility 
    ...
    (= (on car-in-7 seg-out-5) 4) 
    (= (on car-in-1 seg-in-6) 2) 
    (= (on car-in-7 seg-in-1) 2) 
    (= (on car-out-6 seg-in-3) 3) 
    (= (on car-out-1 seg-in-6) 1) 
    (= (on car-out-2 seg-in-2) 3) 
    (= (on car-out-5 seg-out-3) 1) 
    (= (on car-out-1 seg-in-3) 5) 
    (= (on car-out-7 seg-out-3) 4) 
 )
 (:bound 33)
 (:use-cost-metric)
 )
