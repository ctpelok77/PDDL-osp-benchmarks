...
(= (total-cost) 0)
 ...
 (:utility 
    (= (passenger-at p0 n11) 10) 
    (= (passenger-at p1 n0) 10) 
    (= (passenger-at p2 n4) 10) 
    (= (passenger-at p3 n0) 10) 
    (= (passenger-at p4 n1) 10) 
    (= (passenger-at p5 n12) 10) 
    (= (passenger-at p6 n4) 10) 
    (= (passenger-at p0 n1) 4) 
    (= (passenger-at p1 n12) 5) 
    (= (boarded p1 slow2-0) 3) 
    (= (passenger-at p1 n2) 4) 
    (= (passenger-at p3 n7) 1) 
    (= (passenger-at p5 n9) 5) 
    (= (passenger-at p3 n2) 1) 
    (= (boarded p3 slow1-0) 2) 
 )
 (:bound 81)
 (:use-cost-metric)
 )
