...
(= (total-cost) 0)
 ...
 (:utility 
    (= (passenger-at p0 n0) 10) 
    (= (passenger-at p1 n7) 10) 
    (= (passenger-at p2 n6) 10) 
    (= (passenger-at p3 n7) 10) 
    (= (passenger-at p4 n5) 10) 
    (= (passenger-at p5 n3) 10) 
    (= (passenger-at p3 n6) 1) 
    (= (passenger-at p3 n9) 3) 
    (= (passengers slow2-0 n0) 4) 
    (= (passengers fast1 n2) 4) 
    (= (passengers fast0 n3) 3) 
    (= (passenger-at p3 n2) 5) 
    (= (passenger-at p1 n12) 2) 
 )
 (:bound 62)
 (:use-cost-metric)
 )
