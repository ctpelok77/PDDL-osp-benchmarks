(define (problem strips-mysty-x-7)
 ...
 (:utility 
    ...
    (= (craves dread pear) 4) 
    (= (craves dread mutton) 1) 
    (= (craves boils shrimp) 2) 
    (= (fears grief learning) 1) 
    (= (fears abrasion stimulation) 3) 
    (= (craves laceration mutton) 5) 
    (= (locale mutton arizona) 3) 
    (= (craves dread shrimp) 2) 
    (= (craves angina shrimp) 5) 
 )
 (:bound 75)
 )
