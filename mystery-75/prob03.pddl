(define (problem strips-mysty-x-3)
 ...
 (:utility 
    ...
    (= (craves hangover mutton) 4) 
    (= (craves love mutton) 1) 
    (= (locale melon manitoba) 5) 
    (= (craves entertainment lemon) 2) 
    (= (craves laceration marzipan) 3) 
    (= (harmony love venus) 2) 
    (= (craves entertainment melon) 3) 
    (= (craves satisfaction chocolate) 5) 
 )
 (:bound 3)
 )
