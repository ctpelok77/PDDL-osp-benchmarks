(define (problem strips-mysty-x-18)
 ...
 (:utility 
    ...
    (= (craves depression guava) 5) 
    (= (fears depression expectation) 1) 
    (= (craves boils potato) 2) 
    (= (fears anger satisfaction) 3) 
    (= (locale wurst manitoba) 3) 
    (= (craves hangover hotdog) 2) 
    (= (craves hangover bacon) 5) 
    (= (locale turkey manitoba) 5) 
    (= (craves sciatica scallop) 1) 
    (= (locale chocolate manitoba) 1) 
    (= (locale tofu moravia) 4) 
    (= (craves hangover chicken) 4) 
    (= (fears anger expectation) 2) 
    (= (fears grief learning) 2) 
    (= (locale lemon guanabara) 4) 
    (= (craves grief cantelope) 4) 
    (= (locale haroset guanabara) 3) 
    (= (craves prostatitis broccoli) 3) 
    (= (craves learning cucumber) 1) 
 )
 (:bound 75)
 )
