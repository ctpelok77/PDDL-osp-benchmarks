(define (problem strips-mysty-x-29)
 ...
 (:utility 
    ...
    (= (craves abrasion pork) 5) 
    (= (craves grief broccoli) 2) 
    (= (harmony excitement neptune) 4) 
    (= (craves achievement popover) 1) 
    (= (locale scallop oregon) 1) 
    (= (craves laceration pork) 5) 
    (= (craves grief melon) 3) 
    (= (craves abrasion shrimp) 4) 
 )
 (:bound 3)
 )
