(define (problem scanalyzer3d-37)
 ...
 (:utility 
    ...
    (= (on car-in-1 seg-out-8) 4) 
    (= (on car-in-3 seg-in-5) 2) 
    (= (on car-in-8 seg-out-1) 2) 
    (= (on car-in-2 seg-in-3) 1) 
    (= (on car-out-8 seg-in-7) 5) 
    (= (on car-out-4 seg-out-6) 4) 
    (= (on car-in-4 seg-in-3) 3) 
    (= (on car-out-4 seg-out-5) 1) 
    (= (on car-out-4 seg-in-5) 3) 
    (= (on car-out-8 seg-in-2) 5) 
    (= (on car-out-5 seg-in-4) 3) 
    (= (on car-out-3 seg-in-5) 5) 
 )
 (:bound 88)
 (:use-cost-metric)
 )
