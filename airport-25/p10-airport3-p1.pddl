...
(:init
 ...
 (:utility 
    ...
    (= (not_blocked seg_n6_b_0_100 airplane_cfbeg) 2) 
    (= (blocked seg_n3_n_0_100 airplane_cfbeg) 1) 
    (= (not_occupied seg_n4_n5_2_0_86) 2) 
    (= (not_blocked seg_27help_0_100 airplane_cfbeg) 3) 
    (= (blocked seg_n5_n6_0_100 airplane_cfbeg) 4) 
    (= (not_blocked seg_n4_n5_3_0_86 airplane_cfbeg) 1) 
    (= (not_blocked seg_c2_c3_0_100 airplane_cfbeg) 5) 
    (= (facing airplane_cfbeg south) 4) 
    (= (at-segment airplane_cfbeg seg_c4_c5_0_50) 3) 
 )
 (:bound 4)
 )
