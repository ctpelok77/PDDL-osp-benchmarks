...
(:init
 ...
 (:utility 
    (= (is-parked airplane_CFBEG seg_pp_0_60) 10) 
    (= (airborne airplane_DAEWH seg_rwe_0_50) 10) 
    (= (blocked seg_tww4_0_50 airplane_cfbeg) 4) 
    (= (blocked seg_ppdoor_0_40 airplane_daewh) 1) 
    (= (facing airplane_cfbeg south) 5) 
    (= (blocked seg_rw_0_400 airplane_daewh) 2) 
    (= (blocked seg_tww2_0_50 airplane_daewh) 1) 
    (= (not_blocked seg_pp_0_60 airplane_cfbeg) 2) 
 )
 (:bound 4)
 )
