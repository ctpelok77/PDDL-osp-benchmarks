...
(:init
 ...
 (:utility 
    ...
    (= (not_blocked seg_o1_104c_0_60 airplane_cfbeg) 1) 
    (= (occupied seg_n_a4c_0_60) 1) 
    (= (is-parked airplane_cfbeg seg_p107_0_76) 5) 
    (= (not_blocked seg_p118_0_76 airplane_daew7) 2) 
    (= (not_blocked seg_w1_163a_0_34 airplane_cfbeg) 4) 
    (= (not_blocked seg_m_a3a4e_0_75 airplane_cfbeg) 4) 
    (= (blocked seg_a2_c_0_100 airplane_cfbeg) 4) 
    (= (blocked seg_n_a2a3b_0_75 airplane_cfbeg) 2) 
    (= (occupied seg_n_a6a8e_0_75) 1) 
    (= (at-segment airplane_cfbeg seg_w1_141c_0_34) 2) 
    (= (blocked seg_o1_108b_0_60 airplane_cfbeg) 4) 
    (= (blocked seg_n_a3a_0_60 airplane_cfbeg) 4) 
    (= (at-segment airplane_cfbeg seg_p112_0_76) 4) 
    (= (blocked seg_n_a6b_0_60 airplane_cfbeg) 2) 
    (= (not_blocked seg_p151_0_75 airplane_cfbeg) 1) 
    (= (at-segment airplane_daew7 seg_p109_0_76) 4) 
    (= (at-segment airplane_daew7 seg_o1_118c_0_34) 2) 
    (= (blocked seg_n_a2a3e_0_75 airplane_daew7) 4) 
    (= (not_blocked seg_n_a7a6b_0_75 airplane_cfbeg) 1) 
    (= (blocked seg_n_a8b_0_60 airplane_daew7) 1) 
    (= (occupied seg_n_a2a3f_0_115) 1) 
    (= (blocked seg_w1_152c_0_34 airplane_daew7) 5) 
    (= (not_blocked seg_n_a4a7f_0_75 airplane_cfbeg) 4) 
    (= (not_blocked seg_m_a6a8a_0_75 airplane_cfbeg) 3) 
    (= (blocked seg_n_a8a_0_60 airplane_daew7) 1) 
    (= (not_occupied seg_o1_117b_0_60) 5) 
    (= (not_occupied seg_n_a10a_0_60) 5) 
    (= (is-parked airplane_cfbeg seg_p153_0_75) 3) 
    (= (not_blocked seg_w1_151c_0_34 airplane_cfbeg) 3) 
    (= (at-segment airplane_cfbeg seg_o1_c1a_0_60) 1) 
    (= (at-segment airplane_daew7 seg_o1_116c_0_34) 3) 
    (= (at-segment airplane_cfbeg seg_p115_0_76) 1) 
    (= (not_occupied seg_m_a9b_0_60) 3) 
    (= (not_blocked seg_o1_115a_0_34 airplane_daew7) 2) 
    (= (at-segment airplane_cfbeg seg_p134_0_75) 5) 
    (= (not_occupied seg_08l_a9c_0_80) 4) 
    (= (blocked seg_a2_c_0_100 airplane_daew7) 3) 
    (= (not_blocked seg_n_a6c_0_60 airplane_daew7) 5) 
    (= (at-segment airplane_cfbeg seg_w1_141a_0_34) 4) 
    (= (occupied seg_w1_c4a_0_34) 5) 
    (= (not_blocked seg_n_a6a8e_0_75 airplane_daew7) 1) 
    (= (not_blocked seg_n_a8a9d_0_75 airplane_daew7) 1) 
    (= (not_blocked seg_w1_c2a_0_60 airplane_daew7) 5) 
    (= (at-segment airplane_daew7 seg_w1_c4a_0_34) 2) 
    (= (at-segment airplane_daew7 seg_n2_0_108) 2) 
    (= (blocked seg_n_a3d_0_60 airplane_daew7) 3) 
    (= (not_occupied seg_m_a9a10b_0_75) 3) 
    (= (not_blocked seg_m_a8d_0_120_934 airplane_daew7) 5) 
    (= (blocked seg_o1_c1a_0_60 airplane_daew7) 1) 
    (= (not_occupied seg_n_a9a10g_0_75) 5) 
    (= (blocked seg_o1_104a_0_34 airplane_cfbeg) 4) 
    (= (at-segment airplane_daew7 seg_o1_c2d_0_60) 2) 
    (= (not_blocked seg_a7_b_1_0_80_6226 airplane_cfbeg) 5) 
    (= (occupied seg_w1_142c_0_34) 4) 
    (= (not_blocked seg_w1_c3b_0_60 airplane_cfbeg) 5) 
    (= (blocked seg_w1_154c_0_34 airplane_cfbeg) 4) 
    (= (not_blocked seg_n_a4c_0_60 airplane_cfbeg) 1) 
    (= (not_blocked seg_o1_110a_0_34 airplane_daew7) 1) 
    (= (at-segment airplane_cfbeg seg_w1_141b_0_45) 5) 
    (= (occupied seg_p103_0_76) 4) 
    (= (at-segment airplane_cfbeg seg_c3_b_0_80) 2) 
    (= (is-parked airplane_cfbeg seg_p142_0_75) 3) 
    (= (blocked seg_a8_a_0_157_785 airplane_cfbeg) 3) 
    (= (occupied seg_o1_c1c_0_80) 3) 
    (= (not_blocked seg_n_a8a9b_0_75 airplane_daew7) 2) 
    (= (at-segment airplane_daew7 seg_08l_a7a_0_80) 2) 
    (= (at-segment airplane_cfbeg seg_n_a4c_0_60) 1) 
    (= (at-segment airplane_cfbeg seg_w1_c2c_0_34) 2) 
    (= (occupied seg_p115_0_76) 2) 
    (= (not_occupied seg_w1_154a_0_34) 3) 
    (= (blocked seg_09l_0_80 airplane_cfbeg) 3) 
    (= (at-segment airplane_cfbeg seg_n_a6a8b_0_75) 3) 
    (= (not_blocked seg_n_a3a_0_60 airplane_daew7) 5) 
    (= (blocked seg_p152_0_75 airplane_cfbeg) 3) 
    (= (blocked seg_o1_116a_0_34 airplane_cfbeg) 5) 
    (= (not_blocked seg_m_a3a_0_120_934 airplane_cfbeg) 2) 
    (= (not_occupied seg_w1_142c_0_34) 5) 
    (= (not_occupied seg_o1_c2d_0_60) 1) 
    (= (not_blocked seg_w1_164a_0_34 airplane_daew7) 5) 
    (= (not_blocked seg_w1_141c_0_34 airplane_daew7) 5) 
    (= (not_blocked seg_m_a8a9b_0_75 airplane_daew7) 2) 
    (= (blocked seg_o1_109b_0_60 airplane_cfbeg) 1) 
    (= (not_occupied seg_o1_c3b_0_60) 2) 
    (= (not_blocked seg_o1_111c_0_34 airplane_cfbeg) 4) 
    (= (is-parked airplane_daew7 seg_p104_0_76) 2) 
    (= (not_blocked seg_08l_a10b_0_80 airplane_daew7) 1) 
    (= (occupied seg_o1_118b_0_60) 5) 
    (= (not_occupied seg_a8_b_0_80_6226) 3) 
    (= (occupied seg_n_a4a7a_0_115) 3) 
    (= (not_blocked seg_w1_c2a_0_60 airplane_cfbeg) 5) 
    (= (not_blocked seg_c1_n2c_0_60 airplane_cfbeg) 4) 
    (= (not_blocked seg_n1_0_108 airplane_cfbeg) 3) 
    (= (not_blocked seg_n_a2a3a_0_75 airplane_cfbeg) 2) 
    (= (blocked seg_n_a3c_0_60 airplane_daew7) 2) 
    (= (at-segment airplane_cfbeg seg_p141_0_75) 3) 
    (= (at-segment airplane_cfbeg seg_n_a7c_0_60) 4) 
    (= (not_blocked seg_n_a4a7a_0_115 airplane_cfbeg) 4) 
    (= (at-segment airplane_cfbeg seg_w1_161b_0_45) 3) 
 )
 (:bound 25)
 )
