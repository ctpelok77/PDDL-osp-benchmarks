...
(:init
 ...
 (:utility 
    ...
    (= (num-subs l12) 2) 
    (= (num-subs l13) 4) 
    (= (available p27p1-cdk46p1-cycd) 2) 
    (= (chosen cdk46p3-cycdp1) 2) 
    (= (available prbp1-e2f13-dp12p1-ge2) 5) 
    (= (available hdac1-p130-e2f5-dp12-ge2) 3) 
    (= (num-subs l5) 3) 
    (= (num-subs l11) 3) 
    (= (available p21-cdk2p1p2-cycep1) 1) 
    (= (available prbp1) 4) 
    (= (available p57-cdk2p2-cycep1) 1) 
    (= (available prbp1-e2f13-dp12-ge2) 4) 
    (= (chosen hdac1-prbp1-e2f13p1-dp12) 5) 
    (= (available p57-cdk2-cyce) 3) 
    (= (available p27p1-cdk2-cycep1) 5) 
    (= (chosen pcaf) 2) 
    (= (available p21-cdk2-cycep1) 1) 
 )
 (:bound 90)
 )
