...
(:objects
	...
	;; pRbp1-E2F4-DP12 - complex ;; DUPLICATE
...
(:init
 ...
 (:utility 
    ...
    (= (goal19) 10) 
    (= (goal20) 10) 
    (= (available prbp1p2-ap2-ge-c) 1) 
    (= (available cdk2p1p2-cyca) 5) 
    (= (available cdk2-cyce) 2) 
    (= (available raf1-prb-e2f4p1-dp12-ge2) 4) 
    (= (available p27-cdk2-cyca) 2) 
    (= (available p21-cdk2p1-cyca) 3) 
    (= (available hdac1-prb-e2f4p1-dp12) 4) 
    (= (available e2f3-dp12) 1) 
    (= (available p21) 4) 
    (= (available cdk46p2) 5) 
    (= (available cdk7-cych) 5) 
    (= (available prbp2) 1) 
    (= (num-subs l6) 1) 
    (= (available cdk2p1p2-cycb) 2) 
    (= (num-subs l19) 1) 
    (= (available skp2p1-skp1) 3) 
    (= (available gcdc25a) 2) 
    (= (available pcna-p21) 3) 
    (= (available pcna-p21-cdk2-cyce) 2) 
    (= (chosen cdk7) 3) 
    (= (available cdk46p1-cycdp1) 5) 
 )
 (:bound 73)
 )
