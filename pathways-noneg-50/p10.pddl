...
(:init
 ...
 (:utility 
    ...
    (= (goal13) 10) 
    (= (goal14) 10) 
    (= (available prbp1-e2f4p1-dp12-ge2) 3) 
    (= (available cdk2-cyce) 2) 
    (= (available p130) 1) 
    (= (available e2f13-dp12-ge2) 5) 
    (= (available dmp1-cycdp1) 5) 
    (= (num-subs l0) 4) 
    (= (available p130-e2f4-dp12p1) 1) 
    (= (available p57p1-cdk46p1-cycd) 4) 
    (= (available skp2-skp1-cdk2p1-cyca) 3) 
    (= (available e2f1) 2) 
 )
 (:bound 42)
 )
