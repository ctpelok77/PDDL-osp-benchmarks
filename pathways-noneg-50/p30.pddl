...
(:init
 ...
 (:utility 
    ...
    (= (available gcdc25a) 5) 
    (= (available cdk2p2-cyca-e2f13p1) 1) 
    (= (available p27p1-cdk46p2-cycdp1) 3) 
    (= (chosen cycb) 5) 
    (= (available cebp-prbp1-gp) 3) 
    (= (available p21-cdk2p2-cyca) 1) 
    (= (available hbp1-p130) 5) 
    (= (available cdc25ap1) 3) 
    (= (available p57-cdk2p1-cyce) 1) 
    (= (available prb-jun) 4) 
    (= (available dmp1p1-cycd) 2) 
    (= (available p27p1-cdk2p2-cyca) 2) 
    (= (chosen gp) 4) 
    (= (available cdk2p2-cycep1) 5) 
    (= (available pcna-p21-cdk2-cyca) 2) 
    (= (chosen cebp) 3) 
    (= (chosen e2f13) 2) 
