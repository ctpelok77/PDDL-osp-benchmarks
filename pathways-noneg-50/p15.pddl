...
(:init
 ...
 (:utility 
    ...
    (= (goal18) 10) 
    (= (goal19) 10) 
    (= (available prbp1-e2f13p1-dp12-ge2) 4) 
    (= (chosen e2f5) 1) 
    (= (available cdk2p1-cyca) 4) 
    (= (available p21-cdk2-cyce) 5) 
    (= (available ge2) 2) 
    (= (available raf1-cdc25a) 1) 
    (= (available prbp2) 3) 
    (= (available p107) 4) 
    (= (available e2f13) 5) 
    (= (available pcna-p21-cdk2-cycep1) 1) 
    (= (chosen prb-e2f4p1-dp12) 3) 
    (= (available prb-e2f13p1-dp12p1-ge2) 2) 
 )
 (:bound 52)
 )
