...
(define (problem prob-snack)
 ...
 (:utility 
    ...
    (= (served child14) 10) 
    (= (served child15) 10) 
    (= (ontray sandw1 tray2) 1) 
    (= (notexist sandw3) 4) 
    (= (ontray sandw13 tray2) 3) 
    (= (at_kitchen_sandwich sandw17) 5) 
    (= (ontray sandw7 tray2) 2) 
    (= (at_kitchen_content content12) 1) 
    (= (ontray sandw18 tray3) 2) 
    (= (ontray sandw8 tray3) 5) 
 )
 (:bound 12)
 )
