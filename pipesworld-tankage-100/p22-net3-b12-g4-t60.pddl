...
(define (problem p22-net3-b12-g4_rt0_instance)
 ...
 (:utility 
    ...
    (= (normal S13) 10) 
    (= (normal S34) 10) 
    (= (not-occupied ta4-1-gasoleo) 1) 
    (= (last b11 s13) 3) 
    (= (on b6 a4) 5) 
    (= (not-occupied ta3-2-gasoleo) 2) 
    (= (follow b1 b7) 1) 
    (= (follow b5 b5) 4) 
    (= (follow b9 b0) 5) 
    (= (on b8 a3) 3) 
    (= (occupied ta3-2-gasoleo) 4) 
    (= (first b10 s13) 2) 
    (= (follow b7 b3) 2) 
    (= (first b0 s34) 4) 
    (= (not-occupied ta1-2-rat-a) 1) 
    (= (not-occupied ta2-2-rat-a) 3) 
    (= (not-occupied ta2-2-gasoleo) 5) 
 )
 (:bound 30)
 )
