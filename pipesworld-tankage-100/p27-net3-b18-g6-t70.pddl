...
(define (problem p27-net3-b18-g6_rt0_instance)
 ...
 (:utility 
    ...
    (= (normal S34) 10) 
    (= (follow b2 b16) 2) 
    (= (not-occupied ta4-3-oc1b) 4) 
    (= (follow b13 b1) 5) 
    (= (not-occupied ta1-2-oca1) 3) 
    (= (follow b15 b17) 3) 
    (= (not-occupied ta3-1-oc1b) 5) 
    (= (last b15 s13) 4) 
    (= (follow b5 b8) 4) 
    (= (follow b13 b7) 1) 
    (= (occupied ta3-1-gasoleo) 1) 
    (= (on b0 a1) 3) 
    (= (not-occupied ta2-1-rat-a) 1) 
    (= (on b2 a4) 2) 
    (= (occupied ta3-3-oc1b) 4) 
    (= (follow b0 b6) 1) 
    (= (follow b3 b1) 5) 
    (= (not-occupied ta1-2-oc1b) 3) 
    (= (not-occupied ta4-1-rat-a) 2) 
    (= (last b7 s13) 1) 
    (= (occupied ta3-1-oca1) 5) 
    (= (first b2 s34) 4) 
    (= (not-occupied ta3-3-oc1b) 2) 
    (= (follow b8 b7) 2) 
    (= (on b2 a3) 3) 
    (= (last b4 s13) 2) 
    (= (follow b1 b6) 5) 
