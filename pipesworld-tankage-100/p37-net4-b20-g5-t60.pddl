...
(define (problem p37-net4-b20-g5_rt0_instance)
 ...
 (:utility 
    ...
    (= (follow b5 b0) 5) 
    (= (follow b16 b14) 5) 
    (= (occupied ta4-3-lco) 4) 
    (= (follow b6 b17) 3) 
    (= (follow b14 b18) 5) 
    (= (follow b17 b3) 1) 
    (= (last b18 s12) 2) 
    (= (not-occupied ta2-1-gasoleo) 2) 
    (= (follow b13 b7) 3) 
    (= (last b11 s12) 1) 
    (= (on b5 a3) 1) 
    (= (last b12 s23) 2) 
    (= (follow b17 b14) 3) 
    (= (occupied ta1-1-rat-a) 3) 
    (= (not-occupied ta2-3-rat-a) 2) 
    (= (first b5 s12) 5) 
    (= (not-occupied ta1-1-rat-a) 4) 
    (= (last b5 s13) 4) 
    (= (follow b0 b19) 5) 
    (= (follow b6 b14) 4) 
    (= (follow b15 b8) 1) 
    ...
    (= (not-occupied ta2-3-lco) 1) 
    (= (follow b2 b7) 2) 
    (= (last b14 s23) 1) 
    (= (follow b11 b16) 5) 
    (= (follow b9 b13) 3) 
    (= (not-occupied ta4-3-lco) 2) 
    (= (follow b17 b8) 3) 
 )
 (:bound 28)
 )
