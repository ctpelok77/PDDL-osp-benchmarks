...
(define (problem p44-net5-b24-g5_rt0_instance)
 ...
 (:utility 
    ...
    (= (follow b1 b1) 1) 
    (= (follow b23 b20) 1) 
    (= (not-occupied ta4-1-oc1b) 3) 
    (= (follow b12 b16) 1) 
    (= (on b22 a4) 4) 
    (= (on b4 a3) 5) 
    (= (follow b13 b17) 5) 
    (= (follow b0 b3) 4) 
    (= (not-occupied ta5-7-gasoleo) 2) 
    (= (follow b9 b16) 3) 
    (= (last b23 s23) 4) 
    (= (first b21 s13) 5) 
    (= (follow b3 b20) 3) 
    (= (follow b19 b6) 4) 
    (= (last b21 s15) 1) 
    (= (not-occupied ta2-4-oc1b) 5) 
    (= (on b22 a5) 4) 
    (= (occupied ta3-3-oca1) 2) 
    (= (last b11 s12) 4) 
    (= (follow b21 b19) 3) 
    (= (occupied ta3-5-gasoleo) 2) 
    (= (follow b11 b22) 2) 
    (= (follow b2 b0) 5) 
    (= (follow b0 b23) 4) 
    (= (not-occupied ta5-3-oca1) 2) 
    (= (follow b16 b8) 2) 
    (= (follow b6 b5) 4) 
    (= (follow b7 b14) 1) 
    (= (follow b7 b21) 5) 
    (= (last b19 s23) 3) 
    (= (not-occupied ta1-2-gasoleo) 5) 
    (= (follow b0 b2) 2) 
    (= (last b1 s12) 5) 
    (= (last b4 s15) 3) 
    (= (follow b16 b15) 1) 
    (= (last b12 s15) 5) 
    (= (not-occupied ta2-5-oc1b) 2) 
    (= (last b20 s34) 2) 
    (= (last b8 s13) 1) 
    (= (occupied ta3-1-oca1) 1) 
    (= (follow b19 b4) 3) 
    (= (on b8 a4) 4) 
    (= (not-occupied ta3-3-oca1) 3) 
    (= (occupied ta3-1-oc1b) 1) 
    (= (follow b1 b23) 2) 
    (= (not-occupied ta4-1-oca1) 4) 
    (= (not-occupied ta4-2-rat-a) 4) 
    (= (follow b9 b13) 3) 
    (= (follow b4 b7) 1) 
    (= (follow b19 b12) 1) 
    (= (first b9 s15) 5) 
