...
(define (problem p36-net4-b18-g6_rt0_instance)
 ...
 (:utility 
    ...
    (= (follow b7 b6) 2) 
    (= (follow b8 b10) 4) 
    (= (occupied ta3-3-lco) 1) 
    (= (last b1 s23) 2) 
    (= (occupied ta2-2-rat-a) 4) 
    (= (normal s34) 2) 
    (= (occupied ta2-2-lco) 1) 
    (= (first b4 s13) 3) 
    (= (occupied ta1-3-gasoleo) 4) 
    (= (follow b3 b15) 3) 
    (= (follow b2 b6) 3) 
    (= (on b10 a1) 1) 
    (= (on b15 a1) 3) 
    ...
    (= (on b17 a4) 3) 
    (= (first b10 s34) 1) 
    (= (not-occupied ta4-2-lco) 4) 
    (= (last b15 s12) 4) 
    (= (follow b3 b5) 3) 
    (= (last b16 s12) 5) 
    (= (follow b1 b11) 2) 
    (= (last b2 s13) 5) 
    (= (occupied ta3-2-oca1) 4) 
    (= (follow b13 b16) 1) 
    (= (follow b15 b0) 5) 
    (= (occupied ta2-1-gasoleo) 1) 
    (= (not-occupied ta2-1-oc1b) 2) 
 )
 (:bound 49)
 )
