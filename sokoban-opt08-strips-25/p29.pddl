...
(define (problem p145-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-11) 10) 
    (= (at-goal stone-12) 10) 
    (= (at stone-04 pos-08-04) 2) 
    (= (at stone-12 pos-10-05) 5) 
    (= (at player-01 pos-03-06) 4) 
    (= (at stone-08 pos-05-09) 4) 
    (= (at player-01 pos-05-02) 3) 
    (= (at stone-09 pos-06-09) 4) 
    (= (clear pos-06-07) 2) 
    (= (at stone-09 pos-07-02) 1) 
    (= (at stone-03 pos-05-06) 5) 
    (= (at stone-07 pos-04-08) 2) 
    (= (at stone-02 pos-02-05) 1) 
    (= (at stone-12 pos-06-05) 5) 
    (= (at stone-10 pos-06-09) 1) 
    (= (at stone-06 pos-06-09) 2) 
    (= (clear pos-10-07) 2) 
    (= (at player-01 pos-07-03) 3) 
    (= (at stone-10 pos-07-04) 5) 
    (= (at stone-06 pos-06-07) 1) 
    (= (at stone-11 pos-06-05) 5) 
    (= (at stone-12 pos-10-06) 2) 
    (= (at stone-07 pos-06-02) 1) 
    (= (at stone-12 pos-09-07) 4) 
    (= (at stone-07 pos-02-07) 5) 
    (= (at stone-03 pos-05-09) 1) 
    (= (at stone-11 pos-04-04) 5) 
    (= (clear pos-05-05) 3) 
    (= (at player-01 pos-08-04) 3) 
    (= (at stone-01 pos-07-08) 3) 
    (= (at stone-03 pos-06-10) 4) 
    (= (at stone-04 pos-02-06) 3) 
    (= (at stone-09 pos-07-07) 4) 
    (= (at stone-10 pos-04-05) 1) 
    (= (clear pos-09-07) 2) 
    (= (at stone-11 pos-03-05) 3) 
    (= (at stone-03 pos-09-07) 4) 
 )
 (:bound 4)
 (:use-cost-metric)
 )
