...
(define (problem p127-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-03) 10) 
    (= (at-goal stone-04) 10) 
    (= (at stone-03 pos-09-04) 3) 
    (= (at stone-04 pos-02-08) 5) 
    (= (at stone-03 pos-03-05) 4) 
    (= (at stone-01 pos-06-03) 2) 
    (= (at stone-03 pos-06-02) 1) 
    (= (at player-01 pos-02-05) 1) 
    (= (at stone-03 pos-07-07) 5) 
    (= (at stone-03 pos-03-07) 2) 
    (= (at stone-01 pos-08-03) 4) 
    (= (at player-01 pos-08-06) 3) 
 )
 (:bound 8)
 (:use-cost-metric)
 )
