...
(define (problem p095-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-08) 10) 
    (= (clear pos-6-5) 3) 
    (= (at stone-02 pos-6-5) 1) 
    (= (at stone-07 pos-2-7) 4) 
    (= (at stone-07 pos-6-6) 3) 
    (= (at stone-06 pos-4-7) 4) 
    (= (clear pos-2-3) 2) 
    (= (at player-01 pos-3-7) 5) 
    (= (clear pos-2-6) 1) 
    (= (at stone-01 pos-2-6) 1) 
    (= (at stone-06 pos-7-6) 4) 
    (= (at stone-01 pos-6-5) 2) 
    (= (at stone-03 pos-7-3) 2) 
    (= (at stone-07 pos-7-7) 4) 
    (= (at stone-08 pos-3-4) 3) 
    (= (at stone-01 pos-4-3) 1) 
    (= (at stone-04 pos-5-2) 3) 
    (= (at stone-08 pos-5-2) 5) 
    (= (at stone-07 pos-4-3) 5) 
 )
 (:bound 2)
 (:use-cost-metric)
 )
