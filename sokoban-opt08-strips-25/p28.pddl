...
(define (problem p150-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-04) 10) 
    (= (at-goal stone-05) 10) 
    (= (at stone-04 pos-08-04) 1) 
    (= (at stone-05 pos-14-06) 5) 
    (= (clear pos-02-05) 5) 
    (= (at stone-03 pos-04-03) 5) 
    (= (clear pos-10-04) 3) 
    (= (at stone-02 pos-10-04) 1) 
    (= (at stone-03 pos-12-05) 3) 
    (= (clear pos-08-03) 4) 
    (= (at stone-05 pos-08-06) 2) 
    (= (clear pos-13-04) 2) 
    (= (at stone-04 pos-07-06) 4) 
    (= (at player-01 pos-06-05) 2) 
    (= (at player-01 pos-08-06) 4) 
    (= (clear pos-02-08) 1) 
 )
 (:bound 10)
 (:use-cost-metric)
