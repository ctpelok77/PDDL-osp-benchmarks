...
(:init
 ...
 (:utility 
    ...
    (= (location sheet4 htmovercolor_exit-up_topentry) 3) 
    (= (location sheet2 down_bottomentry-colorfeeder_exit) 1) 
    (= (hasimage sheet2 back image-1) 5) 
    (= (stackedin sheet1 finisher2_tray) 2) 
    (= (location sheet2 some_feeder_tray) 4) 
    (= (location sheet3 down_topexit-htmovercolor_entry) 1) 
    (= (location sheet4 htmoverblack_entry-endcap_exit) 2) 
 )
 (:bound 876094)
 (:use-cost-metric)
 )
