...
(:init
 ...
 (:utility 
    ...
    (= (stored goods8 level5) 10) 
    (= (stored goods9 level3) 10) 
    (= (stored goods10 level2) 10) 
    (= (stored goods11 level3) 10) 
    (= (loaded goods10 truck1 level1) 2) 
    (= (on-sale goods2 market3 level0) 3) 
    (= (ready-to-load goods8 market6 level0) 4) 
    (= (loaded goods4 truck4 level2) 2) 
    (= (loaded goods8 truck3 level0) 1) 
    (= (ready-to-load goods6 market2 level0) 4) 
    (= (ready-to-load goods4 market1 level3) 1) 
    (= (ready-to-load goods7 market3 level5) 3) 
    (= (loaded goods6 truck4 level4) 5) 
    (= (ready-to-load goods6 market3 level4) 3) 
    (= (loaded goods6 truck4 level2) 3) 
    (= (loaded goods8 truck5 level0) 1) 
    (= (ready-to-load goods9 market2 level3) 5) 
    (= (on-sale goods10 market2 level2) 5) 
    (= (ready-to-load goods9 market4 level2) 4) 
    (= (ready-to-load goods7 market1 level1) 5) 
    (= (loaded goods2 truck4 level1) 2) 
    (= (on-sale goods1 market2 level0) 1) 
    (= (loaded goods4 truck6 level3) 3) 
    (= (ready-to-load goods2 market2 level1) 4) 
    (= (ready-to-load goods7 market1 level4) 5) 
    (= (on-sale goods9 market1 level0) 4) 
    (= (ready-to-load goods3 market3 level0) 3) 
    (= (ready-to-load goods3 market2 level2) 2) 
    (= (ready-to-load goods3 market5 level0) 4) 
    (= (on-sale goods7 market1 level0) 2) 
    (= (ready-to-load goods5 market2 level1) 5) 
    (= (on-sale goods4 market6 level0) 2) 
    (= (at truck5 market6) 1) 
    (= (loaded goods11 truck3 level0) 4) 
    (= (loaded goods7 truck6 level4) 3) 
    (= (loaded goods11 truck3 level2) 2) 
    (= (ready-to-load goods8 market2 level0) 5) 
    (= (ready-to-load goods3 market3 level5) 1) 
    (= (ready-to-load goods6 market2 level1) 5) 
    (= (on-sale goods5 market5 level1) 5) 
    (= (at truck6 market3) 2) 
    (= (loaded goods3 truck5 level5) 1) 
    (= (loaded goods4 truck2 level3) 3) 
    (= (on-sale goods1 market6 level0) 3) 
