...
(:init
 ...
 (:utility 
    ...
    (= (stored goods7 level5) 10) 
    (= (stored goods8 level2) 10) 
    (= (stored goods9 level6) 10) 
    (= (stored goods10 level1) 10) 
    (= (stored goods11 level1) 10) 
    (= (stored goods12 level1) 10) 
    (= (stored goods13 level6) 10) 
    (= (stored goods14 level4) 10) 
    (= (stored goods15 level5) 10) 
    (= (stored goods16 level3) 10) 
    (= (stored goods17 level3) 10) 
    (= (stored goods18 level4) 10) 
    (= (stored goods12 level5) 3) 
    (= (on-sale goods2 market3 level0) 1) 
    (= (stored goods11 level0) 2) 
    (= (loaded goods2 truck6 level6) 3) 
    (= (loaded goods9 truck5 level1) 4) 
    (= (loaded goods10 truck7 level3) 3) 
    (= (on-sale goods13 market6 level0) 5) 
    (= (loaded goods1 truck2 level6) 5) 
    (= (loaded goods4 truck1 level4) 1) 
    (= (loaded goods18 truck7 level3) 5) 
    (= (ready-to-load goods1 market1 level3) 5) 
    (= (loaded goods15 truck5 level2) 1) 
    (= (ready-to-load goods17 market4 level0) 2) 
    (= (on-sale goods8 market1 level0) 3) 
    (= (loaded goods11 truck6 level5) 5) 
    (= (loaded goods3 truck3 level2) 2) 
    (= (at truck6 market1) 2) 
    (= (ready-to-load goods9 market1 level2) 3) 
    (= (ready-to-load goods7 market2 level5) 3) 
    (= (ready-to-load goods4 market6 level2) 1) 
    (= (loaded goods17 truck3 level6) 5) 
    (= (on-sale goods9 market4 level0) 5) 
    (= (loaded goods9 truck2 level6) 4) 
    (= (ready-to-load goods1 market2 level5) 5) 
    (= (loaded goods10 truck1 level2) 4) 
    (= (loaded goods15 truck3 level0) 1) 
    (= (loaded goods16 truck5 level0) 2) 
    (= (ready-to-load goods9 market5 level6) 4) 
    (= (on-sale goods9 market7 level1) 3) 
    (= (ready-to-load goods5 market2 level1) 4) 
    (= (ready-to-load goods15 market4 level4) 3) 
    (= (ready-to-load goods4 market6 level3) 5) 
    (= (loaded goods9 truck7 level3) 5) 
    (= (on-sale goods8 market3 level0) 4) 
    (= (loaded goods15 truck4 level0) 3) 
    (= (loaded goods16 truck3 level4) 5) 
    (= (on-sale goods18 market4 level0) 3) 
    (= (stored goods11 level5) 3) 
    (= (loaded goods9 truck2 level5) 4) 
    (= (on-sale goods4 market5 level0) 3) 
    (= (loaded goods10 truck3 level3) 2) 
    (= (loaded goods9 truck5 level4) 2) 
    (= (loaded goods11 truck1 level0) 2) 
    (= (loaded goods14 truck7 level0) 5) 
    (= (loaded goods10 truck4 level6) 5) 
    (= (loaded goods17 truck2 level1) 2) 
    (= (loaded goods15 truck3 level2) 4) 
    (= (loaded goods17 truck1 level4) 1) 
    (= (ready-to-load goods18 market3 level4) 1) 
    (= (loaded goods9 truck1 level6) 4) 
    (= (ready-to-load goods7 market4 level0) 5) 
    (= (loaded goods17 truck2 level2) 5) 
    (= (loaded goods6 truck2 level6) 4) 
    (= (loaded goods17 truck5 level5) 1) 
    (= (on-sale goods4 market6 level0) 2) 
    (= (on-sale goods14 market4 level0) 1) 
    (= (ready-to-load goods8 market2 level0) 1) 
    (= (loaded goods13 truck6 level2) 2) 
    (= (ready-to-load goods4 market6 level6) 2) 
    (= (loaded goods13 truck1 level1) 3) 
    (= (ready-to-load goods8 market3 level5) 4) 
    (= (at truck7 depot1) 2) 
    (= (on-sale goods2 market4 level1) 1) 
    (= (ready-to-load goods10 market7 level0) 2) 
    (= (loaded goods2 truck3 level1) 4) 
    (= (stored goods6 level3) 4) 
    (= (on-sale goods9 market1 level1) 1) 
    (= (ready-to-load goods7 market1 level3) 2) 
    (= (ready-to-load goods15 market2 level1) 3) 
    (= (loaded goods9 truck7 level6) 3) 
    (= (loaded goods11 truck5 level0) 1) 
    (= (loaded goods6 truck7 level3) 5) 
    (= (loaded goods4 truck1 level6) 3) 
    (= (ready-to-load goods14 market2 level0) 1) 
    (= (ready-to-load goods8 market6 level0) 4) 
    (= (loaded goods13 truck6 level3) 4) 
    (= (loaded goods14 truck5 level0) 4) 
    (= (ready-to-load goods18 market1 level4) 3) 
    (= (on-sale goods7 market4 level0) 4) 
    (= (on-sale goods18 market3 level1) 5) 
    (= (ready-to-load goods15 market4 level0) 1) 
    (= (loaded goods6 truck5 level2) 2) 
    (= (stored goods10 level2) 2) 
    (= (on-sale goods2 market4 level0) 1) 
    (= (loaded goods8 truck5 level5) 1) 
    (= (loaded goods12 truck7 level3) 1) 
    (= (at truck1 market3) 2) 
    (= (stored goods3 level0) 3) 
 )
 (:bound 157)
 )
