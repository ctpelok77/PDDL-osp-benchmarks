...
(:init
 ...
 (:utility 
    ...
    (= (stored goods4 level3) 10) 
    (= (stored goods5 level3) 10) 
    (= (stored goods6 level5) 10) 
    (= (stored goods7 level1) 10) 
    (= (stored goods8 level4) 10) 
    (= (stored goods9 level1) 10) 
    (= (stored goods10 level2) 10) 
    (= (stored goods11 level3) 10) 
    (= (stored goods12 level3) 10) 
    (= (stored goods13 level6) 10) 
    (= (stored goods14 level4) 10) 
    (= (stored goods15 level3) 10) 
    (= (stored goods16 level2) 10) 
    (= (stored goods17 level1) 10) 
    (= (stored goods18 level1) 10) 
    (= (stored goods19 level3) 10) 
    (= (stored goods20 level2) 10) 
    (= (ready-to-load goods13 market5 level3) 4) 
    (= (loaded goods2 truck4 level0) 1) 
    (= (loaded goods18 truck8 level4) 5) 
    (= (loaded goods10 truck1 level4) 4) 
    (= (on-sale goods5 market5 level2) 2) 
    (= (ready-to-load goods19 market5 level1) 4) 
    (= (ready-to-load goods16 market4 level0) 4) 
    (= (on-sale goods11 market8 level1) 4) 
    (= (loaded goods13 truck4 level1) 3) 
    (= (loaded goods10 truck4 level5) 2) 
    (= (ready-to-load goods6 market5 level1) 2) 
    (= (loaded goods2 truck4 level1) 1) 
    (= (on-sale goods14 market8 level0) 3) 
    (= (at truck1 market8) 2) 
    (= (on-sale goods10 market3 level2) 3) 
    (= (loaded goods6 truck8 level2) 3) 
    (= (ready-to-load goods14 market2 level5) 2) 
    (= (loaded goods10 truck8 level6) 3) 
    (= (ready-to-load goods20 market1 level4) 2) 
    (= (ready-to-load goods4 market2 level1) 4) 
    (= (loaded goods8 truck6 level1) 1) 
    (= (loaded goods19 truck1 level4) 5) 
    (= (loaded goods4 truck2 level3) 5) 
    (= (loaded goods16 truck6 level1) 5) 
    (= (loaded goods12 truck7 level5) 5) 
    (= (ready-to-load goods10 market4 level4) 3) 
    (= (loaded goods1 truck3 level6) 4) 
    (= (loaded goods13 truck1 level4) 4) 
    (= (on-sale goods6 market2 level0) 1) 
    (= (loaded goods20 truck6 level1) 4) 
    (= (loaded goods10 truck1 level2) 1) 
    (= (stored goods7 level2) 5) 
    (= (loaded goods19 truck1 level3) 5) 
    (= (ready-to-load goods3 market2 level2) 1) 
    (= (ready-to-load goods8 market6 level5) 3) 
    (= (loaded goods3 truck2 level2) 2) 
    (= (stored goods16 level3) 4) 
    (= (loaded goods3 truck5 level3) 3) 
    (= (loaded goods9 truck7 level3) 1) 
    (= (loaded goods3 truck2 level4) 2) 
    (= (loaded goods2 truck1 level5) 1) 
    (= (on-sale goods15 market2 level0) 2) 
    (= (loaded goods16 truck5 level5) 5) 
    (= (loaded goods8 truck1 level6) 3) 
    (= (on-sale goods9 market7 level0) 5) 
    (= (loaded goods2 truck3 level3) 2) 
    (= (loaded goods4 truck2 level1) 1) 
    (= (loaded goods18 truck5 level4) 4) 
    (= (ready-to-load goods2 market1 level2) 5) 
    (= (loaded goods14 truck2 level2) 4) 
    (= (on-sale goods18 market6 level0) 5) 
    (= (loaded goods4 truck1 level4) 5) 
    (= (ready-to-load goods8 market7 level1) 4) 
    (= (at truck7 market7) 3) 
    (= (loaded goods20 truck3 level0) 3) 
    (= (loaded goods17 truck8 level4) 5) 
    (= (ready-to-load goods12 market8 level0) 1) 
    (= (loaded goods14 truck6 level4) 2) 
    (= (stored goods20 level3) 1) 
    (= (ready-to-load goods3 market2 level4) 2) 
    (= (ready-to-load goods3 market4 level0) 4) 
    (= (at truck6 depot3) 1) 
    (= (loaded goods5 truck5 level1) 5) 
    (= (loaded goods11 truck4 level4) 5) 
    (= (loaded goods13 truck8 level4) 1) 
    (= (loaded goods5 truck8 level2) 3) 
    (= (ready-to-load goods2 market5 level1) 5) 
    (= (loaded goods12 truck4 level6) 3) 
    (= (stored goods3 level6) 2) 
    (= (loaded goods18 truck4 level3) 5) 
    (= (ready-to-load goods10 market3 level1) 5) 
    (= (loaded goods7 truck6 level5) 4) 
    (= (loaded goods3 truck3 level6) 1) 
    (= (at truck6 market5) 3) 
    (= (loaded goods2 truck3 level1) 2) 
    (= (loaded goods15 truck2 level2) 5) 
    (= (ready-to-load goods15 market1 level5) 2) 
    (= (on-sale goods3 market8 level0) 1) 
    (= (ready-to-load goods4 market3 level1) 4) 
    (= (loaded goods17 truck8 level2) 2) 
    (= (ready-to-load goods1 market6 level4) 3) 
    (= (ready-to-load goods20 market7 level0) 3) 
    (= (loaded goods2 truck3 level0) 3) 
    (= (loaded goods20 truck5 level6) 1) 
    (= (on-sale goods10 market2 level2) 3) 
    (= (ready-to-load goods3 market4 level6) 3) 
    (= (loaded goods2 truck4 level5) 1) 
    (= (loaded goods14 truck7 level3) 2) 
    (= (ready-to-load goods7 market4 level6) 1) 
    (= (loaded goods19 truck3 level6) 3) 
    (= (ready-to-load goods7 market5 level5) 2) 
    (= (loaded goods19 truck8 level3) 2) 
    (= (loaded goods1 truck6 level2) 5) 
    (= (on-sale goods13 market8 level0) 1) 
    (= (stored goods5 level1) 4) 
    (= (ready-to-load goods20 market3 level4) 4) 
    (= (ready-to-load goods10 market2 level3) 2) 
    (= (loaded goods16 truck4 level5) 1) 
    (= (ready-to-load goods15 market6 level5) 2) 
    (= (loaded goods10 truck6 level5) 5) 
    (= (stored goods8 level3) 4) 
    (= (on-sale goods3 market5 level0) 1) 
    (= (at truck7 market4) 5) 
    (= (loaded goods19 truck7 level6) 3) 
    (= (loaded goods9 truck8 level4) 1) 
    (= (loaded goods5 truck8 level4) 4) 
    (= (loaded goods11 truck7 level3) 2) 
    (= (stored goods4 level4) 4) 
    (= (ready-to-load goods2 market4 level3) 4) 
 )
 (:bound 187)
 )
