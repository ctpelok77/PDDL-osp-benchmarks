...
(:init
 ...
 (:utility 
    ...
    (= (ready-to-load goods8 market4 level2) 1) 
    (= (loaded goods3 truck2 level1) 4) 
    (= (on-sale goods5 market2 level0) 2) 
    (= (loaded goods3 truck4 level2) 2) 
    (= (loaded goods4 truck1 level3) 3) 
    (= (at truck3 market2) 3) 
    (= (ready-to-load goods1 market1 level0) 1) 
    (= (on-sale goods9 market3 level0) 5) 
    (= (stored goods1 level3) 1) 
    (= (loaded goods4 truck1 level0) 4) 
    (= (loaded goods8 truck3 level3) 5) 
    (= (on-sale goods3 market2 level0) 4) 
    (= (ready-to-load goods6 market2 level0) 4) 
    (= (stored goods5 level2) 5) 
    (= (loaded goods2 truck3 level3) 3) 
    (= (on-sale goods9 market2 level0) 2) 
    (= (loaded goods7 truck4 level1) 3) 
 )
 (:bound 59)
 )
