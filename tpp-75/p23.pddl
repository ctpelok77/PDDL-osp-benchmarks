...
(:init
 ...
 (:utility 
    ...
    (= (stored goods6 level3) 10) 
    (= (stored goods7 level1) 10) 
    (= (stored goods8 level2) 10) 
    (= (stored goods9 level5) 10) 
    (= (stored goods10 level5) 10) 
    (= (stored goods11 level1) 10) 
    (= (stored goods12 level2) 10) 
    (= (stored goods13 level2) 10) 
    (= (at truck5 market5) 5) 
    (= (on-sale goods3 market2 level2) 5) 
    (= (at truck2 market3) 5) 
    (= (ready-to-load goods13 market4 level0) 5) 
    (= (ready-to-load goods1 market6 level0) 3) 
    (= (loaded goods12 truck6 level4) 4) 
    (= (on-sale goods8 market4 level1) 1) 
    (= (ready-to-load goods8 market4 level1) 2) 
    (= (loaded goods1 truck1 level1) 3) 
    (= (loaded goods5 truck5 level4) 2) 
    (= (loaded goods5 truck6 level0) 2) 
    (= (loaded goods10 truck5 level3) 3) 
    (= (loaded goods12 truck2 level3) 3) 
    (= (loaded goods11 truck6 level0) 5) 
    (= (on-sale goods2 market4 level0) 1) 
    (= (ready-to-load goods6 market2 level1) 5) 
    (= (on-sale goods12 market2 level1) 1) 
    (= (on-sale goods4 market2 level2) 4) 
    (= (ready-to-load goods11 market3 level0) 5) 
    (= (loaded goods7 truck1 level2) 3) 
    (= (ready-to-load goods1 market1 level3) 1) 
    (= (loaded goods8 truck3 level1) 1) 
    (= (loaded goods9 truck2 level5) 1) 
    (= (loaded goods7 truck6 level0) 3) 
    (= (ready-to-load goods7 market1 level4) 4) 
    (= (loaded goods4 truck3 level3) 3) 
    (= (ready-to-load goods2 market1 level3) 3) 
    (= (loaded goods7 truck2 level1) 4) 
    (= (loaded goods11 truck1 level3) 4) 
    (= (ready-to-load goods5 market3 level2) 1) 
    (= (loaded goods11 truck6 level3) 4) 
    (= (loaded goods6 truck5 level0) 1) 
    (= (stored goods11 level3) 2) 
    (= (loaded goods7 truck3 level3) 4) 
    (= (ready-to-load goods8 market4 level0) 5) 
    (= (loaded goods5 truck2 level1) 5) 
    (= (loaded goods7 truck5 level2) 5) 
    (= (at truck2 market1) 4) 
    (= (ready-to-load goods10 market1 level0) 2) 
    (= (loaded goods2 truck3 level5) 3) 
    (= (stored goods4 level0) 2) 
    (= (ready-to-load goods5 market2 level0) 2) 
    (= (ready-to-load goods11 market1 level0) 1) 
    (= (loaded goods7 truck5 level4) 2) 
    (= (ready-to-load goods9 market1 level0) 3) 
    (= (loaded goods9 truck5 level2) 4) 
    (= (ready-to-load goods6 market5 level4) 2) 
    (= (ready-to-load goods8 market2 level2) 2) 
 )
 (:bound 117)
 )
