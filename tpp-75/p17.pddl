...
(:init
 ...
 (:utility 
    ...
    (= (loaded goods3 truck4 level1) 5) 
    (= (loaded goods7 truck3 level0) 5) 
    (= (loaded goods2 truck4 level2) 2) 
    (= (loaded goods2 truck5 level2) 4) 
    (= (loaded goods10 truck1 level4) 3) 
    (= (ready-to-load goods7 market3 level3) 2) 
    (= (loaded goods1 truck4 level2) 2) 
    (= (loaded goods1 truck5 level1) 1) 
    (= (loaded goods10 truck5 level3) 1) 
    (= (loaded goods8 truck5 level4) 4) 
    (= (loaded goods8 truck4 level1) 3) 
    (= (ready-to-load goods5 market3 level0) 5) 
    (= (ready-to-load goods3 market2 level4) 3) 
    (= (on-sale goods3 market3 level0) 1) 
    (= (ready-to-load goods11 market4 level3) 1) 
    (= (loaded goods9 truck4 level2) 3) 
    (= (loaded goods10 truck2 level1) 5) 
    (= (ready-to-load goods8 market3 level0) 3) 
    (= (ready-to-load goods5 market1 level0) 5) 
    (= (loaded goods11 truck3 level2) 4) 
    (= (loaded goods12 truck5 level0) 2) 
    (= (at truck4 market4) 1) 
    (= (loaded goods6 truck5 level2) 3) 
    (= (loaded goods8 truck5 level3) 2) 
    (= (loaded goods9 truck1 level1) 1) 
    (= (ready-to-load goods5 market1 level4) 2) 
    (= (on-sale goods4 market5 level0) 4) 
    (= (on-sale goods12 market2 level0) 4) 
    (= (loaded goods10 truck5 level0) 5) 
    (= (on-sale goods12 market5 level0) 4) 
    (= (stored goods6 level1) 4) 
    (= (at truck3 depot2) 5) 
