...
(:init
 ...
 (:utility 
    ...
    (= (visited loc-x0-y5) 10) 
    (= (visited loc-x0-y8) 10) 
    (= (visited loc-x0-y9) 10) 
    (= (visited loc-x1-y1) 10) 
    (= (visited loc-x1-y5) 10) 
    (= (visited loc-x1-y6) 10) 
    (= (visited loc-x1-y7) 10) 
    (= (visited loc-x1-y9) 10) 
    (= (visited loc-x2-y0) 10) 
    (= (visited loc-x2-y3) 10) 
    (= (visited loc-x2-y5) 10) 
    (= (visited loc-x2-y7) 10) 
    (= (visited loc-x2-y9) 10) 
    (= (visited loc-x3-y0) 10) 
    (= (visited loc-x3-y1) 10) 
    (= (visited loc-x3-y2) 10) 
    (= (visited loc-x3-y8) 10) 
    (= (visited loc-x3-y9) 10) 
    (= (visited loc-x4-y0) 10) 
    (= (visited loc-x4-y2) 10) 
    (= (visited loc-x4-y3) 10) 
    (= (visited loc-x4-y5) 10) 
    (= (visited loc-x4-y7) 10) 
    (= (visited loc-x4-y8) 10) 
    (= (visited loc-x5-y0) 10) 
    (= (visited loc-x5-y1) 10) 
    (= (visited loc-x5-y5) 10) 
    (= (visited loc-x6-y0) 10) 
    (= (visited loc-x6-y1) 10) 
    (= (visited loc-x6-y3) 10) 
    (= (visited loc-x6-y4) 10) 
    (= (visited loc-x6-y5) 10) 
    (= (visited loc-x6-y6) 10) 
    (= (visited loc-x6-y7) 10) 
    (= (visited loc-x6-y8) 10) 
    (= (visited loc-x7-y0) 10) 
    (= (visited loc-x7-y3) 10) 
    (= (visited loc-x7-y4) 10) 
    (= (visited loc-x7-y6) 10) 
    (= (visited loc-x7-y8) 10) 
    (= (visited loc-x8-y1) 10) 
    (= (visited loc-x8-y6) 10) 
    (= (visited loc-x9-y0) 10) 
    (= (visited loc-x9-y4) 10) 
    (= (visited loc-x9-y5) 10) 
    (= (visited loc-x9-y6) 10) 
    (= (visited loc-x9-y9) 10) 
    (= (visited loc-x2-y2) 4) 
    (= (at-robot loc-x4-y9) 5) 
    (= (visited loc-x4-y4) 2) 
    (= (at-robot loc-x1-y3) 1) 
    (= (at-robot loc-x1-y8) 5) 
    (= (at-robot loc-x4-y7) 3) 
    (= (at-robot loc-x5-y4) 4) 
 )
 (:bound 48)
 )
