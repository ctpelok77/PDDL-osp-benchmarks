(define 
 ...
 (:utility 
    ...
    (= (gripper-obstacle x3 y0) 4) 
    (= (gripper-obstacle x0 y7) 2) 
    (= (cart-pos cart x7 y0) 5) 
    (= (base-obstacle x7 y3) 5) 
    (= (base-obstacle x4 y5) 2) 
    (= (base-pos pr2 x1 y0) 1) 
    (= (cart-pos cart x2 y1) 1) 
    (= (gripper-empty pr2) 3) 
    (= (object-pos object1 x4 y4) 3) 
    (= (base-obstacle x6 y1) 4) 
    (= (base-pos pr2 x6 y5) 4) 
    (= (cart-pos cart x1 y4) 2) 
    (= (object-pos object3 x3 y4) 5) 
    (= (base-pos pr2 x2 y1) 1) 
 )
 (:bound 21)
 )
