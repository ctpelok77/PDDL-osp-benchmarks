(define 
 ...
 (:utility 
    ...
    (= (base-pos pr2 x6 y3) 1) 
    (= (base-pos pr2 x0 y7) 1) 
    (= (cart-pos cart x1 y0) 2) 
    (= (object-pos object3 x6 y2) 1) 
    (= (base-obstacle x5 y0) 2) 
    (= (cart-pos cart x6 y7) 4) 
    (= (base-obstacle x2 y7) 2) 
    (= (object-pos object0 x6 y2) 1) 
    (= (base-obstacle x7 y7) 3) 
    (= (not-pushing pr2) 5) 
    (= (base-obstacle x2 y1) 5) 
    (= (cart-pos cart x7 y2) 4) 
    (= (gripper-rel pr2 xrel0 yrel0) 4) 
    (= (gripper-obstacle x8 y4) 5) 
    (= (cart-pos cart x4 y6) 3) 
    (= (cart-pos cart x7 y3) 2) 
    (= (base-obstacle x0 y1) 3) 
 )
 (:bound 30)
 )
