(define 
 ...
 (:utility 
    ...
    (= (base-pos pr2 x7 y4) 5) 
    (= (base-pos pr2 x2 y2) 3) 
    (= (object-pos object2 x4 y2) 2) 
    (= (cart-pos cart x3 y0) 4) 
    (= (gripper-rel pr2 xrel-1 yrel-1) 2) 
    (= (object-pos object1 x4 y3) 2) 
    (= (cart-pos cart x4 y2) 3) 
    (= (base-obstacle x3 y0) 4) 
    (= (base-obstacle x5 y3) 5) 
    (= (base-obstacle x7 y1) 1) 
    (= (base-obstacle x1 y1) 3) 
    (= (on-cart object3 cart) 1) 
    (= (gripper-obstacle x1 y6) 4) 
    (= (cart-pos cart x2 y8) 4) 
    (= (base-obstacle x1 y3) 5) 
    (= (base-obstacle x8 y5) 2) 
    (= (object-pos object0 x1 y6) 1) 
    (= (base-obstacle x6 y1) 5) 
 )
 (:bound 32)
 )
