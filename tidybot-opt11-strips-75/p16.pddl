(define 
  ...
  (:init 
   ...
   (object-pos object0 x6 y6)
   (object-pos object1 x3 y6)
 ...
 (:utility 
    ...
    (= (holding pr2 object2) 4) 
    (= (gripper-obstacle x2 y7) 1) 
    (= (cart-pos cart x1 y0) 3) 
    (= (cart-pos cart x0 y6) 2) 
    (= (gripper-rel pr2 xrel-1 yrel1) 5) 
    (= (gripper-obstacle x5 y2) 2) 
    (= (base-obstacle x1 y2) 5) 
    (= (gripper-obstacle x3 y4) 1) 
    (= (cart-pos cart x6 y1) 5) 
    (= (object-pos object0 x4 y2) 4) 
    (= (cart-pos cart x6 y2) 2) 
    (= (object-pos object1 x4 y6) 1) 
    (= (cart-pos cart x6 y3) 4) 
    (= (base-obstacle x4 y4) 2) 
    (= (base-pos pr2 x0 y0) 3) 
    (= (object-pos object3 x3 y6) 3) 
    (= (object-pos object3 x6 y6) 5) 
    (= (on-cart object2 cart) 3) 
    (= (base-obstacle x5 y4) 4) 
 )
 (:bound 30)
 )
