...
(= (total-cost) 0)
 ...
 (:utility 
    (= (passenger-at p0 n4) 10) 
    (= (passenger-at p1 n8) 10) 
    (= (passenger-at p2 n8) 10) 
    (= (passenger-at p3 n0) 10) 
    (= (passenger-at p4 n10) 10) 
    (= (passenger-at p5 n10) 10) 
    (= (passenger-at p6 n7) 10) 
    (= (lift-at slow2-0 n12) 5) 
    (= (passenger-at p6 n2) 1) 
    (= (passenger-at p0 n5) 5) 
    (= (passenger-at p2 n10) 2) 
    (= (boarded p0 slow2-0) 1) 
    (= (lift-at fast0 n0) 3) 
    (= (lift-at slow2-0 n11) 3) 
 )
 (:bound 42)
 (:use-cost-metric)
 )
