...
(= (total-cost) 0)
 ...
 (:utility 
    ...
    (= (passenger-at p1 n6) 10) 
    (= (passenger-at p2 n0) 10) 
    (= (passenger-at p3 n4) 10) 
    (= (passenger-at p4 n7) 10) 
    (= (passenger-at p5 n6) 10) 
    (= (passenger-at p6 n4) 10) 
    (= (passenger-at p0 n3) 1) 
    (= (lift-at slow0-0 n3) 3) 
    (= (boarded p0 slow1-0) 4) 
    (= (lift-at slow0-0 n1) 2) 
    (= (passenger-at p3 n3) 5) 
 )
 (:bound 25)
 (:use-cost-metric)
 )
