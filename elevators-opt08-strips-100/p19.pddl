...
(= (total-cost) 0)
 ...
 (:utility 
    (= (passenger-at p0 n9) 10) 
    (= (passenger-at p1 n4) 10) 
    (= (passenger-at p2 n10) 10) 
    (= (passenger-at p3 n8) 10) 
    (= (passenger-at p4 n10) 10) 
    (= (passenger-at p5 n12) 10) 
    (= (passenger-at p6 n4) 10) 
    (= (lift-at slow1-0 n6) 4) 
    (= (passenger-at p4 n11) 3) 
    (= (passenger-at p2 n0) 2) 
    (= (passengers slow0-0 n0) 1) 
    (= (passenger-at p1 n7) 1) 
    (= (passenger-at p4 n4) 5) 
 )
 (:bound 160)
 (:use-cost-metric)
 )
