...
(= (total-cost) 0)
 ...
 (:utility 
    (= (passenger-at p0 n3) 10) 
    (= (passenger-at p1 n11) 10) 
    (= (passenger-at p2 n12) 10) 
    (= (passenger-at p3 n1) 10) 
    (= (passenger-at p4 n9) 10) 
    (= (boarded p3 slow0-0) 1) 
    (= (passenger-at p0 n9) 4) 
    (= (lift-at slow0-0 n5) 3) 
    (= (lift-at slow0-0 n0) 5) 
    (= (passenger-at p3 n3) 2) 
 )
 (:bound 87)
 (:use-cost-metric)
 )
