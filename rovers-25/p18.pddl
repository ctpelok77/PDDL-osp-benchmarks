...
(:init
 ...
 (:utility 
    ...
    (= (have_image rover4 objective1 high_res) 2) 
    (= (at rover4 waypoint4) 3) 
    (= (at_rock_sample waypoint13) 2) 
    (= (at rover2 waypoint9) 1) 
    (= (at_rock_sample waypoint9) 1) 
    (= (available rover2) 1) 
    (= (have_image rover1 objective1 high_res) 1) 
    (= (at_soil_sample waypoint14) 2) 
    (= (have_image rover5 objective6 low_res) 2) 
    (= (at rover4 waypoint17) 5) 
    (= (communicated_soil_data waypoint3) 3) 
    (= (have_rock_analysis rover3 waypoint12) 3) 
    (= (have_image rover4 objective6 colour) 5) 
    (= (at rover5 waypoint10) 4) 
    (= (have_image rover3 objective1 colour) 4) 
    (= (have_rock_analysis rover5 waypoint9) 5) 
    (= (at_soil_sample waypoint11) 5) 
 )
 (:bound 10)
 )
