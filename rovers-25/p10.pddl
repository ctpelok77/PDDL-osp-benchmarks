...
(:init
 ...
 (:utility 
    ...
    (= (have_image rover3 objective0 high_res) 1) 
    (= (have_soil_analysis rover0 waypoint3) 4) 
    (= (have_soil_analysis rover3 waypoint6) 3) 
    (= (empty rover0store) 2) 
    (= (have_image rover1 objective2 high_res) 5) 
 )
 (:bound 9)
 )
