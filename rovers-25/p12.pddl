...
(:init
 ...
 (:utility 
    ...
    (= (have_image rover3 objective1 high_res) 5) 
    (= (communicated_image_data objective0 high_res) 2) 
    (= (communicated_image_data objective3 high_res) 3) 
    (= (have_image rover3 objective0 low_res) 1) 
    (= (channel_free general) 4) 
 )
 (:bound 4)
 )
