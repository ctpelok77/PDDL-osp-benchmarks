...
(:init
 ...
 (:utility 
    ...
    (= (at rover1 waypoint2) 5) 
    (= (have_soil_analysis rover0 waypoint0) 4) 
    (= (at rover6 waypoint37) 1) 
    (= (empty rover6store) 4) 
    (= (at rover8 waypoint17) 5) 
    (= (at rover2 waypoint28) 4) 
    (= (have_soil_analysis rover2 waypoint23) 3) 
    (= (at rover6 waypoint26) 1) 
    (= (at rover8 waypoint13) 5) 
    (= (at rover3 waypoint8) 4) 
    (= (at rover0 waypoint32) 2) 
    (= (at rover2 waypoint42) 5) 
    (= (have_soil_analysis rover2 waypoint2) 5) 
    (= (at rover5 waypoint33) 1) 
    (= (have_soil_analysis rover8 waypoint31) 1) 
    (= (at rover4 waypoint27) 3) 
    (= (at rover9 waypoint24) 1) 
    (= (at rover1 waypoint3) 2) 
    (= (at rover4 waypoint25) 4) 
    (= (have_rock_analysis rover7 waypoint38) 1) 
    (= (at rover8 waypoint28) 4) 
    (= (at rover3 waypoint12) 3) 
    (= (at rover7 waypoint9) 3) 
    (= (at rover7 waypoint18) 3) 
    (= (at rover8 waypoint18) 5) 
    (= (have_soil_analysis rover9 waypoint22) 1) 
    (= (have_image rover6 objective0 low_res) 5) 
    (= (at rover3 waypoint1) 4) 
    (= (at_soil_sample waypoint35) 4) 
    (= (have_image rover4 objective5 colour) 3) 
    (= (have_image rover1 objective5 colour) 4) 
    (= (have_image rover8 objective1 low_res) 2) 
    (= (at_rock_sample waypoint36) 2) 
    (= (at rover0 waypoint6) 3) 
    (= (at rover7 waypoint13) 5) 
    (= (at rover1 waypoint16) 3) 
    (= (at rover5 waypoint15) 2) 
    (= (empty rover9store) 2) 
    (= (at rover1 waypoint11) 5) 
    (= (at_rock_sample waypoint38) 2) 
    (= (have_soil_analysis rover3 waypoint0) 4) 
    (= (at rover8 waypoint41) 2) 
    (= (at rover3 waypoint22) 1) 
    (= (at rover8 waypoint3) 3) 
    (= (have_image rover4 objective6 colour) 5) 
    (= (at rover6 waypoint25) 1) 
