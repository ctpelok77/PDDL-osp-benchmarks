...
(:init
 ...
 (:utility 
    ...
    (= (communicated_rock_data waypoint27) 10) 
    ...
    (= (have_rock_analysis rover6 waypoint39) 3) 
    (= (have_image rover1 objective0 colour) 3) 
    (= (have_rock_analysis rover9 waypoint33) 1) 
    (= (communicated_soil_data waypoint34) 2) 
    (= (have_soil_analysis rover3 waypoint10) 1) 
    (= (have_soil_analysis rover4 waypoint17) 2) 
    (= (have_soil_analysis rover4 waypoint25) 3) 
    (= (have_rock_analysis rover2 waypoint17) 5) 
    (= (communicated_soil_data waypoint12) 5) 
    (= (at rover0 waypoint32) 1) 
    (= (have_soil_analysis rover8 waypoint2) 5) 
    (= (at rover7 waypoint4) 5) 
    (= (at rover4 waypoint21) 4) 
    (= (have_image rover8 objective6 colour) 1) 
    (= (at rover3 waypoint29) 1) 
    (= (at rover1 waypoint19) 4) 
    (= (have_image rover7 objective7 colour) 1) 
    (= (at rover8 waypoint36) 5) 
    (= (calibrated camera8 rover9) 4) 
    (= (have_soil_analysis rover0 waypoint24) 3) 
    (= (at rover1 waypoint29) 1) 
    (= (have_image rover6 objective2 high_res) 2) 
    (= (have_rock_analysis rover2 waypoint5) 2) 
    (= (have_image rover3 objective2 colour) 3) 
    (= (have_image rover8 objective6 high_res) 3) 
    (= (calibrated camera12 rover3) 5) 
    (= (at rover7 waypoint27) 1) 
    (= (have_soil_analysis rover4 waypoint0) 3) 
    (= (communicated_image_data objective6 colour) 5) 
    (= (have_soil_analysis rover4 waypoint10) 3) 
    (= (at rover9 waypoint14) 4) 
    (= (at rover7 waypoint25) 4) 
    (= (at_rock_sample waypoint27) 2) 
    (= (at rover7 waypoint38) 4) 
    (= (available rover6) 4) 
    (= (full rover3store) 2) 
    (= (have_image rover0 objective2 high_res) 3) 
    (= (communicated_image_data objective6 low_res) 2) 
    (= (have_rock_analysis rover6 waypoint12) 5) 
    (= (full rover4store) 4) 
    (= (have_soil_analysis rover4 waypoint34) 2) 
    (= (have_soil_analysis rover8 waypoint32) 2) 
    (= (at rover7 waypoint8) 5) 
    (= (at rover0 waypoint38) 4) 
 )
 (:bound 18)
 )
