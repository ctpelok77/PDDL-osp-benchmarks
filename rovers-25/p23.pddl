...
(:init
 ...
 (:utility 
    ...
    (= (communicated_soil_data waypoint27) 10) 
    ...
    (= (at rover2 waypoint9) 5) 
    (= (at rover2 waypoint34) 4) 
    (= (at rover1 waypoint21) 4) 
    (= (have_image rover7 objective8 high_res) 5) 
    (= (at rover7 waypoint10) 3) 
    (= (have_image rover1 objective7 high_res) 4) 
    (= (have_soil_analysis rover3 waypoint9) 2) 
    (= (have_rock_analysis rover5 waypoint21) 5) 
    (= (calibrated camera7 rover7) 3) 
    (= (at rover5 waypoint16) 2) 
    (= (have_rock_analysis rover6 waypoint27) 2) 
    (= (at rover7 waypoint21) 4) 
    (= (have_rock_analysis rover0 waypoint27) 1) 
    (= (communicated_image_data objective0 high_res) 4) 
    (= (at rover5 waypoint6) 5) 
    (= (at rover7 waypoint33) 3) 
    (= (at rover6 waypoint24) 3) 
    (= (have_rock_analysis rover6 waypoint21) 1) 
    (= (have_image rover7 objective1 low_res) 1) 
    (= (at rover3 waypoint18) 1) 
    (= (have_image rover7 objective4 high_res) 5) 
    (= (at rover1 waypoint24) 1) 
    (= (have_rock_analysis rover1 waypoint38) 3) 
    (= (have_rock_analysis rover5 waypoint2) 2) 
    (= (have_image rover7 objective1 high_res) 5) 
    (= (have_soil_analysis rover1 waypoint12) 4) 
    (= (at rover5 waypoint19) 2) 
    (= (at rover0 waypoint33) 3) 
    (= (at rover4 waypoint18) 3) 
    (= (at rover1 waypoint14) 1) 
    (= (at rover1 waypoint22) 2) 
    (= (have_rock_analysis rover7 waypoint20) 4) 
    (= (have_image rover3 objective0 low_res) 5) 
    (= (have_rock_analysis rover5 waypoint38) 1) 
    (= (have_image rover4 objective8 high_res) 5) 
    (= (at rover0 waypoint37) 5) 
    (= (communicated_rock_data waypoint23) 1) 
    (= (at rover6 waypoint25) 2) 
    (= (have_soil_analysis rover3 waypoint2) 4) 
 )
 (:bound 19)
 )
