(define (problem scanalyzer3d-39)
 ...
 (:utility 
    ...
    (= (on car-in-6 seg-in-4) 2) 
    (= (on car-in-4 seg-in-1) 3) 
    (= (on car-out-3 seg-in-3) 2) 
    (= (on car-in-1 seg-in-8) 1) 
    (= (on car-in-7 seg-out-1) 4) 
    (= (on car-in-6 seg-out-2) 5) 
    (= (on car-out-1 seg-in-6) 3) 
    (= (on car-in-4 seg-in-5) 5) 
    (= (on car-out-3 seg-out-4) 3) 
    (= (on car-out-6 seg-in-8) 4) 
    (= (on car-in-4 seg-in-7) 5) 
    (= (on car-out-5 seg-in-7) 4) 
 )
 (:bound 48)
 (:use-cost-metric)
 )
