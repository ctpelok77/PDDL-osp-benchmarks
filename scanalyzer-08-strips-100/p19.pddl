(define (problem scanalyzer3d-44)
 ...
 (:utility 
    ...
    (= (on car-in-2 seg-out-8) 1) 
    (= (on car-out-4 seg-in-9) 2) 
    (= (on car-in-9 seg-out-1) 3) 
    (= (on car-in-3 seg-in-5) 5) 
    (= (on car-in-9 seg-out-3) 1) 
    (= (on car-in-1 seg-in-5) 5) 
    (= (on car-out-3 seg-out-2) 4) 
    (= (on car-in-7 seg-out-1) 2) 
    (= (on car-in-4 seg-in-9) 4) 
    (= (on car-out-2 seg-in-1) 2) 
    (= (on car-in-1 seg-in-3) 4) 
    (= (on car-out-8 seg-in-5) 5) 
    (= (on car-out-9 seg-in-5) 3) 
    (= (on car-in-8 seg-out-4) 1) 
    (= (on car-out-9 seg-in-1) 3) 
 )
 (:bound 54)
 (:use-cost-metric)
 )
