(define (problem scanalyzer3d-36)
 ...
 (:utility 
    ...
    (= (on car-out-5 seg-in-1) 1) 
    (= (on car-in-2 seg-out-3) 5) 
    (= (on car-out-5 seg-out-8) 5) 
    (= (on car-out-7 seg-in-5) 3) 
    (= (on car-in-6 seg-in-4) 4) 
    (= (on car-in-5 seg-in-6) 2) 
    (= (on car-out-6 seg-out-3) 1) 
    (= (on car-out-7 seg-in-7) 3) 
    (= (on car-in-4 seg-out-2) 2) 
    (= (on car-out-1 seg-out-6) 2) 
    (= (on car-out-8 seg-out-7) 4) 
    (= (on car-out-1 seg-out-5) 4) 
 )
 (:bound 96)
 (:use-cost-metric)
 )
