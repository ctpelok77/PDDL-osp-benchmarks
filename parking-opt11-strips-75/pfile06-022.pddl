(define   (problem parking)
 ...
 (:utility 
    ...
    (= (at-curb-num car_12 curb_9) 1) 
    (= (behind-car car_02 car_04) 5) 
    (= (at-curb-num car_17 curb_5) 3) 
    (= (at-curb-num car_12 curb_5) 4) 
    (= (behind-car car_10 car_06) 4) 
    (= (curb-clear curb_0) 3) 
    (= (behind-car car_06 car_14) 2) 
    (= (at-curb-num car_11 curb_8) 5) 
    (= (at-curb-num car_12 curb_7) 5) 
    (= (at-curb-num car_05 curb_8) 2) 
    (= (behind-car car_15 car_13) 5) 
    (= (behind-car car_06 car_10) 4) 
    (= (behind-car car_00 car_17) 3) 
    (= (behind-car car_06 car_06) 1) 
    (= (at-curb-num car_08 curb_9) 2) 
    (= (behind-car car_12 car_11) 4) 
    (= (behind-car car_15 car_00) 4) 
    (= (at-curb-num car_04 curb_1) 5) 
    (= (behind-car car_04 car_12) 3) 
    (= (at-curb-num car_17 curb_4) 2) 
    (= (at-curb-num car_08 curb_0) 2) 
    (= (behind-car car_10 car_07) 3) 
    (= (at-curb car_08) 1) 
    (= (behind-car car_07 car_15) 2) 
    (= (at-curb-num car_00 curb_2) 5) 
    (= (behind-car car_13 car_04) 1) 
 )
 (:bound 23)
 (:use-cost-metric)
 )
