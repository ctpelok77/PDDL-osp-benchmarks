...
(:init
 ...
 (:utility 
    ...
    (= (location sheet4 rh1_entry-rh2_exit) 3) 
    (= (notprintedwith sheet3 back color) 2) 
    (= (location sheet2 lbe_entry-lc1_offramp) 4) 
    (= (hasimage sheet3 front image-2) 5) 
    (= (location sheet1 rh1_exit-im1_returnentry) 4) 
    (= (location sheet3 rh1_entry-rh2_exit) 1) 
    (= (location sheet3 fe1_exit-im1_feedentry) 5) 
