...
(:init
 ...
 (:utility 
    ...
    (= (Stackedin sheet10 Finisher1_Tray) 10) 
    (= (location sheet8 htmovercolor_exit-up_topentry) 4) 
    (= (notprintedwith sheet10 front black) 3) 
    (= (hasimage sheet8 front image-4) 4) 
    (= (hasimage sheet7 front image-2) 2) 
    (= (hasimage sheet4 front image-7) 1) 
    (= (location sheet9 finisher2_entry-finisher1_exit) 5) 
    (= (hasimage sheet7 back image-1) 5) 
    (= (hasimage sheet1 back image-9) 4) 
    (= (hasimage sheet3 front image-4) 3) 
    (= (hasimage sheet1 back image-7) 3) 
    (= (location sheet4 colorcontainer_exit-up_bottomentry) 5) 
    (= (stackedin sheet5 finisher1_tray) 5) 
    (= (stackedin sheet10 finisher2_tray) 1) 
    (= (hasimage sheet1 front image-10) 2) 
    (= (notprintedwith sheet2 back color) 2) 
    (= (hasimage sheet10 back image-10) 3) 
    (= (hasimage sheet10 front image-1) 5) 
    (= (hasimage sheet6 front image-1) 4) 
    (= (notprintedwith sheet5 back black) 2) 
    (= (location sheet6 htmoverblack_entry-endcap_exit) 2) 
    (= (hasimage sheet5 back image-9) 4) 
    (= (location sheet2 endcap_entry-blackcontainer_exit) 1) 
