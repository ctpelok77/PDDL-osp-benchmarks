...
(:init
 ...
 (:utility 
    ...
    (= (location sheet6 lc1_entry-hw1_bottomleftexit) 1) 
    (= (sideup sheet7 back) 3) 
    (= (notprintedwith sheet1 front color) 3) 
    (= (hasimage sheet1 back image-1) 2) 
    (= (available uime-rsrc) 5) 
    (= (location sheet6 hw1_toprightentry-uc1_exit) 1) 
    (= (location sheet4 hw1_toprightentry-uc1_exit) 4) 
    (= (location sheet2 lc1_exit-hw1_bottomrightentry) 4) 
    (= (notprintedwith sheet4 back color) 4) 
    (= (location sheet6 some_feeder_tray) 3) 
    (= (hasimage sheet5 back image-1) 2) 
    (= (hasimage sheet4 front image-2) 1) 
 )
 (:bound 635437)
 (:use-cost-metric)
 )
