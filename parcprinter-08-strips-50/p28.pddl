...
(:init
 ...
 (:utility 
    ...
    (= (sideup sheet6 back) 2) 
    (= (sideup sheet7 back) 4) 
    (= (location sheet5 lc1_entry-hw1_bottomleftexit) 5) 
    (= (hasimage sheet5 front image-3) 2) 
    (= (hasimage sheet2 front image-6) 4) 
    (= (location sheet4 hw1_toprightentry-uc1_exit) 1) 
    (= (location sheet2 lime_entry-lc1_exittoime) 4) 
    (= (notprintedwith sheet4 back color) 1) 
    (= (location sheet3 some_finisher_tray) 3) 
    (= (location sheet1 some_feeder_tray) 3) 
    (= (notprintedwith sheet6 back color) 2) 
    (= (notprintedwith sheet3 back black) 5) 
    (= (hasimage sheet1 front image-6) 1) 
    (= (sideup sheet5 back) 3) 
 )
 (:bound 840641)
 (:use-cost-metric)
 )
