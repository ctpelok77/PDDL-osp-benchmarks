...
(:init
 ...
 (:utility 
    ...
    (= (location sheet5 blackcontainer_entry-blackfeeder_exit) 1) 
    (= (location sheet2 down_bottomentry-colorfeeder_exit) 1) 
    (= (location sheet1 blackcontainer_entry-blackfeeder_exit) 5) 
    (= (hasimage sheet2 front image-1) 2) 
    (= (hasimage sheet3 front image-3) 4) 
    (= (notprintedwith sheet4 front black) 2) 
    (= (hasimage sheet1 front image-3) 5) 
    (= (location sheet1 colorcontainer_entry-down_bottomexit) 3) 
    (= (location sheet3 down_topexit-htmovercolor_entry) 3) 
 )
 (:bound 572566)
 (:use-cost-metric)
 )
