(define (problem scanalyzer3d-34)
 ...
 (:utility 
    ...
    (= (on car-in-1 seg-out-2) 3) 
    (= (on car-out-4 seg-in-2) 2) 
    (= (on car-out-6 seg-in-1) 4) 
    (= (on car-in-5 seg-in-3) 2) 
    (= (on car-in-1 seg-out-5) 4) 
    (= (on car-in-2 seg-out-1) 1) 
    (= (on car-out-6 seg-out-5) 5) 
    (= (on car-in-6 seg-out-2) 3) 
    (= (on car-in-2 seg-out-4) 1) 
 )
 (:bound 31)
 (:use-cost-metric)
 )
