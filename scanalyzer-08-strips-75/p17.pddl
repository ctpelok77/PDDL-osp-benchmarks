(define (problem scanalyzer3d-37)
 ...
 (:utility 
    ...
    (= (on car-in-5 seg-in-8) 2) 
    (= (on car-in-7 seg-out-5) 3) 
    (= (on car-in-6 seg-out-7) 5) 
    (= (on car-out-2 seg-in-8) 2) 
    (= (on car-in-7 seg-out-2) 3) 
    (= (on car-out-6 seg-in-3) 3) 
    (= (on car-out-5 seg-out-4) 4) 
    (= (on car-in-1 seg-out-7) 1) 
    (= (on car-out-8 seg-in-4) 1) 
    (= (on car-out-4 seg-in-4) 4) 
    (= (on car-in-7 seg-out-6) 5) 
    (= (on car-in-3 seg-out-8) 2) 
 )
 (:bound 66)
 (:use-cost-metric)
 )
