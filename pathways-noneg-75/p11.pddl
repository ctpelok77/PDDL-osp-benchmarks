...
(:init
 ...
 (:utility 
    ...
    (= (goal15) 10) 
    (= (chosen sp1) 2) 
    (= (available p130-e2f4p1-dp12) 1) 
    (= (chosen p130-e2f4p1-dp12) 5) 
    (= (chosen hdac1-p130-e2f4p1-dp12) 3) 
    (= (available pcaf) 1) 
    (= (chosen cdk2p2-cycb) 4) 
    (= (available sp1-p107p1-gp) 2) 
    (= (available m1433-cdc25cp2) 3) 
    (= (available raf1-p130-e2f5-dp12-ge2) 4) 
    (= (available pcna-p21-cdk2p1-cyca) 5) 
 )
 (:bound 62)
 )
