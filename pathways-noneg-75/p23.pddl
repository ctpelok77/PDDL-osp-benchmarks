...
(:init
 ...
 (:utility 
    ...
    (= (goal29) 10) 
    (= (goal30) 10) 
    (= (available hdac1-p130-e2f4p1-dp12-ge2) 5) 
    (= (available e2f4-dp12) 2) 
    (= (available cdk46p1) 2) 
    (= (available p130-e2f5-dp12p1-ge2) 4) 
    (= (available ap2) 4) 
    (= (chosen p53) 1) 
    (= (chosen ge-c) 3) 
    (= (num-subs l8) 2) 
    (= (available hdac1-p130-e2f5p1-dp12) 5) 
    (= (available prbp1-e2f13-dp12-ge2) 2) 
    (= (available hdac1-p130-e2f4-dp12p1) 4) 
    (= (available p57-cdk2-cyce) 3) 
    (= (available e2f6-dp12p1-ge2) 3) 
    (= (available hdac1-p107-e2f4-dp12) 1) 
    (= (available pcna-p21-cdk2-cycep1) 5) 
    (= (available cebp-prbp2-gp) 4) 
    (= (available mdm2-e2f13-dp12) 3) 
    (= (chosen dp12) 1) 
 )
 (:bound 136)
 )
