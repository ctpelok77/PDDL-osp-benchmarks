...
(:init
 ...
 (:utility 
    ...
    (= (goal26) 10) 
    (= (goal27) 10) 
    (= (available e2f4-dp12) 1) 
    (= (available cdk1p1p2) 3) 
    (= (available cdk2-cyce) 2) 
    (= (chosen e2f1) 5) 
    (= (available p27p1-cdk2p2-cyca) 1) 
    (= (available skp2-skp1-cdk2p1p2-cyca) 3) 
    (= (available p27) 2) 
    (= (available p57-cdk2p1p2-cyce) 2) 
    (= (chosen cdk2p1) 3) 
    (= (available p57-cdk2p2-cycep1) 3) 
    (= (available mdm2-prb) 4) 
    (= (available p57-cdk46p1-cycd) 4) 
    (= (available cdk2p2) 1) 
    (= (chosen p53) 2) 
    (= (chosen rpa) 5) 
    (= (available cebp-prbp2) 5) 
    (= (available cdk1p2-gadd45) 4) 
    (= (available e2f1) 4) 
 )
 (:bound 168)
 )
