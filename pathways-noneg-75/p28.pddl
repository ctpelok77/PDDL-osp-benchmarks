...
(:init
 ...
 (:utility 
    ...
    (= (goal36) 10) 
    (= (goal37) 10) 
    (= (available raf1-cdc25ap1) 3) 
    (= (available e2f6-dp12) 2) 
    (= (chosen sp1) 1) 
    (= (available cdk46p3-cycd) 2) 
    (= (available p107) 5) 
    (= (available cdk2p1-cyca-e2f13p1) 1) 
    (= (available pcna-gadd45) 3) 
    (= (available c-abl-prb) 1) 
    (= (available raf1-prb-e2f13-dp12p1) 2) 
    (= (available p16-cdk7) 5) 
    (= (available p21-gadd45) 1) 
    (= (num-subs l5) 4) 
    (= (available prbp2-ap2) 3) 
    (= (available hdac1-prbp1-e2f4-dp12-ge2) 3) 
    (= (available pcna-p21-cdk2p1-cyce) 4) 
    (= (available hbp1-p130) 5) 
    (= (chosen e2f5) 5) 
    (= (available mdm2-prb) 4) 
    (= (num-subs l22) 4) 
    (= (num-subs l30) 1) 
    (= (available cdk46p2) 5) 
    (= (available sp1-e2f13-gp) 3) 
    (= (available e2f13-dp12-ge2) 2) 
 )
 (:bound 160)
 )
