...
(:init
 ...
 (:utility 
    ...
    (= (goal28) 10) 
    (= (num-subs l12) 4) 
    (= (available p57-cdk46-cycd) 2) 
    (= (available cdk1p1p2-cks1) 5) 
    (= (chosen gp19arf) 3) 
    (= (num-subs l14) 4) 
    (= (available skp2-skp1p1-cdk2p1-cyca) 1) 
    (= (available cdk2p1p2-cyca-e2f13) 3) 
    (= (available cdk46p1-cycd) 1) 
    (= (chosen raf1) 3) 
    (= (available e2f13p1-dp12-ge2) 1) 
    (= (available dmp1) 2) 
    (= (available p57p1-cdk46p1p2-cycdp1) 4) 
    (= (num-subs l13) 5) 
    (= (available prbp1-e2f13p1-dp12p1) 3) 
    (= (available mdm2-e2f13p1-dp12p1) 1) 
    (= (chosen p16) 2) 
    (= (chosen e2f5) 5) 
    (= (available pcna-p21-cdk2-cyce) 2) 
    (= (available hdac1-prbp1-e2f4-dp12) 5) 
    (= (available cdk46p2) 4) 
 )
 (:bound 114)
 )
