(define 
 ...
 (:utility 
    ...
    (= (base-pos pr2 x0 y7) 3) 
    (= (gripper-obstacle x5 y1) 2) 
    (= (cart-pos cart x4 y4) 5) 
    (= (cart-pos cart x7 y5) 1) 
    (= (gripper-obstacle x2 y1) 5) 
    (= (base-obstacle x0 y5) 4) 
    (= (gripper-obstacle x0 y1) 4) 
    (= (base-obstacle x7 y5) 1) 
    (= (base-obstacle x6 y0) 5) 
    (= (base-obstacle x0 y0) 4) 
    (= (gripper-obstacle x6 y3) 2) 
