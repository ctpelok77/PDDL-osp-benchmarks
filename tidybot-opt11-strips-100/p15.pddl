(define 
 ...
 (:utility 
    ...
    (= (base-pos pr2 x3 y3) 4) 
    (= (object-pos object2 x3 y3) 5) 
    (= (base-obstacle x2 y5) 5) 
    (= (base-pos pr2 x3 y2) 3) 
    (= (base-obstacle x7 y0) 2) 
    (= (base-pos pr2 x2 y7) 1) 
    (= (object-pos object0 x2 y4) 4) 
    (= (base-obstacle x1 y1) 5) 
    (= (base-obstacle x1 y3) 3) 
    (= (cart-pos cart x3 y7) 2) 
    (= (base-obstacle x7 y4) 2) 
    (= (base-pos pr2 x2 y0) 5) 
    (= (base-pos pr2 x0 y1) 2) 
    (= (base-obstacle x0 y2) 1) 
    (= (base-obstacle x3 y0) 1) 
    (= (object-pos object2 x6 y6) 4) 
    (= (base-obstacle x3 y7) 4) 
 )
 (:bound 47)
 )
