(define 
 ...
 (:utility 
    ...
    (= (object-pos object1 x2 y3) 2) 
    (= (gripper-obstacle x6 y5) 3) 
    (= (cart-pos cart x3 y0) 2) 
    (= (cart-pos cart x4 y2) 5) 
    (= (gripper-obstacle x7 y7) 5) 
    (= (cart-pos cart x5 y5) 1) 
    (= (gripper-obstacle x1 y7) 3) 
    (= (base-pos pr2 x5 y5) 4) 
    (= (base-obstacle x6 y1) 4) 
    (= (base-obstacle x4 y0) 1) 
    (= (base-obstacle x3 y3) 2) 
    (= (cart-pos cart x4 y5) 5) 
 )
 (:bound 27)
 )
