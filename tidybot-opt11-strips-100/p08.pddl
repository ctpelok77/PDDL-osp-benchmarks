(define 
 ...
 (:utility 
    ...
    (= (gripper-obstacle x0 y3) 4) 
    (= (base-obstacle x5 y1) 5) 
    (= (base-obstacle x0 y4) 3) 
    (= (base-pos pr2 x4 y5) 1) 
    (= (cart-pos cart x6 y0) 1) 
    (= (gripper-obstacle x6 y0) 2) 
    (= (holding pr2 object1) 4) 
    (= (base-pos pr2 x0 y0) 1) 
    (= (object-pos object3 x2 y3) 5) 
 )
 (:bound 37)
 )
