(define 
 ...
 (:utility 
    ...
    (= (cart-pos cart x2 y4) 5) 
    (= (cart-pos cart x1 y6) 1) 
    (= (base-obstacle x2 y5) 4) 
    (= (base-pos pr2 x5 y1) 3) 
    (= (cart-pos cart x7 y5) 1) 
    (= (base-obstacle x2 y6) 5) 
    (= (base-pos pr2 x7 y1) 1) 
    (= (object-pos object3 x4 y4) 5) 
    (= (cart-pos cart x7 y0) 2) 
    (= (base-obstacle x7 y5) 2) 
    (= (base-pos pr2 x7 y7) 4) 
    (= (gripper-obstacle x3 y3) 2) 
    (= (gripper-rel pr2 xrel0 yrel0) 3) 
    (= (cart-pos cart x2 y3) 4) 
    (= (parked pr2) 1) 
    (= (base-obstacle x6 y0) 3) 
    (= (base-pos pr2 x5 y7) 5) 
    (= (base-obstacle x1 y8) 2) 
 )
 (:bound 25)
 )
