...
(define (problem transport-two-cities-sequential-12nodes-1000size-3degree-100mindistance-2trucks-5packages-2014seed)
 ...
 (:utility 
    (= (at package-1 city-2-loc-7) 10) 
    (= (at package-2 city-2-loc-5) 10) 
    (= (at package-3 city-2-loc-10) 10) 
    (= (at package-4 city-2-loc-4) 10) 
    (= (at package-5 city-2-loc-12) 10) 
    (= (at package-1 city-2-loc-6) 1) 
    (= (at package-4 city-2-loc-12) 3) 
    (= (at package-4 city-1-loc-8) 2) 
    (= (at package-4 city-1-loc-6) 1) 
    (= (capacity truck-2 capacity-4) 5) 
    (= (at package-1 city-1-loc-4) 3) 
    (= (capacity truck-1 capacity-1) 2) 
    (= (at package-4 city-2-loc-6) 4) 
    (= (at package-4 city-1-loc-12) 5) 
 )
 (:bound 1031)
 (:use-cost-metric)
 )
