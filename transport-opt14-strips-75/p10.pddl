...
(define (problem transport-two-cities-sequential-15nodes-1000size-3degree-100mindistance-3trucks-5packages-2014seed)
 ...
 (:utility 
    ...
    (= (at package-2 city-2-loc-13) 10) 
    (= (at package-3 city-2-loc-3) 10) 
    (= (at package-4 city-2-loc-12) 10) 
    (= (at package-5 city-2-loc-7) 10) 
    (= (at truck-1 city-1-loc-3) 5) 
    (= (at package-2 city-2-loc-7) 3) 
    (= (at package-4 city-2-loc-5) 2) 
    (= (at truck-2 city-2-loc-7) 2) 
    (= (at truck-2 city-2-loc-5) 4) 
    (= (at package-1 city-2-loc-2) 1) 
    (= (at package-1 city-1-loc-7) 1) 
    (= (at truck-2 city-2-loc-2) 4) 
    (= (at package-3 city-2-loc-5) 4) 
    (= (at package-4 city-2-loc-7) 3) 
    (= (at package-2 city-2-loc-14) 1) 
    (= (at package-4 city-2-loc-11) 5) 
    (= (at package-3 city-2-loc-4) 5) 
 )
 (:bound 1737)
 (:use-cost-metric)
 )
