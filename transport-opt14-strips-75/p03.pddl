...
(define (problem transport-city-sequential-12nodes-1000size-3degree-100mindistance-2trucks-5packages-2014seed)
 ...
 (:utility 
    (= (at package-1 city-loc-3) 10) 
    (= (at package-2 city-loc-8) 10) 
    (= (at package-3 city-loc-5) 10) 
    (= (at package-4 city-loc-2) 10) 
    (= (at package-5 city-loc-2) 10) 
    (= (at package-2 city-loc-9) 1) 
    (= (at package-5 city-loc-12) 2) 
    (= (capacity truck-2 capacity-4) 4) 
    (= (at package-4 city-loc-4) 3) 
 )
 (:bound 225)
 (:use-cost-metric)
 )
