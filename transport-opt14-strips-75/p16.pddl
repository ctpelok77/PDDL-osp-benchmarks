...
(define (problem transport-three-cities-sequential-15nodes-1000size-3degree-100mindistance-3trucks-5packages-2014seed)
 ...
 (:utility 
    (= (at package-1 city-2-loc-13) 10) 
    (= (at package-2 city-2-loc-10) 10) 
    (= (at package-3 city-2-loc-11) 10) 
    (= (at package-4 city-2-loc-10) 10) 
    (= (at package-5 city-3-loc-5) 10) 
    (= (at package-4 city-3-loc-3) 1) 
    (= (in package-5 truck-2) 4) 
    (= (at package-3 city-3-loc-6) 3) 
    (= (at truck-2 city-2-loc-4) 2) 
    (= (at truck-2 city-2-loc-14) 5) 
    (= (at truck-1 city-2-loc-4) 1) 
    (= (at package-5 city-2-loc-9) 2) 
    (= (at package-3 city-3-loc-5) 2) 
    (= (at truck-3 city-3-loc-11) 4) 
    (= (at truck-1 city-1-loc-6) 4) 
    (= (at truck-2 city-1-loc-13) 1) 
    (= (at truck-2 city-1-loc-11) 5) 
    (= (at truck-1 city-2-loc-3) 5) 
    (= (at package-2 city-3-loc-10) 3) 
    (= (at package-1 city-3-loc-5) 1) 
    (= (at truck-3 city-3-loc-13) 2) 
    (= (at package-4 city-3-loc-14) 4) 
    (= (at truck-1 city-3-loc-4) 5) 
