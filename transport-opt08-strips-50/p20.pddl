...
(define (problem transport-two-cities-sequential-20nodes-1000size-4degree-100mindistance-3trucks-11packages-2008seed)
 ...
 (:utility 
    (= (at package-1 city-2-loc-14) 10) 
    (= (at package-2 city-2-loc-7) 10) 
    (= (at package-3 city-2-loc-11) 10) 
    (= (at package-4 city-2-loc-8) 10) 
    (= (at package-5 city-2-loc-5) 10) 
    (= (at package-6 city-2-loc-12) 10) 
    (= (at package-7 city-2-loc-16) 10) 
    (= (at package-8 city-2-loc-2) 10) 
    (= (at package-9 city-2-loc-6) 10) 
    (= (at package-10 city-2-loc-18) 10) 
    (= (at package-11 city-2-loc-3) 10) 
    (= (at truck-2 city-1-loc-1) 2) 
    (= (at package-1 city-2-loc-12) 3) 
    (= (at package-10 city-1-loc-3) 4) 
    (= (at package-3 city-1-loc-5) 4) 
    (= (at package-9 city-1-loc-11) 4) 
    (= (at package-7 city-2-loc-3) 1) 
    (= (at package-2 city-1-loc-4) 3) 
    (= (at truck-3 city-1-loc-3) 5) 
    (= (at truck-1 city-2-loc-2) 1) 
    (= (at package-3 city-1-loc-9) 5) 
    (= (at package-2 city-1-loc-20) 3) 
    (= (at package-8 city-1-loc-16) 4) 
    (= (in package-5 truck-2) 3) 
    (= (at package-8 city-1-loc-12) 2) 
    (= (at truck-2 city-1-loc-3) 2) 
    (= (at package-4 city-1-loc-20) 5) 
    (= (at truck-2 city-1-loc-17) 4) 
    (= (at package-1 city-1-loc-13) 2) 
    (= (at package-11 city-1-loc-14) 2) 
    (= (at package-7 city-2-loc-2) 2) 
    (= (at package-3 city-2-loc-17) 1) 
    (= (in package-3 truck-2) 3) 
    (= (at package-11 city-2-loc-17) 5) 
    (= (at package-8 city-1-loc-17) 3) 
    (= (at package-4 city-2-loc-14) 5) 
    (= (at package-3 city-1-loc-15) 4) 
    (= (at package-2 city-1-loc-19) 1) 
    (= (at package-3 city-1-loc-7) 1) 
    (= (capacity truck-3 capacity-4) 5) 
 )
 (:bound 2005)
 (:use-cost-metric)
 )
