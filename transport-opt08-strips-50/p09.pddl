...
(define (problem transport-city-sequential-27nodes-1000size-4degree-100mindistance-3trucks-10packages-2008seed)
 ...
 (:utility 
    (= (at package-1 city-loc-15) 10) 
    (= (at package-2 city-loc-2) 10) 
    (= (at package-3 city-loc-2) 10) 
    (= (at package-4 city-loc-17) 10) 
    (= (at package-5 city-loc-10) 10) 
    (= (at package-6 city-loc-14) 10) 
    (= (at package-7 city-loc-5) 10) 
    (= (at package-8 city-loc-5) 10) 
    (= (at package-9 city-loc-2) 10) 
    (= (at package-10 city-loc-7) 10) 
    (= (at package-2 city-loc-6) 4) 
    (= (at package-2 city-loc-3) 2) 
    (= (at package-10 city-loc-10) 5) 
    (= (at package-10 city-loc-13) 2) 
    (= (at package-1 city-loc-20) 4) 
    (= (at package-7 city-loc-1) 3) 
    (= (at package-1 city-loc-8) 4) 
    (= (at package-4 city-loc-21) 3) 
    (= (at package-4 city-loc-1) 5) 
    (= (at truck-2 city-loc-1) 3) 
    (= (at package-5 city-loc-1) 5) 
    (= (at truck-2 city-loc-3) 1) 
    (= (at package-10 city-loc-23) 3) 
    (= (capacity truck-3 capacity-0) 4) 
    (= (at package-4 city-loc-25) 1) 
    (= (at package-6 city-loc-3) 1) 
    (= (at package-3 city-loc-27) 2) 
    (= (at package-1 city-loc-25) 1) 
    (= (at package-3 city-loc-11) 5) 
 )
 (:bound 571)
 (:use-cost-metric)
 )
