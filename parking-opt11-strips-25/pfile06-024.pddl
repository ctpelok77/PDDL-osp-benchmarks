(define   (problem parking)
 ...
 (:utility 
    ...
    (= (behind-car car_17 car_01) 3) 
    (= (behind-car car_10 car_02) 4) 
    (= (behind-car car_01 car_05) 5) 
    (= (behind-car car_01 car_17) 2) 
    (= (car-clear car_05) 1) 
    (= (at-curb-num car_07 curb_0) 1) 
    (= (behind-car car_01 car_09) 2) 
    (= (behind-car car_05 car_14) 3) 
    (= (behind-car car_14 car_03) 2) 
    (= (at-curb-num car_14 curb_5) 2) 
    (= (at-curb-num car_17 curb_6) 2) 
    (= (behind-car car_06 car_06) 4) 
    (= (behind-car car_12 car_17) 3) 
    (= (at-curb-num car_02 curb_3) 5) 
    (= (behind-car car_16 car_00) 5) 
    (= (behind-car car_17 car_14) 4) 
    (= (at-curb-num car_03 curb_7) 4) 
    (= (behind-car car_07 car_06) 3) 
    (= (behind-car car_11 car_14) 4) 
    (= (behind-car car_13 car_06) 3) 
    (= (behind-car car_16 car_12) 1) 
    (= (behind-car car_04 car_05) 5) 
    (= (at-curb car_13) 1) 
    (= (at-curb-num car_04 curb_6) 5) 
    (= (behind-car car_06 car_11) 1) 
    (= (at-curb-num car_09 curb_5) 5) 
 )
 (:bound 12)
 (:use-cost-metric)
 )
