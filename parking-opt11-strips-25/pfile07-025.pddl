(define   (problem parking)
 ...
 (:utility 
    ...
    (= (at-curb-num car_07 curb_06) 5) 
    (= (behind-car car_18 car_15) 1) 
    (= (at-curb-num car_13 curb_10) 5) 
    (= (behind-car car_11 car_19) 4) 
    (= (behind-car car_18 car_01) 4) 
    (= (at-curb-num car_01 curb_03) 1) 
    (= (behind-car car_09 car_01) 2) 
    (= (at-curb-num car_19 curb_04) 2) 
    (= (behind-car car_05 car_08) 5) 
    (= (behind-car car_13 car_15) 2) 
    (= (at-curb-num car_04 curb_01) 5) 
    (= (behind-car car_09 car_09) 3) 
    (= (behind-car car_04 car_02) 5) 
    (= (behind-car car_12 car_17) 3) 
    (= (behind-car car_06 car_12) 1) 
    (= (behind-car car_06 car_03) 4) 
    (= (at-curb-num car_05 curb_02) 4) 
    (= (curb-clear curb_06) 4) 
    (= (behind-car car_08 car_06) 4) 
    (= (at-curb-num car_01 curb_10) 3) 
    (= (behind-car car_07 car_04) 1) 
    (= (behind-car car_09 car_00) 3) 
    (= (at-curb-num car_06 curb_01) 3) 
    (= (car-clear car_18) 1) 
    (= (behind-car car_19 car_14) 1) 
    (= (behind-car car_08 car_13) 3) 
    (= (behind-car car_01 car_01) 5) 
    (= (at-curb-num car_01 curb_09) 2) 
    (= (behind-car car_08 car_08) 2) 
    (= (curb-clear curb_01) 1) 
    (= (behind-car car_19 car_10) 3) 
    (= (behind-car car_09 car_06) 2) 
 )
 (:bound 17)
 (:use-cost-metric)
 )
