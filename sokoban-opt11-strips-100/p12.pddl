...
(define (problem p154-microban-sequential)
 ...
 (:utility 
    (= (at-goal stone-01) 10) 
    (= (at player-01 pos-26-12) 5) 
    (= (at player-01 pos-03-14) 5) 
    (= (clear pos-16-08) 1) 
    (= (clear pos-03-13) 2) 
    (= (at player-01 pos-24-02) 4) 
    (= (clear pos-08-04) 1) 
    (= (clear pos-01-05) 2) 
    (= (clear pos-22-06) 5) 
    (= (clear pos-19-14) 2) 
    (= (at stone-01 pos-03-15) 4) 
    (= (at player-01 pos-10-02) 2) 
    (= (clear pos-14-06) 3) 
    (= (at player-01 pos-26-11) 4) 
    (= (clear pos-12-06) 4) 
    (= (clear pos-28-06) 1) 
    (= (at player-01 pos-15-08) 3) 
    (= (clear pos-26-14) 2) 
    (= (clear pos-23-02) 5) 
    (= (clear pos-05-13) 3) 
    (= (at player-01 pos-15-04) 1) 
    (= (at player-01 pos-09-11) 3) 
    (= (at player-01 pos-16-14) 4) 
    (= (at player-01 pos-20-04) 1) 
 )
 (:bound 2)
 (:use-cost-metric)
 )
