...
(define (problem p083-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-03) 10) 
    (= (at-goal stone-04) 10) 
    (= (at player-01 pos-06-07) 5) 
    (= (at player-01 pos-03-08) 3) 
    (= (clear pos-03-04) 1) 
    (= (at stone-04 pos-04-07) 2) 
    (= (at player-01 pos-03-07) 2) 
    (= (at stone-04 pos-04-09) 3) 
    (= (at stone-04 pos-03-09) 1) 
    (= (at stone-04 pos-05-05) 4) 
    (= (at stone-03 pos-03-06) 5) 
    (= (clear pos-07-07) 4) 
 )
 (:bound 47)
 (:use-cost-metric)
