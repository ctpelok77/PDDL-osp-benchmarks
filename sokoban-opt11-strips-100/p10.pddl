...
(define (problem p095-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-07) 10) 
    (= (at-goal stone-08) 10) 
    (= (at stone-05 pos-5-7) 3) 
    (= (at stone-08 pos-6-2) 2) 
    (= (at stone-05 pos-7-7) 3) 
    (= (at player-01 pos-6-6) 4) 
    (= (at player-01 pos-2-6) 2) 
    (= (clear pos-2-7) 1) 
    (= (at stone-05 pos-4-4) 5) 
    (= (at stone-06 pos-6-5) 5) 
    (= (at stone-01 pos-2-6) 1) 
    (= (at stone-08 pos-2-5) 5) 
    (= (at stone-08 pos-7-7) 4) 
    (= (at player-01 pos-5-6) 4) 
    (= (at stone-07 pos-7-5) 4) 
    (= (at stone-04 pos-2-2) 2) 
    (= (clear pos-6-5) 3) 
    (= (at stone-04 pos-5-3) 1) 
    (= (at stone-01 pos-3-7) 5) 
    (= (at stone-02 pos-3-3) 3) 
 )
 (:bound 8)
 (:use-cost-metric)
 )
