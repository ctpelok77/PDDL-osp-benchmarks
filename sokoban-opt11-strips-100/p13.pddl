...
(define (problem p131-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-03) 10) 
    (= (at-goal stone-04) 10) 
    (= (at stone-03 pos-02-06) 4) 
    (= (at stone-01 pos-02-02) 3) 
    (= (at stone-02 pos-05-07) 2) 
    (= (at player-01 pos-05-06) 5) 
    (= (clear pos-04-04) 5) 
    (= (at stone-02 pos-05-05) 3) 
    (= (at stone-02 pos-03-08) 2) 
    (= (at stone-03 pos-06-06) 1) 
    (= (at stone-02 pos-06-06) 4) 
 )
 (:bound 31)
 (:use-cost-metric)
 )
