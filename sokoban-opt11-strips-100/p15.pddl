...
(define (problem p148-microban-sequential)
 ...
 (:utility 
    ...
    (= (clear pos-14-06) 4) 
    (= (clear pos-08-04) 2) 
    (= (at stone-01 pos-08-05) 2) 
    (= (at stone-03 pos-14-06) 3) 
    (= (at stone-01 pos-07-05) 2) 
    (= (at stone-03 pos-10-06) 4) 
    (= (at stone-02 pos-06-02) 3) 
    (= (at player-01 pos-03-02) 1) 
    (= (clear pos-04-02) 5) 
    (= (at stone-03 pos-11-06) 4) 
    (= (at player-01 pos-05-03) 5) 
 )
 (:bound 49)
 (:use-cost-metric)
 )
