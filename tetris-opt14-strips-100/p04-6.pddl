(define (problem Tetris-6-4-3684682)
(:domain tetris)
(:objects  
...
(at_square square2 f1-2f)
 ...
 (:utility 
    ...
    (= (clear f2-2f) 10) 
    (= (clear f2-3f) 10) 
    (= (at_right_l rightl0 f5-1f f4-1f f3-1f) 5) 
    (= (at_square square2 f1-0f) 3) 
    (= (at_square square0 f2-1f) 4) 
    (= (at_right_l rightl0 f3-1f f3-2f f4-2f) 1) 
    (= (at_right_l rightl0 f2-1f f2-2f f2-1f) 5) 
    (= (at_right_l rightl0 f5-2f f5-1f f5-0f) 5) 
    (= (at_right_l rightl0 f3-1f f4-1f f3-1f) 4) 
    (= (at_right_l rightl0 f3-1f f4-1f f5-1f) 4) 
    (= (at_right_l rightl0 f3-1f f3-2f f3-3f) 3) 
    (= (at_two straight1 f5-3f f5-2f) 3) 
    (= (at_two straight1 f3-1f f2-1f) 2) 
    (= (at_two straight1 f1-3f f2-3f) 1) 
    (= (at_two straight0 f3-0f f2-0f) 2) 
    (= (at_right_l rightl0 f2-2f f2-1f f3-1f) 1) 
    (= (at_square square0 f3-2f) 4) 
    (= (at_two straight1 f3-0f f2-0f) 2) 
    (= (at_right_l rightl0 f3-2f f3-1f f2-1f) 2) 
    (= (at_two straight0 f2-2f f3-2f) 3) 
    (= (at_right_l rightl0 f1-0f f1-1f f0-1f) 5) 
    (= (at_square square2 f3-1f) 4) 
    (= (at_right_l rightl0 f4-0f f5-0f f4-0f) 3) 
    (= (at_two straight0 f3-2f f4-2f) 1) 
    (= (at_two straight1 f0-1f f1-1f) 2) 
    (= (at_two straight1 f2-3f f1-3f) 5) 
 )
 (:bound 27)
 (:use-cost-metric)
 )
