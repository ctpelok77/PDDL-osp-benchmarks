...
(at_square square2 f2-2f)
 ...
 (:utility 
    ...
    (= (clear f2-2f) 10) 
    (= (clear f2-3f) 10) 
    (= (at_two straight1 f5-0f f4-0f) 3) 
    (= (at_right_l rightl0 f1-2f f1-3f f1-2f) 2) 
    (= (at_two straight0 f3-2f f3-1f) 4) 
    (= (at_right_l rightl0 f1-2f f0-2f f0-1f) 5) 
    (= (at_two straight1 f4-1f f4-0f) 4) 
    (= (at_two straight0 f0-0f f0-1f) 4) 
    (= (at_two straight0 f0-0f f1-0f) 4) 
    (= (at_right_l rightl0 f4-1f f4-0f f4-1f) 2) 
    (= (at_two straight1 f4-1f f5-1f) 2) 
    (= (at_right_l rightl0 f4-2f f5-2f f5-3f) 3) 
    (= (at_two straight0 f5-2f f4-2f) 4) 
    (= (at_two straight0 f3-1f f4-1f) 1) 
    (= (at_right_l rightl0 f0-2f f0-3f f0-2f) 1) 
    (= (at_two straight0 f1-2f f2-2f) 2) 
    (= (at_square square0 f2-3f) 1) 
    (= (at_two straight1 f4-0f f4-1f) 3) 
    (= (at_right_l rightl0 f3-2f f3-3f f3-2f) 3) 
    (= (at_right_l rightl0 f3-1f f3-2f f3-3f) 5) 
    (= (at_two straight1 f0-3f f1-3f) 5) 
    (= (at_right_l rightl0 f3-2f f3-1f f3-2f) 5) 
    (= (at_square square0 f3-3f) 1) 
    (= (at_right_l rightl0 f2-3f f1-3f f0-3f) 5) 
    (= (at_square square1 f3-0f) 3) 
    (= (at_two straight1 f0-1f f1-1f) 1) 
 )
 (:bound 30)
 (:use-cost-metric)
 )
