(define (problem strips-mprime-x-21)
 ...
 (:utility 
    ...
    (= (fears loneliness-15 satisfaction) 1) 
    (= (fears boils-12 triumph) 4) 
    (= (craves anger onion) 2) 
    (= (craves sciatica hamburger) 1) 
    (= (fears prostatitis expectation) 3) 
    (= (craves love wurst) 4) 
    (= (craves loneliness-15 popover) 4) 
    (= (craves grief apple) 2) 
    (= (craves laceration-5 muffin) 4) 
    (= (craves love onion) 1) 
    (= (fears dread love) 5) 
    (= (craves rest snickers) 2) 
    (= (craves sciatica marzipan) 1) 
    (= (craves expectation guava) 2) 
    (= (craves sciatica-16 onion) 5) 
    (= (craves prostatitis marzipan) 3) 
    (= (fears hangover-9 rest) 2) 
    (= (craves angina-1 marzipan) 1) 
    (= (craves hangover-3 okra) 5) 
    (= (craves anger-4 apple) 1) 
    (= (craves jealousy-11 snickers) 4) 
    (= (craves grief-2 guava) 3) 
    (= (craves abrasion onion) 4) 
    (= (craves boils-12 popover) 5) 
    (= (craves jealousy onion) 4) 
    (= (craves dread-14 guava) 5) 
    (= (craves loneliness flounder) 3) 
    (= (fears loneliness-32 learning) 5) 
    (= (craves boils okra) 3) 
    (= (craves prostatitis flounder) 2) 
    (= (harmony triumph mars) 5) 
    (= (craves anxiety flounder) 5) 
    (= (craves dread okra) 2) 
    (= (fears jealousy-11 triumph) 4) 
    (= (craves prostatitis-7 onion) 3) 
    (= (craves laceration guava) 3) 
    (= (fears angina-1 rest) 2) 
 )
 (:bound 6)
 )
