(define (problem strips-mprime-x-6)
 ...
 (:utility 
    ...
    (= (craves abrasion wonderbread) 1) 
    (= (craves abrasion popover) 2) 
    (= (locale bacon goias) 4) 
    (= (locale popover surrey) 1) 
    (= (harmony curiosity neptune) 4) 
    (= (fears angina lubricity) 3) 
    (= (craves anger mutton) 3) 
    (= (craves loneliness tomato) 2) 
    (= (craves sciatica beef) 3) 
    (= (locale chicken goias) 3) 
    (= (locale scallop kentucky) 2) 
    (= (craves achievement wonderbread) 1) 
    (= (locale cantelope surrey) 5) 
    (= (locale marzipan goias) 4) 
    (= (fears anger achievement) 5) 
    (= (craves anger pistachio) 2) 
    (= (craves loneliness onion) 1) 
    (= (craves lubricity cantelope) 5) 
    (= (craves triumph wonderbread) 3) 
    (= (fears loneliness curiosity) 4) 
    (= (harmony rest mars) 4) 
    (= (craves intoxication papaya) 1) 
    (= (craves boils scallop) 1) 
    (= (craves prostatitis beef) 5) 
    (= (fears sciatica intoxication) 5) 
    (= (craves angina muffin) 2) 
    (= (locale rice arizona) 2) 
    (= (craves intoxication cantelope) 5) 
    (= (fears hangover love) 4) 
    (= (locale muffin goias) 3) 
    (= (fears grief achievement) 1) 
    (= (locale pistachio goias) 3) 
 )
 (:bound 12)
 )
