(define (problem strips-mprime-x-3)
 ...
 (:utility 
    (= (craves hangover ham) 10) 
    (= (craves boils lemon) 4) 
    (= (craves angina popover) 1) 
    (= (locale melon manitoba) 1) 
    (= (craves boils mutton) 2) 
    (= (fears depression satisfaction) 4) 
    (= (fears jealousy triumph) 5) 
    (= (craves triumph lemon) 3) 
    (= (craves angina melon) 5) 
    (= (craves jealousy snickers) 3) 
    (= (craves laceration chocolate) 5) 
    (= (craves satisfaction snickers) 1) 
 )
 (:bound 4)
 )
