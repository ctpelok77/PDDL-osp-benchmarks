...
(define (problem transport-city-sequential-15nodes-1000size-3degree-100mindistance-3trucks-8packages-2012seed)
 ...
 (:utility 
    (= (at package-1 city-loc-4) 10) 
    (= (at package-2 city-loc-6) 10) 
    (= (at package-3 city-loc-12) 10) 
    (= (at package-4 city-loc-8) 10) 
    (= (at package-5 city-loc-10) 10) 
    (= (at package-6 city-loc-10) 10) 
    (= (at package-7 city-loc-9) 10) 
    (= (at package-8 city-loc-15) 10) 
    (= (at package-7 city-loc-2) 2) 
    (= (capacity truck-2 capacity-0) 4) 
    (= (at truck-3 city-loc-14) 1) 
    (= (at truck-3 city-loc-4) 3) 
    (= (at package-2 city-loc-3) 2) 
    (= (in package-7 truck-1) 3) 
    (= (at package-5 city-loc-15) 1) 
    (= (at package-4 city-loc-6) 5) 
    (= (at truck-1 city-loc-12) 4) 
 )
 (:bound 174)
 (:use-cost-metric)
 )
