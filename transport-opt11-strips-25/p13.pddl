...
(define (problem transport-city-sequential-15nodes-1000size-2degree-100mindistance-2trucks-8packages-2012seed)
 ...
 (:utility 
    ...
    (= (at package-3 city-loc-11) 10) 
    (= (at package-4 city-loc-14) 10) 
    (= (at package-5 city-loc-3) 10) 
    (= (at package-6 city-loc-12) 10) 
    (= (at package-7 city-loc-13) 10) 
    (= (at package-8 city-loc-14) 10) 
    (= (at package-6 city-loc-9) 5) 
    (= (at truck-1 city-loc-5) 3) 
    (= (capacity truck-1 capacity-0) 2) 
    (= (at package-5 city-loc-14) 5) 
    (= (in package-2 truck-2) 1) 
    (= (at package-8 city-loc-13) 1) 
    (= (at package-5 city-loc-4) 4) 
