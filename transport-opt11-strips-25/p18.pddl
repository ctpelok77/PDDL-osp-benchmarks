...
(define (problem transport-two-cities-sequential-8nodes-1000size-3degree-100mindistance-2trucks-5packages-2008seed)
 ...
 (:utility 
    ...
    (= (at package-1 city-2-loc-6) 2) 
    (= (capacity truck-1 capacity-4) 5) 
    (= (in package-3 truck-2) 1) 
    (= (at package-4 city-1-loc-2) 3) 
    (= (at package-2 city-1-loc-1) 2) 
    (= (at package-1 city-1-loc-5) 4) 
 )
 (:bound 235)
 (:use-cost-metric)
 )
