...
(define (problem transport-three-cities-sequential-5nodes-1000size-3degree-100mindistance-2trucks-6packages-2008seed)
 ...
 (:utility 
    ...
    (= (at package-4 city-1-loc-4) 3) 
    (= (at package-4 city-3-loc-3) 4) 
    (= (at package-6 city-3-loc-2) 2) 
    (= (at package-1 city-1-loc-2) 1) 
    (= (at package-6 city-2-loc-3) 4) 
    (= (at package-1 city-2-loc-5) 3) 
 )
 (:bound 242)
 (:use-cost-metric)
 )
