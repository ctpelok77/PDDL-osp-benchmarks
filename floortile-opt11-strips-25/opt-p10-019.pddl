(define (problem prob019)
 ...
 (:utility 
    ...
    (= (painted tile_3-6 white) 4) 
    (= (robot-at robot2 tile_1-2) 2) 
    (= (robot-at robot3 tile_3-1) 4) 
    (= (clear tile_6-2) 3) 
    (= (robot-at robot1 tile_5-3) 2) 
    (= (robot-at robot3 tile_3-4) 1) 
    (= (clear tile_5-2) 5) 
    (= (robot-at robot2 tile_4-6) 5) 
    (= (robot-at robot2 tile_2-1) 3) 
    (= (robot-at robot1 tile_5-1) 1) 
    (= (robot-at robot1 tile_4-6) 2) 
 )
 (:bound 87)
 (:use-cost-metric)
 )
