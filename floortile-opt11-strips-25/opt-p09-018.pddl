(define (problem prob018)
 ...
 (:utility 
    ...
    (= (painted tile_7-1 white) 10) 
    (= (painted tile_7-2 black) 10) 
    (= (painted tile_7-3 white) 10) 
    (= (painted tile_7-4 black) 10) 
    (= (painted tile_7-5 white) 10) 
    (= (painted tile_5-1 black) 4) 
    (= (robot-at robot4 tile_5-5) 5) 
    (= (painted tile_0-5 white) 5) 
    (= (robot-at robot1 tile_4-1) 3) 
    (= (clear tile_1-3) 1) 
    (= (robot-at robot1 tile_7-4) 3) 
    (= (robot-at robot1 tile_3-3) 2) 
    (= (painted tile_7-3 black) 4) 
    (= (robot-at robot2 tile_6-3) 4) 
    (= (robot-at robot3 tile_0-5) 3) 
    (= (robot-at robot2 tile_2-1) 1) 
    (= (robot-at robot3 tile_6-4) 5) 
 )
 (:bound 82)
 (:use-cost-metric)
 )
