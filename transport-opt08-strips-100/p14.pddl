...
(define (problem transport-two-cities-sequential-8nodes-1000size-3degree-100mindistance-2trucks-5packages-2008seed)
 ...
 (:utility 
    ...
    (= (at truck-2 city-1-loc-2) 4) 
    (= (at package-3 city-1-loc-4) 5) 
    (= (in package-3 truck-1) 2) 
    (= (at package-1 city-1-loc-8) 4) 
    (= (capacity truck-2 capacity-1) 3) 
    (= (at package-5 city-1-loc-2) 1) 
 )
 (:bound 941)
 (:use-cost-metric)
 )
