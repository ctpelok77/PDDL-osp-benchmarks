...
(define (problem transport-three-cities-sequential-8nodes-1000size-4degree-100mindistance-3trucks-9packages-2008seed)
 ...
 (:utility 
    (= (at package-1 city-3-loc-6) 10) 
    (= (at package-2 city-3-loc-3) 10) 
    (= (at package-3 city-2-loc-3) 10) 
    (= (at package-4 city-1-loc-5) 10) 
    (= (at package-5 city-1-loc-7) 10) 
    (= (at package-6 city-1-loc-1) 10) 
    (= (at package-7 city-2-loc-2) 10) 
    (= (at package-8 city-3-loc-3) 10) 
    (= (at package-9 city-2-loc-4) 10) 
    (= (at package-4 city-1-loc-4) 5) 
    (= (at package-6 city-3-loc-2) 1) 
    (= (at truck-1 city-2-loc-6) 1) 
    (= (in package-1 truck-3) 1) 
    (= (at package-1 city-2-loc-3) 4) 
    (= (at truck-1 city-2-loc-4) 5) 
    (= (at truck-3 city-1-loc-2) 3) 
    (= (in package-7 truck-1) 1) 
    (= (at truck-3 city-3-loc-4) 5) 
    (= (in package-7 truck-2) 2) 
    (= (at truck-2 city-2-loc-4) 3) 
    (= (at truck-3 city-2-loc-1) 4) 
    (= (at package-4 city-1-loc-2) 2) 
    (= (at truck-2 city-3-loc-5) 5) 
    (= (at truck-1 city-2-loc-3) 2) 
