...
(define (problem transport-city-sequential-21nodes-1000size-4degree-100mindistance-3trucks-8packages-2008seed)
 ...
 (:utility 
    (= (at package-1 city-loc-21) 10) 
    (= (at package-2 city-loc-5) 10) 
    (= (at package-3 city-loc-13) 10) 
    (= (at package-4 city-loc-16) 10) 
    (= (at package-5 city-loc-2) 10) 
    (= (at package-6 city-loc-4) 10) 
    (= (at package-7 city-loc-8) 10) 
    (= (at package-8 city-loc-19) 10) 
    (= (at truck-1 city-loc-7) 2) 
    (= (at package-6 city-loc-19) 2) 
    (= (at package-7 city-loc-10) 3) 
    (= (at truck-3 city-loc-1) 1) 
    (= (at truck-3 city-loc-20) 4) 
    (= (at truck-3 city-loc-4) 5) 
    (= (in package-7 truck-2) 1) 
    (= (at truck-1 city-loc-17) 3) 
    (= (in package-4 truck-2) 5) 
    (= (at package-2 city-loc-14) 2) 
    (= (capacity truck-3 capacity-0) 4) 
    (= (at package-4 city-loc-5) 5) 
    (= (at truck-1 city-loc-4) 4) 
 )
 (:bound 891)
 (:use-cost-metric)
 )
