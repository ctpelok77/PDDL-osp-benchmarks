...
(define (problem transport-two-cities-sequential-14nodes-1000size-4degree-100mindistance-3trucks-8packages-2008seed)
 ...
 (:utility 
    (= (at package-1 city-2-loc-9) 10) 
    (= (at package-2 city-2-loc-11) 10) 
    (= (at package-3 city-2-loc-1) 10) 
    (= (at package-4 city-2-loc-4) 10) 
    (= (at package-5 city-2-loc-13) 10) 
    (= (at package-6 city-2-loc-2) 10) 
    (= (at package-7 city-2-loc-1) 10) 
    (= (at package-8 city-2-loc-8) 10) 
    (= (at package-6 city-1-loc-6) 5) 
    (= (at package-2 city-1-loc-13) 4) 
    (= (at package-5 city-1-loc-5) 2) 
    (= (at package-7 city-2-loc-5) 3) 
    (= (at package-5 city-1-loc-1) 5) 
    (= (at package-6 city-2-loc-14) 4) 
    (= (at package-3 city-2-loc-3) 3) 
    (= (in package-7 truck-1) 1) 
    (= (at package-4 city-2-loc-9) 4) 
    (= (at package-5 city-1-loc-4) 3) 
    (= (in package-4 truck-2) 2) 
    (= (at package-8 city-1-loc-11) 1) 
    (= (at package-4 city-1-loc-2) 5) 
    (= (at package-3 city-2-loc-5) 2) 
    (= (at package-8 city-1-loc-1) 1) 
    (= (at package-5 city-1-loc-2) 4) 
 )
 (:bound 2596)
 (:use-cost-metric)
 )
