...
(define (problem transport-three-cities-sequential-6nodes-1000size-4degree-100mindistance-3trucks-7packages-2008seed)
 ...
 (:utility 
    ...
    (= (at package-2 city-3-loc-4) 10) 
    (= (at package-3 city-3-loc-2) 10) 
    (= (at package-4 city-2-loc-3) 10) 
    (= (at package-5 city-1-loc-4) 10) 
    (= (at package-6 city-3-loc-1) 10) 
    (= (at package-7 city-1-loc-6) 10) 
    (= (at package-4 city-3-loc-2) 1) 
    (= (at package-3 city-3-loc-1) 2) 
    (= (at package-3 city-1-loc-5) 3) 
    (= (at package-3 city-2-loc-1) 4) 
    (= (at package-6 city-1-loc-2) 5) 
    (= (in package-7 truck-2) 4) 
    (= (at package-1 city-1-loc-6) 3) 
    (= (at package-3 city-3-loc-3) 2) 
    (= (at package-5 city-3-loc-2) 5) 
    (= (at truck-1 city-3-loc-4) 1) 
 )
 (:bound 1707)
 (:use-cost-metric)
 )
