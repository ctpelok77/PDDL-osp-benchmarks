...
(define (problem transport-city-sequential-30nodes-1000size-4degree-100mindistance-3trucks-11packages-2008seed)
 ...
 (:utility 
    (= (at package-1 city-loc-29) 10) 
    (= (at package-2 city-loc-20) 10) 
    (= (at package-3 city-loc-28) 10) 
    (= (at package-4 city-loc-28) 10) 
    (= (at package-5 city-loc-5) 10) 
    (= (at package-6 city-loc-5) 10) 
    (= (at package-7 city-loc-30) 10) 
    (= (at package-8 city-loc-29) 10) 
    (= (at package-9 city-loc-4) 10) 
    (= (at package-10 city-loc-28) 10) 
    (= (at package-11 city-loc-27) 10) 
    (= (at truck-2 city-loc-17) 5) 
    (= (at truck-3 city-loc-6) 1) 
    (= (at package-4 city-loc-22) 5) 
    (= (at truck-1 city-loc-8) 2) 
    (= (at package-2 city-loc-9) 1) 
    (= (at package-4 city-loc-6) 3) 
    (= (at package-2 city-loc-16) 2) 
    (= (at package-1 city-loc-18) 5) 
    (= (at package-5 city-loc-8) 5) 
    (= (at truck-1 city-loc-2) 3) 
    (= (at package-7 city-loc-29) 2) 
    (= (at package-2 city-loc-18) 4) 
    (= (at truck-3 city-loc-1) 3) 
    (= (in package-7 truck-1) 3) 
    (= (at truck-1 city-loc-29) 1) 
    (= (at package-2 city-loc-13) 4) 
    (= (at truck-3 city-loc-12) 2) 
    (= (at truck-2 city-loc-29) 1) 
    (= (at package-7 city-loc-3) 1) 
    (= (at package-11 city-loc-7) 3) 
    (= (in package-9 truck-1) 2) 
    (= (at package-10 city-loc-17) 5) 
 )
 (:bound 1328)
 (:use-cost-metric)
 )
