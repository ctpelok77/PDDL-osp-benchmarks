...
(define (problem transport-two-cities-sequential-12nodes-1000size-4degree-100mindistance-3trucks-7packages-2008seed)
 ...
 (:utility 
    (= (at package-1 city-2-loc-8) 10) 
    (= (at package-2 city-2-loc-5) 10) 
    (= (at package-3 city-2-loc-6) 10) 
    (= (at package-4 city-2-loc-3) 10) 
    (= (at package-5 city-2-loc-10) 10) 
    (= (at package-6 city-2-loc-7) 10) 
    (= (at package-7 city-2-loc-10) 10) 
    (= (at package-5 city-1-loc-12) 2) 
    (= (at package-4 city-1-loc-5) 3) 
    (= (at package-4 city-2-loc-12) 1) 
    (= (at package-5 city-2-loc-5) 5) 
    (= (at truck-1 city-2-loc-7) 1) 
    (= (at package-5 city-2-loc-7) 4) 
    (= (at package-1 city-1-loc-2) 3) 
    (= (at package-5 city-2-loc-6) 2) 
    (= (at truck-1 city-2-loc-10) 5) 
    (= (at package-4 city-2-loc-9) 3) 
    (= (at truck-2 city-1-loc-7) 1) 
    (= (at package-1 city-1-loc-1) 4) 
    (= (at truck-3 city-2-loc-11) 4) 
 )
 (:bound 2051)
 (:use-cost-metric)
 )
