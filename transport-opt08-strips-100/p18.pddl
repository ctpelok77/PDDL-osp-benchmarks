...
(define (problem transport-two-cities-sequential-16nodes-1000size-4degree-100mindistance-3trucks-9packages-2008seed)
 ...
 (:utility 
    ...
    (= (at package-2 city-2-loc-9) 10) 
    (= (at package-3 city-2-loc-13) 10) 
    (= (at package-4 city-2-loc-15) 10) 
    (= (at package-5 city-2-loc-2) 10) 
    (= (at package-6 city-2-loc-6) 10) 
    (= (at package-7 city-2-loc-8) 10) 
    (= (at package-8 city-2-loc-8) 10) 
    (= (at package-9 city-2-loc-14) 10) 
    (= (capacity truck-3 capacity-1) 3) 
    (= (at package-2 city-1-loc-15) 2) 
    (= (at package-9 city-2-loc-13) 4) 
    (= (at truck-2 city-2-loc-14) 5) 
    (= (at package-3 city-1-loc-12) 5) 
    (= (at truck-1 city-1-loc-4) 2) 
    (= (at truck-1 city-2-loc-5) 5) 
    (= (at truck-1 city-2-loc-10) 1) 
    (= (at package-8 city-2-loc-11) 4) 
    (= (at package-2 city-2-loc-15) 1) 
    (= (in package-2 truck-3) 5) 
    (= (at package-9 city-2-loc-8) 2) 
    (= (at package-1 city-2-loc-15) 3) 
    (= (at truck-2 city-2-loc-13) 1) 
    (= (at package-9 city-2-loc-7) 2) 
    (= (at truck-3 city-1-loc-1) 1) 
    (= (at package-6 city-2-loc-11) 4) 
    (= (at package-2 city-1-loc-11) 4) 
    (= (at package-4 city-2-loc-10) 3) 
    (= (in package-4 truck-2) 3) 
 )
 (:bound 3611)
 (:use-cost-metric)
 )
