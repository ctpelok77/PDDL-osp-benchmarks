...
(:init
 ...
 (:utility 
    ...
    (= (stored goods15 level1) 10) 
    (= (loaded goods12 truck5 level3) 1) 
    (= (loaded goods14 truck2 level2) 1) 
    (= (on-sale goods4 market4 level0) 5) 
    (= (stored goods9 level2) 4) 
    (= (stored goods1 level3) 1) 
    (= (ready-to-load goods13 market3 level0) 2) 
    (= (loaded goods1 truck1 level3) 5) 
    (= (loaded goods10 truck1 level4) 1) 
    (= (loaded goods9 truck4 level1) 3) 
    (= (loaded goods6 truck4 level4) 3) 
    (= (ready-to-load goods8 market1 level0) 4) 
    (= (loaded goods4 truck2 level4) 2) 
    (= (loaded goods2 truck2 level1) 2) 
    (= (on-sale goods2 market2 level0) 4) 
    (= (loaded goods4 truck1 level2) 3) 
    (= (ready-to-load goods5 market1 level1) 1) 
    (= (loaded goods1 truck4 level4) 4) 
    (= (on-sale goods3 market2 level1) 5) 
    (= (ready-to-load goods15 market1 level0) 2) 
    (= (on-sale goods8 market2 level2) 4) 
    (= (loaded goods8 truck1 level1) 5) 
    (= (ready-to-load goods10 market3 level2) 1) 
    (= (stored goods15 level3) 4) 
    (= (ready-to-load goods11 market5 level0) 4) 
    (= (ready-to-load goods3 market5 level0) 2) 
    (= (loaded goods8 truck2 level0) 2) 
    (= (ready-to-load goods9 market4 level1) 5) 
    (= (ready-to-load goods5 market1 level0) 5) 
    (= (stored goods14 level4) 3) 
    (= (on-sale goods8 market2 level1) 2) 
    (= (ready-to-load goods9 market3 level0) 1) 
    (= (on-sale goods14 market3 level0) 3) 
    (= (on-sale goods12 market2 level0) 3) 
    (= (on-sale goods15 market4 level2) 2) 
    (= (loaded goods1 truck5 level0) 5) 
    (= (loaded goods13 truck5 level3) 3) 
    (= (loaded goods7 truck4 level4) 4) 
    (= (ready-to-load goods9 market4 level3) 1) 
    (= (loaded goods8 truck3 level0) 2) 
    (= (loaded goods5 truck2 level3) 5) 
    (= (loaded goods4 truck3 level2) 3) 
 )
 (:bound 47)
 )
