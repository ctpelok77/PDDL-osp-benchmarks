...
(:init
 ...
 (:utility 
    ...
    (= (stored goods16 level5) 10) 
    (= (on-sale goods8 market1 level0) 4) 
    (= (ready-to-load goods15 market4 level3) 4) 
    (= (ready-to-load goods2 market1 level2) 5) 
    (= (stored goods9 level0) 1) 
    (= (loaded goods6 truck2 level5) 1) 
    (= (loaded goods6 truck3 level0) 4) 
    (= (ready-to-load goods5 market1 level3) 2) 
    (= (on-sale goods5 market4 level0) 1) 
    (= (loaded goods3 truck4 level1) 3) 
    (= (stored goods13 level0) 2) 
    (= (loaded goods1 truck7 level0) 2) 
    (= (on-sale goods2 market6 level0) 5) 
    (= (on-sale goods16 market7 level0) 4) 
    (= (ready-to-load goods6 market2 level3) 3) 
    (= (loaded goods6 truck5 level1) 5) 
    (= (ready-to-load goods4 market3 level0) 4) 
    (= (ready-to-load goods1 market1 level3) 5) 
    (= (ready-to-load goods7 market2 level0) 2) 
    (= (ready-to-load goods13 market3 level4) 2) 
    (= (on-sale goods5 market7 level0) 1) 
    (= (loaded goods2 truck7 level3) 5) 
    (= (loaded goods14 truck1 level3) 3) 
    (= (ready-to-load goods11 market2 level5) 4) 
    (= (loaded goods6 truck5 level4) 4) 
    (= (loaded goods10 truck7 level3) 5) 
    (= (on-sale goods2 market4 level0) 5) 
    (= (on-sale goods15 market1 level0) 4) 
    (= (loaded goods6 truck6 level1) 3) 
    (= (stored goods7 level0) 2) 
    (= (loaded goods2 truck4 level1) 1) 
    (= (loaded goods14 truck3 level3) 2) 
    (= (loaded goods7 truck5 level5) 5) 
    (= (stored goods2 level6) 4) 
    (= (loaded goods8 truck1 level1) 1) 
    (= (loaded goods14 truck5 level6) 4) 
    (= (at truck6 market6) 1) 
    (= (loaded goods2 truck1 level2) 2) 
    (= (at truck7 market5) 1) 
    (= (loaded goods10 truck3 level4) 3) 
    (= (ready-to-load goods2 market1 level3) 2) 
    (= (loaded goods9 truck7 level3) 5) 
    (= (ready-to-load goods12 market3 level1) 4) 
    (= (stored goods8 level6) 4) 
    (= (loaded goods6 truck1 level3) 3) 
    (= (stored goods8 level3) 3) 
    (= (loaded goods6 truck7 level4) 3) 
    (= (ready-to-load goods2 market1 level5) 1) 
    (= (stored goods5 level1) 5) 
    (= (loaded goods5 truck4 level5) 4) 
    (= (ready-to-load goods2 market4 level4) 3) 
    (= (loaded goods13 truck2 level3) 4) 
    (= (stored goods1 level2) 1) 
    (= (loaded goods5 truck6 level3) 1) 
    (= (loaded goods16 truck6 level4) 3) 
    (= (on-sale goods11 market3 level0) 1) 
    (= (stored goods8 level5) 3) 
    (= (at truck6 market4) 2) 
    (= (loaded goods11 truck2 level1) 5) 
    (= (stored goods1 level6) 2) 
    (= (ready-to-load goods5 market4 level5) 3) 
    (= (ready-to-load goods8 market3 level0) 1) 
    (= (loaded goods2 truck1 level4) 2) 
    (= (loaded goods5 truck7 level1) 3) 
    (= (loaded goods12 truck2 level4) 2) 
    (= (ready-to-load goods8 market2 level6) 1) 
    (= (loaded goods6 truck6 level2) 5) 
    (= (loaded goods1 truck4 level5) 4) 
    (= (ready-to-load goods14 market4 level5) 1) 
    (= (loaded goods3 truck7 level6) 3) 
    (= (ready-to-load goods3 market2 level5) 5) 
    (= (loaded goods11 truck1 level0) 3) 
    (= (stored goods2 level0) 3) 
    (= (loaded goods10 truck4 level2) 5) 
    (= (on-sale goods11 market7 level0) 5) 
    (= (on-sale goods1 market5 level1) 5) 
    (= (on-sale goods14 market3 level1) 1) 
    (= (loaded goods14 truck3 level6) 2) 
    (= (ready-to-load goods4 market6 level2) 2) 
    (= (ready-to-load goods13 market4 level6) 2) 
 )
 (:bound 47)
 )
