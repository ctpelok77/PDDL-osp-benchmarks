...
(:init
 ...
 (:utility 
    ...
    (= (stored goods13 level4) 10) 
    (= (stored goods14 level2) 10) 
    (= (loaded goods6 truck3 level2) 5) 
    (= (ready-to-load goods13 market4 level0) 4) 
    (= (loaded goods13 truck3 level1) 3) 
    (= (loaded goods7 truck3 level4) 5) 
    (= (loaded goods1 truck1 level3) 2) 
    (= (ready-to-load goods10 market4 level0) 3) 
    (= (loaded goods10 truck2 level4) 4) 
    (= (ready-to-load goods10 market1 level2) 1) 
    (= (ready-to-load goods2 market4 level2) 2) 
    (= (at truck2 depot2) 5) 
    (= (ready-to-load goods9 market4 level4) 1) 
    (= (ready-to-load goods12 market1 level2) 2) 
    (= (on-sale goods5 market5 level0) 4) 
    (= (loaded goods7 truck4 level3) 4) 
    (= (loaded goods6 truck1 level2) 4) 
    (= (loaded goods7 truck1 level2) 1) 
    (= (stored goods9 level1) 5) 
    (= (loaded goods2 truck1 level2) 3) 
    (= (on-sale goods8 market1 level0) 1) 
    (= (loaded goods5 truck1 level0) 1) 
    (= (on-sale goods1 market1 level1) 1) 
    (= (loaded goods1 truck4 level1) 3) 
    (= (at truck5 market2) 5) 
    (= (stored goods14 level4) 2) 
    (= (loaded goods1 truck3 level3) 2) 
    (= (at truck3 depot2) 5) 
    (= (at truck4 depot1) 3) 
    (= (loaded goods11 truck3 level0) 3) 
    (= (loaded goods10 truck5 level2) 5) 
    (= (loaded goods10 truck1 level3) 4) 
    (= (ready-to-load goods14 market1 level1) 2) 
    (= (on-sale goods3 market4 level1) 2) 
    (= (on-sale goods2 market2 level1) 1) 
    (= (ready-to-load goods6 market5 level0) 5) 
    (= (ready-to-load goods6 market2 level3) 2) 
    (= (on-sale goods12 market4 level1) 4) 
    (= (ready-to-load goods3 market2 level3) 4) 
    (= (ready-to-load goods6 market3 level3) 3) 
 )
 (:bound 32)
 )
