...
(:init
 ...
 (:utility 
    ...
    (= (loaded goods1 truck2 level2) 3) 
    (= (loaded goods10 truck3 level0) 5) 
    (= (ready-to-load goods1 market2 level3) 3) 
    (= (ready-to-load goods1 market2 level2) 2) 
    (= (loaded goods1 truck4 level0) 2) 
    (= (loaded goods6 truck3 level0) 5) 
    (= (loaded goods2 truck4 level0) 4) 
    (= (loaded goods6 truck1 level0) 1) 
    (= (ready-to-load goods1 market4 level3) 4) 
    (= (loaded goods8 truck2 level2) 4) 
    (= (loaded goods4 truck1 level0) 1) 
    (= (stored goods6 level0) 4) 
    (= (ready-to-load goods6 market2 level3) 5) 
    (= (at truck2 market2) 1) 
    (= (loaded goods3 truck2 level3) 2) 
    (= (loaded goods4 truck3 level2) 3) 
    (= (ready-to-load goods10 market4 level0) 3) 
    (= (loaded goods2 truck3 level3) 5) 
    (= (ready-to-load goods10 market1 level3) 2) 
 )
 (:bound 25)
 )
