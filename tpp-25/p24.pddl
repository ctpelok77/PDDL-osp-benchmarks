...
(:init
 ...
 (:utility 
    ...
    (= (on-sale goods5 market2 level1) 1) 
    (= (loaded goods12 truck6 level2) 5) 
    (= (loaded goods1 truck2 level5) 4) 
    (= (loaded goods7 truck2 level0) 3) 
    (= (ready-to-load goods9 market2 level3) 3) 
    (= (stored goods11 level4) 2) 
    (= (loaded goods6 truck5 level3) 4) 
    (= (stored goods14 level5) 1) 
    (= (loaded goods13 truck2 level2) 4) 
    (= (on-sale goods13 market4 level1) 3) 
    (= (loaded goods12 truck1 level4) 4) 
    (= (loaded goods12 truck4 level0) 1) 
    (= (loaded goods14 truck1 level3) 1) 
    (= (on-sale goods5 market3 level0) 5) 
    (= (loaded goods2 truck3 level0) 5) 
    (= (on-sale goods10 market5 level0) 5) 
    (= (loaded goods8 truck4 level1) 4) 
    (= (loaded goods1 truck3 level0) 4) 
    (= (loaded goods11 truck3 level5) 5) 
    (= (ready-to-load goods9 market1 level1) 1) 
    (= (loaded goods14 truck2 level5) 1) 
    (= (stored goods6 level2) 2) 
    (= (at truck6 market6) 2) 
    (= (ready-to-load goods12 market5 level4) 3) 
    (= (ready-to-load goods3 market3 level0) 3) 
    (= (loaded goods4 truck5 level3) 4) 
    (= (loaded goods6 truck2 level0) 5) 
    (= (loaded goods7 truck4 level5) 2) 
    (= (loaded goods1 truck3 level5) 2) 
    (= (loaded goods1 truck3 level3) 2) 
    (= (loaded goods8 truck4 level2) 1) 
    (= (ready-to-load goods10 market2 level1) 5) 
    (= (loaded goods9 truck3 level4) 1) 
    (= (loaded goods11 truck3 level2) 1) 
    (= (stored goods8 level5) 2) 
    (= (stored goods8 level3) 5) 
    (= (ready-to-load goods12 market1 level1) 3) 
    (= (loaded goods11 truck5 level2) 5) 
    (= (loaded goods12 truck3 level0) 3) 
    (= (stored goods8 level1) 1) 
    (= (on-sale goods10 market2 level1) 4) 
    (= (ready-to-load goods14 market2 level1) 1) 
    (= (loaded goods11 truck5 level0) 4) 
    (= (ready-to-load goods9 market2 level2) 3) 
    (= (stored goods4 level0) 4) 
    (= (ready-to-load goods6 market5 level0) 2) 
    (= (loaded goods13 truck4 level0) 3) 
    (= (loaded goods2 truck3 level1) 2) 
    (= (loaded goods12 truck3 level2) 2) 
    (= (ready-to-load goods7 market5 level0) 2) 
    (= (on-sale goods4 market1 level2) 3) 
    (= (at truck1 market3) 5) 
 )
 (:bound 38)
 )
