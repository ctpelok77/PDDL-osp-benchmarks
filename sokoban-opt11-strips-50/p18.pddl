...
(define (problem p107-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-10) 10) 
    (= (at-goal stone-11) 10) 
    (= (at stone-01 pos-7-6) 2) 
    (= (at stone-11 pos-2-7) 4) 
    (= (at stone-10 pos-7-4) 4) 
    (= (at stone-11 pos-3-4) 4) 
    (= (at stone-05 pos-7-6) 5) 
    (= (at stone-08 pos-3-5) 3) 
    (= (at stone-06 pos-2-7) 3) 
    (= (clear pos-3-2) 3) 
    (= (at stone-02 pos-2-5) 5) 
    (= (at stone-02 pos-3-3) 5) 
    (= (at stone-01 pos-5-3) 5) 
    (= (at stone-04 pos-3-7) 1) 
    (= (at stone-10 pos-4-5) 4) 
    (= (at stone-05 pos-4-7) 2) 
    (= (at player-01 pos-5-2) 1) 
    (= (at stone-10 pos-7-7) 5) 
    (= (at stone-08 pos-3-6) 3) 
    (= (at player-01 pos-7-6) 2) 
    (= (at stone-06 pos-3-3) 2) 
    (= (at stone-08 pos-4-5) 1) 
    (= (at stone-10 pos-5-2) 4) 
    (= (at stone-02 pos-2-3) 3) 
    (= (at stone-06 pos-7-3) 2) 
 )
 (:bound 5)
 (:use-cost-metric)
 )
