...
(define (problem p127-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-03) 10) 
    (= (at-goal stone-04) 10) 
    (= (at stone-02 pos-02-06) 1) 
    (= (at stone-02 pos-05-02) 2) 
    (= (at player-01 pos-04-05) 5) 
    (= (at stone-03 pos-07-04) 3) 
    (= (at player-01 pos-07-04) 2) 
    (= (at stone-02 pos-05-06) 3) 
    (= (at stone-02 pos-03-05) 5) 
    (= (clear pos-03-01) 4) 
    (= (at stone-02 pos-03-06) 4) 
    (= (at player-01 pos-08-07) 1) 
 )
 (:bound 16)
 (:use-cost-metric)
 )
