...
(:init
 ...
 (:utility 
    ...
    (= (in depot1-1-2 depot1) 3) 
    (= (on crate7 depot3-1-4) 5) 
    (= (on crate1 depot1-2-3) 5) 
    (= (in crate7 depot0) 1) 
    (= (on crate8 depot1-1-2) 4) 
    (= (on crate6 depot1-2-4) 4) 
    (= (on crate4 depot3-1-4) 5) 
    (= (at hoist0 depot1-1-4) 1) 
    (= (at hoist0 depot4-1-4) 1) 
    (= (on crate11 container-1-3) 3) 
    (= (on crate16 depot1-1-1) 4) 
    (= (on crate6 container-3-1) 2) 
    (= (in depot3-1-1 depot3) 5) 
    (= (on crate9 depot2-2-3) 4) 
    (= (on crate13 container-4-0) 5) 
    (= (on crate9 depot4-1-4) 1) 
    (= (on crate13 container-2-2) 2) 
    (= (in depot2-2-1 depot2) 4) 
    (= (on crate9 container-0-1) 1) 
    (= (at hoist1 container-1-1) 4) 
    (= (on crate1 container-0-3) 3) 
    (= (in crate8 depot0) 1) 
    (= (on crate8 depot4-1-3) 2) 
    (= (on crate7 depot1-1-4) 1) 
    (= (on crate5 depot4-1-2) 3) 
    (= (at hoist1 depot1-1-1) 1) 
    (= (on crate15 depot1-2-3) 5) 
    (= (on crate15 depot0-2-4) 5) 
    (= (at hoist4 depot1-1-4) 4) 
    (= (in container-0-0 container0) 3) 
    (= (on crate4 container-1-0) 5) 
    (= (on crate10 container-3-1) 3) 
    (= (at hoist2 loadarea) 1) 
    (= (in crate9 depot1) 2) 
    (= (on crate2 container-2-0) 2) 
    (= (on crate13 depot2-1-4) 3) 
    (= (clear container-2-0) 3) 
    (= (on crate7 depot1-2-4) 5) 
    (= (on crate14 depot4-1-4) 5) 
    (= (at hoist4 depot4-2-2) 2) 
    (= (on crate15 depot3-2-1) 5) 
    (= (on crate3 depot1-2-2) 3) 
    (= (in depot4-2-2 depot4) 4) 
    (= (on crate10 container-1-3) 5) 
    (= (on crate13 depot1-2-3) 3) 
    (= (at hoist1 depot2-1-4) 1) 
    (= (on crate4 depot1-2-3) 5) 
    (= (on crate5 container-1-2) 1) 
    (= (at hoist0 depot1-1-1) 4) 
    (= (on crate1 depot1-2-2) 3) 
    (= (on crate13 depot2-1-1) 3) 
    (= (on crate6 container-0-2) 2) 
    (= (at hoist4 container-2-2) 4) 
    (= (on crate17 depot3-1-2) 1) 
    (= (at hoist2 depot1-1-2) 1) 
    (= (on crate2 depot3-2-2) 4) 
    (= (on crate9 depot4-1-1) 2) 
    (= (lifting hoist4 crate11) 4) 
    (= (on crate7 container-3-2) 5) 
    (= (lifting hoist2 crate5) 4) 
    (= (at hoist0 container-0-2) 3) 
    (= (in crate15 depot2) 4) 
    (= (in depot2-2-3 depot2) 1) 
    (= (at hoist4 depot2-1-3) 2) 
    (= (on crate17 depot2-1-4) 2) 
    (= (on crate17 depot2-2-1) 1) 
    (= (on crate13 container-2-3) 2) 
    (= (on crate9 depot1-2-3) 2) 
    (= (on crate14 container-3-1) 3) 
    (= (on crate4 container-2-2) 3) 
    (= (at hoist0 container-2-3) 1) 
    (= (on crate16 container-2-0) 2) 
    (= (on crate17 depot1-1-1) 5) 
    (= (in depot1-2-2 depot1) 5) 
    (= (on crate10 depot3-2-1) 2) 
    (= (on crate1 depot3-1-4) 2) 
    (= (at hoist1 depot0-1-1) 4) 
    (= (on crate16 depot0-1-4) 4) 
    (= (on crate6 depot3-1-3) 3) 
    (= (at hoist1 container-2-3) 2) 
 )
 (:bound 20)
 )
