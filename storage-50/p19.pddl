...
(:init
 ...
 (:utility 
    ...
    (= (in crate7 depot2) 10) 
    (= (in crate8 depot2) 10) 
    (= (at hoist2 loadarea) 5) 
    (= (on crate7 depot2-1-3) 1) 
    (= (lifting hoist2 crate0) 5) 
    (= (at hoist2 depot2-1-1) 5) 
    (= (clear container-1-2) 3) 
    (= (at hoist1 depot1-1-1) 4) 
    (= (in depot1-2-1 depot1) 3) 
    (= (on crate1 depot2-1-2) 3) 
    (= (in container-2-0 container2) 4) 
    (= (lifting hoist0 crate5) 5) 
    (= (on crate6 depot2-1-1) 2) 
    (= (on crate2 depot1-1-3) 4) 
    (= (lifting hoist1 crate0) 3) 
    (= (at hoist0 loadarea) 2) 
    (= (in crate2 depot1) 5) 
    (= (lifting hoist1 crate4) 1) 
    (= (on crate2 depot1-2-3) 1) 
    (= (on crate6 container-0-2) 2) 
    (= (clear depot1-1-3) 1) 
    (= (clear container-1-3) 4) 
    (= (at hoist1 depot2-2-1) 4) 
    (= (on crate2 depot2-2-3) 2) 
 )
 (:bound 20)
 )
