...
(:init
 ...
 (:utility 
    ...
    (= (in crate4 depot1) 10) 
    (= (in crate5 depot1) 10) 
    (= (on crate3 container-1-1) 4) 
    (= (clear depot0-1-3) 2) 
    (= (on crate3 depot1-1-1) 2) 
    (= (at hoist0 loadarea) 3) 
    (= (on crate5 depot0-1-2) 4) 
    (= (on crate5 depot0-2-1) 1) 
    (= (available hoist1) 3) 
    (= (on crate0 depot1-2-1) 2) 
    (= (on crate0 container-0-0) 3) 
    (= (on crate1 depot1-2-1) 5) 
    (= (on crate0 depot1-1-2) 1) 
    (= (on crate1 depot0-2-2) 1) 
 )
 (:bound 10)
 )
