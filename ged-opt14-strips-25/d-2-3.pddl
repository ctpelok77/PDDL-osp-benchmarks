...
;; sequence 1 (names): ((NORMAL SUB2) (NORMAL G40) (NORMAL SUB3) (NORMAL SUB4) (NORMAL SUB1))
;; sequence 2 (names): ((NORMAL SUB2) (INVERTED SUB3) (NORMAL G40) (INVERTED SUB4) (NORMAL SUB1))

(DEFINE (PROBLEM CAMPANULA-TO-ADENOPHORA)
        (:DOMAIN GENOME-EDIT-DISTANCE)
        (:OBJECTS SUB4 SUB3 SUB2 SUB1 G40)
        (:INIT (NORMAL SUB2) (NORMAL G40) (NORMAL SUB3) (NORMAL SUB4)
               (NORMAL SUB1) (PRESENT SUB2) (PRESENT G40)
               (PRESENT SUB3) (PRESENT SUB4) (PRESENT SUB1)
               (CW SUB1 SUB2) (CW SUB4 SUB1) (CW SUB3 SUB4)
               (CW G40 SUB3) (CW SUB2 G40) (IDLE) (= (TOTAL-COST) 0))
 (:utility 
    (= (NORMAL SUB2) 10) 
    (= (INVERTED SUB3) 10) 
    (= (NORMAL G40) 10) 
