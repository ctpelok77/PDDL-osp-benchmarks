(define (problem scanalyzer3d-39)
 ...
 (:utility 
    ...
    (= (on car-in-7 seg-out-5) 5) 
    (= (on car-in-4 seg-out-4) 2) 
    (= (on car-out-2 seg-in-5) 2) 
    (= (on car-out-1 seg-out-3) 4) 
    (= (on car-in-2 seg-out-8) 1) 
    (= (on car-out-8 seg-in-7) 2) 
    (= (on car-in-3 seg-in-1) 1) 
    (= (on car-in-6 seg-in-1) 3) 
    (= (on car-out-7 seg-out-1) 3) 
    (= (on car-in-5 seg-in-4) 4) 
    (= (on car-out-3 seg-out-5) 4) 
