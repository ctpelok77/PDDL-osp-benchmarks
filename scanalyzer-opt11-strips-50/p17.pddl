(define (problem scanalyzer3d-32)
 ...
 (:utility 
    ...
    (= (on car-out-6 seg-in-1) 3) 
    (= (on car-in-1 seg-in-3) 5) 
    (= (on car-out-2 seg-out-7) 3) 
    (= (on car-out-7 seg-in-4) 2) 
    (= (on car-out-5 seg-out-4) 1) 
    (= (on car-out-5 seg-in-3) 1) 
    (= (on car-out-5 seg-in-2) 4) 
    (= (on car-out-3 seg-in-5) 4) 
    (= (on car-out-7 seg-out-3) 2) 
 )
 (:bound 33)
 (:use-cost-metric)
 )
