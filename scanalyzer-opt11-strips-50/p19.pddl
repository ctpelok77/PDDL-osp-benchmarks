(define (problem scanalyzer3d-42)
 ...
 (:utility 
    ...
    (= (on car-in-9 seg-out-2) 2) 
    (= (on car-in-1 seg-in-5) 3) 
    (= (on car-in-1 seg-in-2) 3) 
    (= (on car-in-1 seg-in-9) 2) 
    (= (on car-in-6 seg-out-3) 2) 
    (= (on car-in-1 seg-in-3) 5) 
    (= (on car-out-8 seg-in-2) 1) 
    (= (on car-in-9 seg-in-5) 1) 
    (= (on car-out-1 seg-out-8) 4) 
    (= (on car-out-2 seg-in-2) 3) 
    (= (on car-in-2 seg-in-6) 1) 
    (= (on car-out-4 seg-out-5) 5) 
    (= (on car-in-6 seg-out-2) 5) 
    (= (on car-in-2 seg-in-5) 4) 
    (= (on car-out-9 seg-out-5) 4) 
 )
 (:bound 43)
 (:use-cost-metric)
 )
