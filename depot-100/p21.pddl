...
(:init
 ...
 (:utility 
    (= (on crate0 pallet2) 10) 
    (= (on crate1 pallet7) 10) 
    (= (on crate2 pallet11) 10) 
    (= (on crate3 pallet3) 10) 
    (= (on crate5 pallet5) 10) 
    (= (on crate6 pallet12) 10) 
    (= (on crate7 pallet18) 10) 
    (= (on crate8 pallet15) 10) 
    (= (on crate2 crate5) 1) 
    (= (on crate6 crate2) 4) 
    (= (clear pallet12) 5) 
    (= (on crate0 pallet17) 2) 
    (= (on crate5 pallet11) 2) 
    (= (lifting hoist5 crate9) 4) 
    (= (lifting hoist6 crate5) 5) 
    (= (on crate0 pallet3) 1) 
    (= (at crate9 distributor3) 2) 
    (= (on crate6 crate9) 2) 
    (= (at crate3 depot2) 5) 
    (= (on crate4 crate3) 2) 
    (= (on crate3 crate0) 1) 
    (= (at crate3 depot4) 3) 
    (= (at hoist1 depot1) 4) 
    (= (on crate4 pallet14) 3) 
    (= (on crate8 pallet13) 3) 
    (= (on crate6 pallet18) 2) 
    (= (on crate6 pallet4) 3) 
    (= (at crate9 depot5) 1) 
    (= (on crate8 crate2) 4) 
    (= (lifting hoist7 crate0) 5) 
    (= (available hoist7) 3) 
    (= (on crate4 pallet6) 2) 
    (= (on crate7 crate4) 3) 
    (= (on crate4 pallet8) 1) 
    (= (at crate7 depot0) 5) 
    (= (lifting hoist14 crate2) 4) 
    (= (on crate5 pallet2) 5) 
    (= (at hoist12 depot5) 1) 
    (= (on crate7 crate8) 5) 
    (= (lifting hoist10 crate8) 1) 
    (= (available hoist12) 5) 
    (= (on crate8 crate9) 3) 
    (= (at pallet5 depot5) 2) 
    (= (clear pallet18) 3) 
    (= (on crate1 pallet19) 1) 
    (= (at crate2 depot2) 4) 
 )
 (:bound 33)
 )
