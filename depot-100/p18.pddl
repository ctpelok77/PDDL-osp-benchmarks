...
(:init
 ...
 (:utility 
    (= (on crate0 crate10) 10) 
    (= (on crate1 pallet6) 10) 
    (= (on crate2 crate12) 10) 
    (= (on crate4 pallet4) 10) 
    (= (on crate5 pallet2) 10) 
    (= (on crate6 pallet7) 10) 
    (= (on crate8 crate4) 10) 
    (= (on crate9 crate1) 10) 
    (= (on crate10 pallet1) 10) 
    (= (on crate11 pallet5) 10) 
    (= (on crate12 crate5) 10) 
    (= (on crate13 pallet3) 10) 
    (= (on crate14 pallet0) 10) 
    (= (in crate0 truck2) 1) 
    (= (on crate4 crate10) 3) 
    (= (lifting hoist2 crate8) 3) 
    (= (lifting hoist6 crate5) 4) 
    (= (in crate14 truck1) 1) 
    (= (on crate1 crate8) 5) 
    (= (on crate7 pallet4) 5) 
    (= (lifting hoist6 crate12) 4) 
    (= (on crate7 pallet2) 4) 
    (= (on crate8 crate14) 2) 
    (= (lifting hoist4 crate12) 3) 
    (= (on crate6 pallet4) 5) 
    (= (on crate7 crate6) 1) 
    (= (lifting hoist7 crate0) 2) 
    (= (lifting hoist0 crate1) 4) 
    (= (on crate6 crate5) 2) 
    (= (in crate7 truck3) 4) 
    (= (at crate0 distributor0) 5) 
    (= (at pallet0 depot0) 1) 
    (= (lifting hoist4 crate11) 5) 
    (= (at crate12 distributor1) 5) 
    (= (on crate10 crate11) 2) 
    (= (clear pallet7) 2) 
    (= (on crate5 pallet0) 2) 
    (= (at crate3 depot1) 3) 
    (= (at hoist7 distributor1) 1) 
    (= (on crate13 crate5) 3) 
    (= (at crate12 depot1) 4) 
    (= (at crate5 depot0) 1) 
    (= (on crate9 crate2) 3) 
