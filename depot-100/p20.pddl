...
(:init
 ...
 (:utility 
    ...
    (= (on crate1 crate11) 10) 
    (= (on crate2 pallet6) 10) 
    (= (on crate3 crate0) 10) 
    (= (on crate4 crate5) 10) 
    (= (on crate5 crate14) 10) 
    (= (on crate6 pallet4) 10) 
    (= (on crate7 pallet2) 10) 
    (= (on crate8 pallet7) 10) 
    (= (on crate9 crate8) 10) 
    (= (on crate11 pallet5) 10) 
    (= (on crate12 crate6) 10) 
    (= (on crate13 crate2) 10) 
    (= (on crate14 pallet1) 10) 
    (= (on crate9 pallet1) 1) 
    (= (in crate5 truck3) 5) 
    (= (on crate11 crate2) 5) 
    (= (lifting hoist7 crate13) 4) 
    (= (on crate7 crate3) 4) 
    (= (on crate6 pallet0) 3) 
    (= (on crate10 crate6) 3) 
    (= (on crate11 pallet1) 5) 
    (= (at crate9 depot3) 3) 
    (= (on crate8 crate8) 1) 
    (= (on crate0 crate10) 2) 
    (= (on crate14 crate5) 1) 
    ...
    (= (on crate6 crate1) 3) 
    (= (in crate8 truck0) 3) 
    (= (at crate12 distributor2) 5) 
    (= (on crate4 pallet8) 2) 
    (= (at crate12 depot2) 5) 
    (= (on crate3 crate8) 2) 
    (= (in crate7 truck1) 4) 
    (= (on crate3 pallet6) 4) 
    (= (on crate12 pallet2) 3) 
    (= (at crate7 depot0) 3) 
    (= (on crate1 pallet8) 2) 
    (= (lifting hoist1 crate10) 4) 
    (= (lifting hoist3 crate2) 2) 
    (= (lifting hoist4 crate5) 2) 
    (= (on crate3 crate3) 4) 
    (= (on crate10 pallet9) 1) 
    (= (on crate6 crate13) 1) 
    (= (on crate7 pallet3) 1) 
    (= (at crate11 distributor2) 4) 
    (= (on crate0 pallet8) 5) 
    (= (on crate9 pallet7) 4) 
    (= (on crate8 crate11) 5) 
    (= (on crate5 crate6) 2) 
    (= (at crate2 distributor1) 1) 
 )
 (:bound 87)
 )
