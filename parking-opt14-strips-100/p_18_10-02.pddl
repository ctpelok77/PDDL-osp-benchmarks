(define   (problem parking)
 ...
 (:utility 
    ...
    (= (at-curb-num car_11 curb_1) 4) 
    (= (behind-car car_06 car_00) 1) 
    (= (behind-car car_08 car_13) 3) 
    (= (at-curb-num car_10 curb_7) 3) 
    (= (behind-car car_03 car_04) 3) 
    (= (at-curb-num car_06 curb_0) 2) 
    (= (behind-car car_12 car_15) 1) 
    (= (behind-car car_00 car_16) 2) 
    (= (behind-car car_06 car_04) 1) 
    (= (at-curb-num car_13 curb_2) 5) 
    (= (behind-car car_04 car_02) 5) 
    (= (behind-car car_17 car_10) 3) 
    (= (at-curb-num car_10 curb_0) 2) 
    (= (car-clear car_16) 5) 
    (= (behind-car car_07 car_11) 1) 
    (= (car-clear car_04) 4) 
    (= (behind-car car_05 car_15) 1) 
    (= (at-curb-num car_12 curb_2) 5) 
    (= (at-curb-num car_07 curb_5) 2) 
    (= (behind-car car_03 car_16) 4) 
    (= (at-curb-num car_05 curb_1) 2) 
    (= (behind-car car_15 car_07) 3) 
    (= (car-clear car_08) 4) 
    (= (behind-car car_06 car_05) 2) 
    (= (behind-car car_04 car_05) 3) 
