(define (problem strips-mysty-x-21)
 ...
 (:utility 
    (= (craves sciatica apple) 10) 
    (= (craves loneliness-32 onion) 2) 
    (= (craves abrasion popover) 5) 
    (= (fears hangover-3 learning) 1) 
    (= (craves angina lemon) 1) 
    (= (fears laceration-10 learning) 5) 
    (= (fears boils rest) 2) 
    (= (craves laceration-5 okra) 1) 
    (= (craves jealousy guava) 2) 
    (= (craves hangover-3 marzipan) 5) 
    (= (craves depression-8 guava) 5) 
    (= (craves laceration okra) 2) 
    (= (craves grief-2 lemon) 1) 
    (= (craves anger snickers) 4) 
    (= (fears grief-2 love) 5) 
    (= (craves boils-12 guava) 2) 
    (= (craves anxiety-13 flounder) 5) 
    (= (craves anxiety popover) 5) 
    (= (craves hangover-3 lemon) 4) 
    (= (craves grief-2 wurst) 4) 
    (= (fears jealousy expectation) 1) 
    (= (craves hangover okra) 2) 
    (= (harmony satisfaction saturn) 3) 
    (= (craves loneliness onion) 3) 
    (= (craves sciatica-16 muffin) 3) 
    (= (fears sciatica satisfaction) 4) 
    (= (craves anger-4 popover) 3) 
    (= (craves angina-1 apple) 2) 
    (= (craves anxiety flounder) 4) 
    (= (craves angina flounder) 3) 
    (= (craves depression-8 popover) 1) 
    (= (craves anxiety apple) 3) 
    (= (craves hangover marzipan) 3) 
    (= (fears prostatitis-7 learning) 4) 
    (= (craves prostatitis-7 guava) 4) 
 )
 (:bound 3)
 )
