(define (problem strips-mysty-x-23)
 ...
 (:utility 
    ...
    (= (craves abrasion chicken) 2) 
    (= (locale chicken pennsylvania) 2) 
    (= (craves anxiety-1 chicken) 5) 
    (= (fears dread curiosity) 5) 
    (= (harmony intoxication mars) 4) 
    (= (locale apple kentucky) 3) 
    (= (fears anxiety intoxication) 2) 
    (= (craves dread wonderbread) 3) 
    (= (locale flounder kentucky) 4) 
    (= (craves loneliness lamb) 3) 
    (= (craves hangover beef) 2) 
    (= (craves empathy chicken) 4) 
    (= (craves anxiety beef) 4) 
    (= (craves anxiety onion) 1) 
    (= (fears grief empathy) 1) 
    (= (craves satisfaction lamb) 4) 
    (= (craves jealousy haroset) 3) 
    (= (craves anger wonderbread) 1) 
    (= (craves anxiety-1 pistachio) 5) 
    (= (craves angina lobster) 4) 
    (= (craves anxiety-1 flounder) 1) 
    (= (craves boils scallop) 5) 
    (= (craves laceration ham) 2) 
    (= (locale haroset manitoba) 1) 
    (= (locale scallop goias) 5) 
    (= (craves grief lamb) 5) 
    (= (craves boils-2 sweetroll) 3) 
    (= (harmony satisfaction mars) 2) 
    (= (craves boils sweetroll) 1) 
 )
 (:bound 4)
 )
