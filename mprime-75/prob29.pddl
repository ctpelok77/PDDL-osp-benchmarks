(define (problem strips-mprime-x-29)
 ...
 (:utility 
    (= (craves jealousy shrimp) 10) 
    (= (craves prostatitis shrimp) 10) 
    (= (craves prostatitis papaya) 4) 
    (= (locale pork arizona) 4) 
    (= (craves achievement scallop) 3) 
    (= (craves achievement pear) 2) 
    (= (craves laceration melon) 5) 
    (= (fears prostatitis excitement) 3) 
    (= (craves grief papaya) 1) 
    (= (locale scallop quebec) 2) 
    (= (craves laceration popover) 5) 
    (= (craves achievement shrimp) 1) 
 )
 (:bound 3)
 )
