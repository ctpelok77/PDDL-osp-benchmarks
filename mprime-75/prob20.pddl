(define (problem strips-mprime-x-20)
 ...
 (:utility 
    ...
    (= (locale orange manitoba) 1) 
    (= (craves understanding potato) 4) 
    (= (craves grief orange) 1) 
    (= (craves laceration pork) 3) 
    (= (craves satisfaction mutton) 5) 
    (= (craves grief guava) 3) 
    (= (harmony expectation venus) 5) 
    (= (craves aesthetics wonderbread) 3) 
    (= (harmony aesthetics venus) 2) 
    (= (craves achievement guava) 2) 
    (= (craves empathy cod) 1) 
    (= (fears grief empathy) 5) 
    (= (craves expectation pepper) 1) 
    (= (craves grief mutton) 2) 
    (= (craves curiosity wonderbread) 2) 
    (= (locale scallion manitoba) 2) 
    (= (craves aesthetics rice) 3) 
    (= (locale cherry surrey) 5) 
    (= (fears laceration lubricity) 5) 
    (= (craves triumph mutton) 2) 
    (= (craves grief tuna) 3) 
    (= (locale cherry bavaria) 4) 
    (= (locale cod surrey) 1) 
    (= (craves understanding pork) 5) 
    (= (locale muffin guanabara) 1) 
    (= (craves triumph orange) 4) 
    (= (locale sweetroll quebec) 4) 
    (= (locale rice kentucky) 4) 
 )
 (:bound 5)
 )
