(define (problem strips-log-y-5)
 ...
 (:utility 
    ...
    (= (at package3 city8-3) 10) 
    (= (at package2 city4-3) 10) 
    (= (at package1 city6-3) 10) 
    (= (at package1 city5-3) 5) 
    (= (at package5 city1-1) 1) 
    (= (at package3 city1-2) 1) 
    (= (at truck3 city1-2) 3) 
    (= (at truck15 city8-2) 2) 
    (= (at truck5 city1-2) 3) 
    (= (at plane1 city1-3) 4) 
    (= (in package4 truck15) 5) 
    (= (at package3 city6-2) 2) 
    (= (at package5 city5-1) 4) 
    (= (at truck12 city5-2) 4) 
    (= (at package2 city6-3) 5) 
 )
 (:bound 22)
 )
