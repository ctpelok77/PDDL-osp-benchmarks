(define (problem strips-log-x-11)
   ...
   (:init (obj package8)
          ...
          (at package1 city1-3))
 (:utility 
    (= (at package8 city3-3) 10) 
    (= (at package7 city3-3) 10) 
    (= (at package6 city3-2) 10) 
    (= (at package5 city1-3) 10) 
    (= (at package4 city3-3) 10) 
    (= (at package3 city1-2) 10) 
    (= (at package2 city2-3) 10) 
    (= (at package1 city1-1) 10) 
    (= (in package2 truck7) 5) 
    (= (at package2 city3-1) 2) 
    (= (at plane1 city3-3) 4) 
    (= (at truck5 city2-3) 2) 
    (= (in package6 truck5) 5) 
    (= (in package7 truck22) 3) 
    (= (in package4 truck9) 4) 
    (= (at package4 city1-3) 5) 
    (= (at package4 city2-2) 2) 
    (= (in package8 truck18) 2) 
    (= (in package1 plane5) 4) 
    (= (at truck19 city2-2) 1) 
    (= (in package4 truck11) 1) 
    (= (at truck19 city2-3) 1) 
    (= (in package4 truck14) 3) 
    (= (at package1 city2-1) 1) 
    (= (in package8 plane2) 5) 
    (= (at package6 city3-1) 3) 
 )
 (:bound 22)
 )
