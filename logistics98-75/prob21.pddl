(define (problem strips-log-x-21)
 ...
 (:utility 
    (= (at package11 city9-8) 10) 
    (= (at package10 city12-9) 10) 
    (= (at package9 city2-3) 10) 
    (= (at package8 city10-7) 10) 
    (= (at package7 city2-2) 10) 
    (= (at package6 city12-6) 10) 
    (= (at package5 city14-8) 10) 
    (= (at package4 city13-2) 10) 
    (= (at package3 city2-8) 10) 
    (= (at package2 city6-2) 10) 
    (= (at package1 city11-6) 10) 
    (= (in package3 plane12) 1) 
    (= (in package9 plane13) 4) 
    (= (at package4 city14-8) 5) 
    (= (at package5 city9-7) 3) 
    (= (at package8 city11-1) 1) 
    (= (in package7 truck4) 3) 
    (= (at truck6 city4-5) 2) 
    (= (in package9 truck17) 1) 
    (= (in package1 plane8) 5) 
    (= (at truck4 city1-8) 2) 
    (= (at plane10 city4-9) 1) 
    (= (at package7 city8-7) 1) 
    (= (at package1 city9-5) 4) 
    (= (at package11 city8-5) 5) 
    (= (at package2 city9-4) 1) 
    (= (in package7 truck26) 3) 
    (= (at package8 city6-6) 4) 
    (= (at package5 city12-7) 1) 
    (= (at package10 city3-2) 1) 
    (= (in package5 truck10) 2) 
    (= (in package6 truck10) 1) 
    (= (at truck31 city5-7) 4) 
    (= (at package2 city8-3) 3) 
    (= (at package6 city9-3) 4) 
    (= (at package10 city6-8) 5) 
    (= (in package7 plane8) 2) 
    (= (at package8 city8-5) 3) 
    (= (in package3 truck32) 2) 
    (= (at package2 city11-5) 4) 
    (= (in package11 plane3) 5) 
    (= (in package8 plane4) 4) 
    (= (at plane13 city11-9) 1) 
    (= (in package2 truck40) 3) 
    (= (in package4 plane10) 2) 
    (= (at truck1 city12-7) 3) 
    (= (at truck2 city2-8) 4) 
    (= (at package5 city6-7) 2) 
    (= (at package3 city5-5) 2) 
    (= (at truck31 city5-5) 2) 
    (= (at package7 city6-9) 5) 
    (= (in package5 truck11) 3) 
    (= (in package6 truck40) 3) 
    (= (at plane12 city3-9) 5) 
    (= (at package9 city14-4) 4) 
    (= (at package7 city3-1) 5) 
    (= (at package6 city3-9) 5) 
    (= (at package4 city9-2) 2) 
    (= (at package6 city2-5) 2) 
    (= (at package11 city8-7) 2) 
    (= (at package2 city2-1) 4) 
    (= (at truck2 city2-4) 1) 
    (= (at package6 city5-9) 5) 
    (= (at truck18 city5-5) 4) 
    (= (at truck25 city9-3) 4) 
    (= (at plane5 city2-9) 2) 
    (= (at truck4 city1-4) 1) 
    (= (at truck35 city9-3) 4) 
    (= (at package1 city7-5) 3) 
    (= (at truck19 city13-6) 2) 
    (= (in package2 plane2) 5) 
    (= (at package9 city9-6) 4) 
    (= (at package8 city11-6) 1) 
    (= (at package1 city2-1) 3) 
    (= (in package9 truck35) 3) 
    (= (at package4 city10-5) 2) 
    (= (at package5 city2-2) 3) 
    (= (at package1 city2-9) 5) 
    (= (at package3 city8-8) 4) 
    (= (in package8 truck23) 3) 
    (= (at package2 city6-5) 4) 
    (= (at package11 city7-7) 4) 
    (= (in package7 plane13) 2) 
    (= (at package1 city2-6) 5) 
    (= (at package1 city12-4) 3) 
    (= (at package4 city11-3) 2) 
    (= (at package4 city8-4) 3) 
    (= (at package10 city5-4) 5) 
    (= (in package4 truck26) 1) 
    (= (at package8 city5-1) 1) 
    (= (at package5 city12-3) 5) 
    (= (at package7 city12-4) 4) 
    (= (at package2 city5-9) 3) 
    (= (at package6 city8-8) 5) 
    (= (at package8 city4-2) 2) 
    (= (at package10 city2-4) 5) 
    (= (in package8 plane8) 5) 
    (= (at package7 city7-1) 1) 
    (= (at package4 city14-4) 5) 
    (= (at package6 city14-1) 2) 
    (= (at package7 city11-6) 4) 
    (= (at plane7 city2-9) 5) 
    (= (at package6 city3-4) 1) 
    (= (at truck6 city4-3) 1) 
    (= (at package8 city9-4) 5) 
    (= (at package11 city9-7) 4) 
    (= (at package11 city6-4) 5) 
    (= (at plane3 city6-9) 4) 
    (= (at package4 city7-6) 1) 
    (= (at package11 city7-5) 5) 
    (= (at package2 city12-6) 4) 
    (= (in package2 truck26) 4) 
    (= (in package9 plane9) 5) 
    (= (at package6 city2-1) 1) 
    (= (at truck11 city6-2) 5) 
    (= (in package2 truck34) 2) 
    (= (at package10 city13-2) 2) 
    (= (in package7 truck36) 4) 
    (= (at package8 city14-2) 3) 
    (= (at package2 city10-8) 1) 
    (= (at package6 city13-5) 3) 
    (= (in package6 truck20) 1) 
    (= (at package6 city8-4) 1) 
    (= (at package6 city1-3) 2) 
    (= (at truck8 city11-6) 2) 
    (= (in package10 truck11) 3) 
    (= (at plane2 city4-9) 3) 
    (= (at package3 city12-7) 1) 
    (= (in package5 truck39) 3) 
    (= (at plane11 city8-9) 3) 
    (= (at truck32 city6-1) 2) 
    (= (at package11 city5-8) 1) 
    (= (at package9 city13-8) 4) 
    (= (in package4 truck35) 3) 
    (= (in package10 truck36) 2) 
    (= (at package7 city1-9) 3) 
 )
 (:bound 81)
 )
