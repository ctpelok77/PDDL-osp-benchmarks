...
(define (problem transport-three-cities-sequential-18nodes-1000size-4degree-100mindistance-3trucks-6packages-2014seed)
 ...
 (:utility 
    (= (at package-1 city-2-loc-4) 10) 
    (= (at package-2 city-3-loc-9) 10) 
    (= (at package-3 city-2-loc-3) 10) 
    (= (at package-4 city-3-loc-12) 10) 
    (= (at package-5 city-1-loc-14) 10) 
    (= (at package-6 city-3-loc-8) 10) 
    (= (at package-5 city-2-loc-8) 1) 
    (= (at truck-2 city-3-loc-5) 1) 
    (= (at truck-1 city-3-loc-16) 4) 
    (= (at truck-1 city-1-loc-10) 3) 
    (= (at truck-1 city-2-loc-2) 5) 
    (= (at truck-1 city-1-loc-3) 5) 
    (= (capacity truck-3 capacity-3) 3) 
    (= (at truck-1 city-2-loc-8) 4) 
    (= (at truck-1 city-1-loc-5) 2) 
    (= (at package-1 city-1-loc-2) 2) 
    (= (at truck-1 city-3-loc-11) 5) 
    (= (at truck-1 city-2-loc-7) 4) 
    (= (at package-4 city-1-loc-15) 1) 
    (= (at truck-2 city-1-loc-18) 2) 
    (= (at truck-2 city-3-loc-10) 3) 
    (= (at package-6 city-1-loc-14) 2) 
    (= (at package-3 city-1-loc-8) 1) 
    (= (at package-6 city-2-loc-17) 5) 
    (= (at package-2 city-2-loc-7) 4) 
    (= (at truck-3 city-1-loc-8) 3) 
    (= (at package-3 city-2-loc-1) 2) 
    (= (in package-5 truck-3) 1) 
    (= (at package-3 city-2-loc-12) 4) 
    (= (at package-1 city-1-loc-9) 5) 
    (= (at package-1 city-1-loc-18) 3) 
 )
 (:bound 1051)
 (:use-cost-metric)
 )
