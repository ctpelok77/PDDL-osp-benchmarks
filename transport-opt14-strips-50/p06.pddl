...
(define (problem transport-city-sequential-20nodes-1000size-4degree-100mindistance-3trucks-6packages-2014seed)
 ...
 (:utility 
    (= (at package-1 city-loc-10) 10) 
    (= (at package-2 city-loc-19) 10) 
    (= (at package-3 city-loc-20) 10) 
    (= (at package-4 city-loc-18) 10) 
    (= (at package-5 city-loc-13) 10) 
    (= (at package-6 city-loc-1) 10) 
    (= (at package-2 city-loc-20) 5) 
    (= (at package-5 city-loc-11) 2) 
    (= (at package-2 city-loc-1) 4) 
    (= (at package-2 city-loc-10) 4) 
    (= (at package-4 city-loc-14) 1) 
    (= (at package-5 city-loc-17) 3) 
    (= (in package-6 truck-3) 2) 
    (= (capacity truck-2 capacity-0) 1) 
    (= (at truck-2 city-loc-3) 3) 
    (= (at package-3 city-loc-17) 5) 
 )
 (:bound 372)
 (:use-cost-metric)
 )
