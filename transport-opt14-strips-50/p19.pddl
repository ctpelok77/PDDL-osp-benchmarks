...
(define (problem transport-three-cities-sequential-20nodes-1000size-4degree-100mindistance-3trucks-7packages-2014seed)
 ...
 (:utility 
    (= (at package-1 city-2-loc-5) 10) 
    (= (at package-2 city-2-loc-17) 10) 
    (= (at package-3 city-1-loc-12) 10) 
    (= (at package-4 city-1-loc-5) 10) 
    (= (at package-5 city-3-loc-14) 10) 
    (= (at package-6 city-3-loc-15) 10) 
    (= (at package-7 city-2-loc-10) 10) 
    (= (at package-7 city-3-loc-12) 5) 
    (= (at truck-1 city-3-loc-18) 2) 
    (= (at package-4 city-1-loc-6) 5) 
    (= (at truck-1 city-2-loc-4) 3) 
    (= (at truck-3 city-3-loc-11) 2) 
    (= (at truck-1 city-3-loc-6) 5) 
    (= (at package-1 city-1-loc-4) 4) 
    (= (at package-4 city-2-loc-6) 3) 
    (= (at package-7 city-1-loc-16) 2) 
    (= (at package-5 city-2-loc-7) 5) 
    (= (at package-6 city-1-loc-17) 4) 
    (= (at truck-1 city-3-loc-2) 3) 
    (= (at truck-3 city-2-loc-4) 4) 
    (= (at truck-3 city-1-loc-15) 4) 
    (= (at package-1 city-2-loc-19) 1) 
    (= (at package-5 city-2-loc-1) 1) 
    (= (at truck-2 city-3-loc-19) 5) 
    (= (at package-7 city-3-loc-20) 1) 
    (= (at truck-2 city-2-loc-11) 3) 
    (= (at truck-3 city-1-loc-4) 1) 
    (= (at package-1 city-3-loc-6) 2) 
    (= (at package-7 city-2-loc-15) 4) 
    (= (at package-2 city-2-loc-7) 4) 
    (= (at package-4 city-2-loc-16) 3) 
    (= (at package-1 city-3-loc-8) 2) 
    (= (in package-7 truck-2) 3) 
    (= (at truck-1 city-1-loc-12) 3) 
    (= (at package-3 city-2-loc-20) 1) 
    (= (at package-2 city-3-loc-14) 1) 
    (= (capacity truck-3 capacity-0) 2) 
    (= (at package-5 city-1-loc-9) 4) 
 )
 (:bound 1069)
 (:use-cost-metric)
 )
