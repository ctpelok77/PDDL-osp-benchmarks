...
(define (problem transport-three-cities-sequential-12nodes-1000size-3degree-100mindistance-2trucks-5packages-2014seed)
 ...
 (:utility 
    ...
    (= (at package-4 city-1-loc-8) 10) 
    (= (at package-5 city-1-loc-3) 10) 
    (= (at truck-1 city-2-loc-1) 3) 
    (= (at truck-1 city-2-loc-6) 3) 
    (= (capacity truck-1 capacity-4) 4) 
    (= (at package-5 city-1-loc-1) 4) 
    (= (at package-2 city-2-loc-2) 5) 
    (= (at package-1 city-1-loc-2) 2) 
    (= (at package-2 city-3-loc-9) 5) 
    (= (at package-2 city-2-loc-3) 5) 
    (= (at truck-2 city-1-loc-11) 1) 
    (= (at truck-2 city-2-loc-1) 2) 
    (= (at package-5 city-2-loc-12) 1) 
    (= (at package-3 city-1-loc-9) 1) 
    (= (at package-5 city-1-loc-9) 2) 
 )
 (:bound 376)
 (:use-cost-metric)
 )
