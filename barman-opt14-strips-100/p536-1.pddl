(define (problem prob)
 ...
 (:utility 
    ...
    (= (contains shot5 cocktail3) 10) 
    (= (used shot5 ingredient1) 4) 
    (= (used shot4 ingredient3) 2) 
    (= (used shot2 ingredient1) 1) 
    (= (contains shot2 cocktail5) 3) 
    (= (shaker-level shaker1 l0) 5) 
 )
 (:bound 62)
 )
