(define (problem prob)
 ...
 (:utility 
    ...
    (= (contains shot5 cocktail6) 10) 
    (= (contains shot6 cocktail2) 10) 
    (= (contains shot7 cocktail3) 10) 
    (= (used shot5 ingredient2) 4) 
    (= (holding right shaker1) 2) 
    (= (ontable shot4) 4) 
    (= (contains shaker1 cocktail1) 1) 
    (= (used shot8 ingredient3) 1) 
    (= (contains shot3 cocktail1) 2) 
    (= (holding right shot2) 3) 
 )
 (:bound 78)
 )
