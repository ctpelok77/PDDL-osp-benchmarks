...
(define (problem p106-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-04) 10) 
    (= (at-goal stone-05) 10) 
    (= (at stone-03 pos-03-03) 5) 
    (= (at stone-02 pos-07-08) 4) 
    (= (at stone-04 pos-08-03) 3) 
    (= (clear pos-01-08) 1) 
    (= (clear pos-03-08) 3) 
    (= (at player-01 pos-06-02) 3) 
    (= (at stone-03 pos-07-05) 1) 
    (= (at stone-01 pos-08-02) 2) 
    (= (at stone-02 pos-06-03) 1) 
    (= (at stone-02 pos-04-02) 4) 
    (= (clear pos-10-02) 2) 
    (= (at stone-03 pos-06-05) 4) 
 )
 (:bound 25)
 (:use-cost-metric)
 )
