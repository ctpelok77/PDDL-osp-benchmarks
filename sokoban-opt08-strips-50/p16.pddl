...
(define (problem p147-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-02) 10) 
    (= (at-goal stone-03) 10) 
    (= (at stone-03 pos-11-03) 5) 
    (= (at player-01 pos-03-06) 1) 
    (= (clear pos-11-08) 3) 
    (= (at stone-03 pos-03-06) 4) 
    (= (at stone-02 pos-11-04) 2) 
    (= (at player-01 pos-05-06) 5) 
    (= (at stone-02 pos-08-03) 4) 
    (= (at stone-02 pos-08-04) 1) 
    (= (at stone-02 pos-08-05) 3) 
    (= (at stone-03 pos-11-05) 2) 
 )
 (:bound 25)
 (:use-cost-metric)
 )
