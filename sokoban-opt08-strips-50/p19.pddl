...
(define (problem p083-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-03) 10) 
    (= (at-goal stone-04) 10) 
    (= (at stone-03 pos-05-04) 4) 
    (= (at stone-04 pos-04-04) 3) 
    (= (at stone-02 pos-05-07) 4) 
    (= (at stone-01 pos-07-04) 2) 
    (= (at stone-01 pos-07-05) 5) 
    (= (clear pos-03-09) 3) 
    (= (at stone-04 pos-03-03) 1) 
    (= (at stone-04 pos-05-08) 1) 
    (= (at stone-04 pos-07-04) 5) 
    (= (at player-01 pos-06-06) 2) 
 )
 (:bound 23)
 (:use-cost-metric)
 )
