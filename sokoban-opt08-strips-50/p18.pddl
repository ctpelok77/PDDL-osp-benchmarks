...
(define (problem p148-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-03) 10) 
    (= (at-goal stone-04) 10) 
    (= (at stone-02 pos-14-06) 1) 
    (= (at stone-03 pos-05-02) 5) 
    (= (at stone-01 pos-06-03) 1) 
    (= (at stone-02 pos-08-04) 5) 
    (= (at stone-01 pos-08-06) 2) 
    (= (at stone-03 pos-08-02) 2) 
    (= (at stone-03 pos-04-03) 3) 
    (= (clear pos-05-03) 5) 
    (= (clear pos-07-03) 4) 
    (= (clear pos-14-02) 3) 
    (= (at stone-02 pos-09-03) 1) 
 )
 (:bound 24)
 (:use-cost-metric)
 )
