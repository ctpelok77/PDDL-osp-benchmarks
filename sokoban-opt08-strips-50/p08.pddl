...
(define (problem p131-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-03) 10) 
    (= (at-goal stone-04) 10) 
    (= (at stone-03 pos-03-10) 2) 
    (= (clear pos-03-10) 4) 
    (= (at stone-03 pos-05-06) 3) 
    (= (at stone-04 pos-02-04) 1) 
    (= (at stone-02 pos-06-08) 3) 
    (= (at stone-01 pos-05-07) 4) 
    (= (at stone-01 pos-03-04) 5) 
    (= (at stone-01 pos-04-04) 2) 
    (= (clear pos-03-03) 1) 
 )
 (:bound 15)
 (:use-cost-metric)
