...
(:init
 ...
 (:utility 
    ...
    (= (occupied seg_n2_n3_4_0_85) 2) 
    (= (at-segment airplane_daewh seg_rwy_0_1300) 4) 
    (= (blocked seg_a01_0_100 airplane_dfboy) 4) 
    (= (not_blocked seg_b_27_0_100 airplane_dfboy) 5) 
    (= (at-segment airplane_dfboy seg_n2_n3_1_0_86) 3) 
    (= (at-segment airplane_daewh seg_n4_n5_2_0_86) 2) 
    (= (not_blocked seg_a01_0_100 airplane_daewh) 3) 
    (= (at-segment airplane_cfbeg seg_n1_n2_0_100) 5) 
    (= (is-moving airplane_cfbeg) 1) 
    (= (is-parked airplane_daewh seg_a01_0_100) 4) 
    (= (at-segment airplane_cfbeg seg_n4_n5_4_0_85) 4) 
    (= (at-segment airplane_cfbeg seg_n4_n5_3_0_86) 1) 
    (= (not_occupied seg_n4_n5_4_0_85) 1) 
    (= (not_blocked seg_27help_0_100 airplane_daewh) 1) 
    (= (at-segment airplane_daewh seg_27_0_150) 3) 
    (= (at-segment airplane_cfbeg seg_b02_0_100) 5) 
    (= (at-segment airplane_daewh seg_n1_a_0_100) 2) 
    (= (occupied seg_n4_n5_5_0_86) 4) 
    (= (not_blocked seg_27thresh_0_100 airplane_daewh) 5) 
    (= (at-segment airplane_dfboy seg_n_c_0_100) 2) 
    (= (at-segment airplane_dfboy seg_n4_n5_3_0_86) 2) 
    (= (at-segment airplane_cfbeg seg_n2_n3_3_0_86) 3) 
    (= (not_blocked seg_n4_n5_5_0_86 airplane_daewh) 1) 
    (= (at-segment airplane_dfboy seg_c_c2_0_100) 5) 
 )
 (:bound 60)
 )
