...
(define (problem p147-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-02) 10) 
    (= (at-goal stone-03) 10) 
    (= (at stone-01 pos-03-03) 2) 
    (= (at stone-03 pos-08-04) 3) 
    (= (clear pos-06-06) 1) 
    (= (at stone-03 pos-05-05) 1) 
    (= (at stone-02 pos-06-09) 4) 
    (= (at player-01 pos-06-09) 2) 
    (= (at stone-03 pos-04-06) 5) 
    (= (at stone-02 pos-03-06) 4) 
    (= (clear pos-02-10) 3) 
    (= (at player-01 pos-09-05) 5) 
 )
 (:bound 12)
 (:use-cost-metric)
 )
