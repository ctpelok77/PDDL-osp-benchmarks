...
(define (problem p035-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-04) 10) 
    (= (at-goal stone-05) 10) 
    (= (at stone-04 pos-03-05) 1) 
    (= (at stone-04 pos-04-09) 5) 
    (= (at player-01 pos-05-07) 3) 
    (= (at stone-01 pos-06-08) 2) 
    (= (at stone-05 pos-05-04) 4) 
    (= (at stone-05 pos-03-07) 1) 
    (= (at stone-05 pos-04-04) 2) 
    (= (clear pos-05-04) 3) 
    (= (at stone-01 pos-04-05) 4) 
 )
 (:bound 7)
 (:use-cost-metric)
 )
