...
(define (problem p118-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-03) 10) 
    (= (at-goal stone-04) 10) 
    (= (at stone-02 pos-05-08) 1) 
    (= (at player-01 pos-03-09) 1) 
    (= (at stone-02 pos-07-08) 1) 
    (= (clear pos-06-06) 3) 
    (= (at stone-02 pos-06-05) 5) 
    (= (at stone-04 pos-04-06) 3) 
    (= (at stone-04 pos-04-08) 2) 
    (= (at stone-04 pos-04-05) 4) 
    (= (at stone-04 pos-03-02) 3) 
    (= (at stone-02 pos-06-08) 2) 
    (= (clear pos-06-03) 2) 
    (= (at stone-03 pos-05-08) 5) 
 )
 (:bound 11)
 (:use-cost-metric)
 )
