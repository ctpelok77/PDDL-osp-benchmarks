...
(define (problem p134-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-03) 10) 
    (= (at-goal stone-04) 10) 
    (= (at player-01 pos-11-07) 4) 
    (= (at stone-02 pos-06-07) 4) 
    (= (at player-01 pos-08-05) 1) 
    (= (at player-01 pos-07-08) 2) 
    (= (at stone-02 pos-04-06) 2) 
    (= (at stone-01 pos-08-07) 4) 
    (= (clear pos-08-07) 1) 
    (= (clear pos-10-06) 5) 
    (= (at stone-01 pos-10-04) 3) 
    (= (clear pos-04-06) 1) 
    (= (at stone-01 pos-10-08) 2) 
    (= (clear pos-02-10) 3) 
 )
 (:bound 19)
 (:use-cost-metric)
