(define 
 ...
 (:utility 
    ...
    (= (cart-pos cart x1 y4) 4) 
    (= (base-obstacle x3 y4) 4) 
    (= (base-pos pr2 x6 y3) 2) 
    (= (gripper-obstacle x8 y3) 2) 
    (= (base-obstacle x3 y8) 1) 
    (= (base-obstacle x8 y3) 1) 
    (= (base-pos pr2 x5 y8) 5) 
    (= (cart-pos cart x1 y8) 3) 
    (= (base-pos pr2 x6 y5) 5) 
    (= (cart-pos cart x8 y1) 5) 
    (= (object-pos object2 x5 y6) 3) 
    (= (base-obstacle x5 y2) 1) 
    (= (base-obstacle x6 y5) 3) 
    (= (cart-pos cart x5 y6) 4) 
    (= (base-pos pr2 x0 y1) 3) 
    (= (object-pos object2 x6 y4) 5) 
    (= (base-pos pr2 x5 y6) 2) 
    (= (gripper-obstacle x7 y2) 2) 
    (= (cart-pos cart x3 y8) 4) 
 )
 (:bound 23)
 )
