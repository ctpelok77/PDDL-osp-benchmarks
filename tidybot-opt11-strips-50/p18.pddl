(define 
 ...
 (:utility 
    ...
    (= (holding pr2 object2) 3) 
    (= (cart-pos cart x8 y4) 5) 
    (= (base-pos pr2 x1 y7) 5) 
    (= (gripper-obstacle x0 y8) 2) 
    (= (base-obstacle x4 y4) 4) 
    (= (base-pos pr2 x0 y5) 5) 
    (= (base-obstacle x1 y7) 2) 
    (= (object-pos object2 x5 y5) 2) 
    (= (base-pos pr2 x3 y7) 4) 
    (= (cart-pos cart x5 y5) 4) 
    (= (base-obstacle x0 y6) 3) 
    (= (not-pushed cart) 4) 
    (= (object-pos object3 x1 y3) 1) 
    (= (gripper-obstacle x6 y0) 2) 
    (= (cart-pos cart x6 y3) 1) 
    (= (gripper-obstacle x5 y5) 3) 
    (= (cart-pos cart x3 y3) 1) 
    (= (base-obstacle x5 y4) 3) 
 )
 (:bound 22)
 )
