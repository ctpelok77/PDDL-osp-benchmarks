(define 
 ...
 (:utility 
    ...
    (= (base-pos pr2 x1 y6) 4) 
    (= (object-pos object2 x3 y3) 2) 
    (= (base-obstacle x3 y2) 3) 
    (= (gripper-rel pr2 xrel-1 yrel-1) 1) 
    (= (cart-pos cart x4 y3) 4) 
    (= (base-pos pr2 x1 y0) 5) 
    (= (base-obstacle x5 y1) 1) 
    (= (gripper-rel pr2 xrel-1 yrel1) 1) 
    (= (base-obstacle x5 y2) 3) 
    (= (gripper-obstacle x4 y0) 3) 
    (= (gripper-obstacle x2 y4) 2) 
 )
 (:bound 8)
 )
