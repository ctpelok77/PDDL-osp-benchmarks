(define 
 ...
 (:utility 
    ...
    (= (base-obstacle x3 y5) 5) 
    (= (gripper-obstacle x1 y1) 4) 
    (= (base-pos pr2 x7 y2) 2) 
    (= (gripper-obstacle x7 y0) 2) 
    (= (base-obstacle x3 y2) 4) 
    (= (base-obstacle x1 y7) 1) 
    (= (cart-pos cart x1 y1) 1) 
    (= (base-pos pr2 x2 y5) 5) 
    (= (cart-pos cart x2 y5) 3) 
    (= (object-pos object1 x3 y4) 3) 
    (= (gripper-obstacle x4 y0) 2) 
    (= (base-obstacle x1 y2) 4) 
    (= (cart-pos cart x7 y7) 1) 
    (= (object-pos object0 x4 y4) 5) 
 )
 (:bound 17)
 )
