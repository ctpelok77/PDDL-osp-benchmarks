...
(:init
 ...
 (:utility 
    ...
    (= (at-robot loc-x0-y12) 1) 
    (= (at-robot loc-x0-y6) 3) 
    (= (at-robot loc-x13-y13) 3) 
    (= (at-robot loc-x1-y8) 1) 
    (= (at-robot loc-x1-y10) 4) 
    (= (at-robot loc-x10-y3) 3) 
    (= (at-robot loc-x4-y0) 2) 
    (= (at-robot loc-x7-y7) 5) 
    (= (at-robot loc-x15-y6) 1) 
    (= (at-robot loc-x15-y8) 5) 
    (= (at-robot loc-x10-y11) 5) 
    (= (at-robot loc-x14-y10) 2) 
 )
 (:bound 191)
 )
