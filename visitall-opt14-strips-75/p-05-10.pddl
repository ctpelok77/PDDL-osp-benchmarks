...
(:init
 ...
 (:utility 
    ...
    (= (visited loc-x7-y2) 10) 
    (= (visited loc-x7-y4) 10) 
    (= (visited loc-x7-y9) 10) 
    (= (visited loc-x8-y2) 10) 
    (= (visited loc-x8-y9) 10) 
    (= (visited loc-x9-y3) 10) 
    ...
    (= (at-robot loc-x6-y3) 1) 
    (= (at-robot loc-x2-y5) 5) 
    (= (at-robot loc-x0-y2) 1) 
    (= (at-robot loc-x4-y1) 3) 
 )
 (:bound 45)
 )
