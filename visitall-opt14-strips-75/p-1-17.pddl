...
(:init
 ...
 (:utility 
    ...
    (= (at-robot loc-x9-y5) 4) 
    (= (at-robot loc-x5-y2) 1) 
    (= (at-robot loc-x13-y12) 5) 
    (= (at-robot loc-x1-y8) 4) 
    (= (at-robot loc-x0-y0) 1) 
    (= (at-robot loc-x15-y7) 4) 
    (= (at-robot loc-x9-y8) 2) 
    (= (at-robot loc-x0-y1) 1) 
    (= (at-robot loc-x2-y14) 5) 
    (= (at-robot loc-x11-y4) 3) 
    (= (at-robot loc-x9-y11) 2) 
    (= (at-robot loc-x3-y8) 3) 
    (= (at-robot loc-x6-y0) 2) 
    (= (at-robot loc-x8-y11) 5) 
 )
 (:bound 216)
 )
