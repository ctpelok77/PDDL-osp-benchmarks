...
(:init
	...
	(at truck7 depot2))
 (:utility 
    (= (stored goods1 level4) 10) 
    (= (stored goods2 level2) 10) 
    (= (stored goods3 level6) 10) 
    (= (stored goods4 level4) 10) 
    (= (stored goods5 level2) 10) 
    (= (stored goods6 level2) 10) 
    (= (stored goods7 level5) 10) 
    (= (stored goods8 level1) 10) 
    (= (stored goods9 level2) 10) 
    (= (stored goods10 level4) 10) 
    (= (stored goods11 level2) 10) 
    (= (stored goods12 level5) 10) 
    (= (stored goods13 level1) 10) 
    (= (stored goods14 level2) 10) 
    (= (stored goods15 level3) 10) 
    (= (stored goods16 level1) 10) 
    (= (stored goods17 level2) 10) 
    (= (at truck2 market6) 3) 
    (= (loaded goods12 truck5 level3) 2) 
    (= (loaded goods5 truck3 level1) 2) 
    (= (loaded goods17 truck2 level1) 3) 
    (= (loaded goods9 truck7 level2) 3) 
    (= (on-sale goods10 market4 level0) 1) 
    (= (stored goods15 level6) 1) 
    (= (loaded goods14 truck3 level2) 3) 
    (= (loaded goods7 truck2 level4) 3) 
    (= (loaded goods10 truck4 level0) 1) 
    (= (loaded goods5 truck7 level6) 4) 
    (= (loaded goods4 truck6 level1) 4) 
    (= (at truck3 market3) 2) 
    (= (ready-to-load goods1 market6 level0) 2) 
    (= (loaded goods1 truck4 level0) 4) 
    (= (ready-to-load goods10 market2 level0) 5) 
    (= (loaded goods8 truck1 level5) 1) 
    (= (at truck3 market1) 2) 
    (= (loaded goods9 truck3 level1) 3) 
    (= (loaded goods14 truck2 level2) 5) 
    (= (loaded goods2 truck3 level3) 4) 
    (= (loaded goods1 truck4 level4) 3) 
    (= (loaded goods5 truck7 level0) 4) 
    (= (stored goods11 level0) 2) 
    (= (loaded goods1 truck7 level2) 5) 
    (= (loaded goods5 truck3 level5) 5) 
    (= (ready-to-load goods5 market7 level3) 3) 
    (= (on-sale goods13 market4 level2) 4) 
    (= (loaded goods14 truck6 level6) 2) 
    (= (ready-to-load goods2 market5 level0) 5) 
    (= (on-sale goods10 market5 level0) 1) 
    (= (on-sale goods2 market4 level0) 1) 
    (= (on-sale goods3 market4 level0) 1) 
    (= (loaded goods8 truck4 level1) 1) 
    (= (loaded goods13 truck3 level1) 5) 
    (= (ready-to-load goods14 market2 level6) 3) 
    (= (loaded goods3 truck5 level3) 1) 
    (= (loaded goods14 truck5 level0) 5) 
    (= (loaded goods10 truck4 level5) 2) 
    (= (ready-to-load goods3 market1 level6) 5) 
    (= (loaded goods7 truck1 level4) 5) 
    (= (stored goods3 level1) 1) 
    (= (loaded goods17 truck7 level2) 3) 
    (= (loaded goods7 truck7 level6) 5) 
    (= (loaded goods9 truck4 level2) 2) 
    (= (loaded goods7 truck2 level3) 3) 
    (= (loaded goods4 truck7 level4) 4) 
    (= (on-sale goods8 market1 level0) 3) 
    (= (ready-to-load goods13 market5 level0) 2) 
    (= (ready-to-load goods11 market2 level5) 4) 
    (= (loaded goods10 truck4 level1) 5) 
    (= (loaded goods13 truck2 level3) 2) 
    (= (on-sale goods8 market7 level0) 4) 
    (= (at truck3 market2) 1) 
    (= (loaded goods11 truck5 level2) 2) 
    (= (loaded goods16 truck3 level1) 3) 
    (= (stored goods10 level0) 5) 
    (= (loaded goods7 truck3 level5) 1) 
    (= (on-sale goods14 market2 level1) 4) 
    (= (ready-to-load goods14 market4 level3) 4) 
    (= (on-sale goods7 market2 level0) 1) 
    (= (at truck3 market4) 2) 
    (= (ready-to-load goods14 market6 level1) 2) 
    (= (ready-to-load goods5 market7 level2) 4) 
    (= (loaded goods4 truck2 level4) 3) 
    (= (on-sale goods17 market7 level0) 1) 
    (= (ready-to-load goods9 market5 level2) 5) 
    (= (ready-to-load goods7 market6 level3) 1) 
    (= (ready-to-load goods12 market7 level0) 5) 
    (= (ready-to-load goods4 market6 level4) 3) 
    (= (on-sale goods12 market6 level0) 3) 
    (= (loaded goods16 truck2 level5) 4) 
    (= (loaded goods14 truck1 level3) 1) 
    (= (ready-to-load goods2 market3 level2) 5) 
    (= (loaded goods3 truck3 level0) 4) 
    (= (ready-to-load goods14 market6 level3) 2) 
    (= (stored goods2 level5) 4) 
    (= (ready-to-load goods15 market3 level4) 3) 
    (= (ready-to-load goods10 market7 level0) 4) 
    (= (loaded goods14 truck1 level1) 5) 
    (= (ready-to-load goods7 market5 level0) 2) 
    (= (loaded goods9 truck1 level5) 2) 
    (= (loaded goods10 truck5 level6) 5) 
 )
 (:bound 210)
 )
