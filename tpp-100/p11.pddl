...
(:init
 ...
 (:utility 
    ...
    (= (on-sale goods4 market3 level0) 1) 
    (= (on-sale goods3 market1 level0) 2) 
    (= (ready-to-load goods3 market1 level2) 1) 
    (= (at truck2 market1) 4) 
    (= (on-sale goods4 market1 level0) 3) 
    (= (on-sale goods3 market1 level1) 5) 
    (= (ready-to-load goods2 market3 level0) 3) 
    (= (stored goods2 level0) 2) 
    (= (loaded goods2 truck3 level2) 4) 
 )
 (:bound 77)
 )
