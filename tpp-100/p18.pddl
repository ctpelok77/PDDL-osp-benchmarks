...
(:init
 ...
 (:utility 
    ...
    (= (ready-to-load goods3 market5 level0) 5) 
    (= (stored goods9 level0) 3) 
    (= (on-sale goods4 market2 level0) 1) 
    (= (loaded goods5 truck1 level1) 3) 
    (= (at truck3 market3) 4) 
    (= (loaded goods12 truck1 level2) 4) 
    (= (ready-to-load goods13 market1 level1) 2) 
    (= (on-sale goods9 market4 level2) 4) 
    (= (ready-to-load goods13 market3 level2) 2) 
    (= (ready-to-load goods12 market2 level3) 5) 
    (= (ready-to-load goods10 market3 level4) 2) 
    (= (loaded goods12 truck3 level1) 1) 
    (= (stored goods8 level0) 5) 
    (= (loaded goods2 truck3 level0) 4) 
    (= (loaded goods4 truck1 level2) 5) 
    (= (ready-to-load goods9 market4 level2) 2) 
    (= (loaded goods2 truck4 level1) 4) 
    (= (at truck4 depot2) 5) 
    (= (stored goods6 level4) 5) 
    (= (loaded goods10 truck3 level4) 4) 
    (= (on-sale goods8 market1 level0) 2) 
    (= (stored goods12 level4) 1) 
    (= (on-sale goods7 market1 level0) 3) 
    (= (loaded goods10 truck2 level1) 2) 
    (= (on-sale goods10 market1 level2) 1) 
    (= (ready-to-load goods6 market3 level2) 5) 
    (= (ready-to-load goods1 market4 level1) 1) 
    (= (stored goods10 level2) 3) 
    (= (loaded goods9 truck5 level4) 1) 
    (= (loaded goods1 truck3 level1) 4) 
    (= (loaded goods12 truck5 level1) 2) 
    (= (loaded goods5 truck4 level4) 3) 
    (= (loaded goods10 truck5 level4) 1) 
    (= (ready-to-load goods3 market2 level3) 4) 
    (= (ready-to-load goods2 market3 level0) 5) 
    (= (at truck1 market3) 3) 
 )
 (:bound 94)
 )
