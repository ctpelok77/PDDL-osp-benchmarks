...
(:init
 ...
 (:utility 
    ...
    (= (at-segment airplane_dfboy seg_n4_n5_4_0_85) 1) 
    (= (not_blocked seg_rwy_0_1300 airplane_cfbeg) 3) 
    (= (not_blocked seg_c5_c_a02_0_100 airplane_cfbeg) 4) 
    (= (not_blocked seg_n2_n3_2_0_86 airplane_cfbeg) 4) 
    (= (not_blocked seg_n_c_0_100 airplane_dfboy) 3) 
    (= (not_occupied seg_09help_0_100) 2) 
    (= (occupied seg_rwy_0_1300) 1) 
    (= (occupied seg_b02_0_100) 2) 
    (= (not_blocked seg_c5_c6_0_50 airplane_cfbeg) 5) 
    (= (not_blocked seg_c5_c6_0_50 airplane_dfboy) 3) 
    (= (not_blocked seg_b02_0_100 airplane_cfbeg) 4) 
    (= (not_blocked seg_c5_c_a02_0_100 airplane_dfboy) 1) 
    (= (not_occupied seg_n4_n5_1_0_85) 5) 
    (= (not_blocked seg_27help_0_100 airplane_cfbeg) 2) 
    (= (at-segment airplane_cfbeg seg_c5_c6_0_50) 5) 
 )
 (:bound 20)
 )
