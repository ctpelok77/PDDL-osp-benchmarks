...
(:init
 ...
 (:utility 
    ...
    (= (blocked seg_n4_n5_0_86 airplane_cfbeg) 4) 
    (= (blocked seg_n5_n6_0_100 airplane_cfbeg) 3) 
    (= (not_occupied seg_n4_n5_3_0_86) 1) 
    (= (not_blocked seg_09help_0_100 airplane_cfbeg) 5) 
    (= (not_occupied seg_c_c2_0_84) 2) 
    (= (at-segment airplane_cfbeg seg_n2_n3_3_0_86) 3) 
    (= (occupied seg_n4_n5_3_0_86) 1) 
    (= (occupied seg_rwy_0_1300) 4) 
    (= (not_occupied seg_n2_n3_6_0_86) 2) 
 )
 (:bound 10)
 )
