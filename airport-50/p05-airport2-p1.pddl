...
(:init
 ...
 (:utility 
    ...
    (= (blocked seg_c5_c_a02_0_100 airplane_daewh) 1) 
    (= (not_occupied seg_c5_c_b02_0_100) 3) 
    (= (not_blocked seg_n2_n3_0_85 airplane_daewh) 3) 
    (= (not_occupied seg_n6_b_0_100) 5) 
    (= (not_occupied seg_n4_n5_4_0_85) 5) 
    (= (blocked seg_c5_c6_0_50 airplane_daewh) 4) 
    (= (blocked seg_n1_a_0_100 airplane_daewh) 2) 
    (= (blocked seg_c_c2_1_0_83 airplane_daewh) 1) 
    (= (at-segment airplane_daewh seg_n2_n3_3_0_86) 4) 
 )
 (:bound 10)
 )
