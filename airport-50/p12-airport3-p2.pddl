...
(:init
 ...
 (:utility 
    ...
    (= (at-segment airplane_cfbeg seg_n2_n3_0_85) 3) 
    (= (not_blocked seg_09thresh_0_100 airplane_cfbeg) 5) 
    (= (not_blocked seg_09help_0_100 airplane_cfbeg) 4) 
    (= (at-segment airplane_cfbeg seg_rwy_0_1300) 3) 
    (= (at-segment airplane_cfbeg seg_09_0_150) 1) 
    (= (occupied seg_n2_n3_4_0_85) 2) 
    (= (at-segment airplane_dfboy seg_n_n4_0_100) 3) 
    (= (blocked seg_09_0_150 airplane_dfboy) 4) 
    (= (not_blocked seg_n2_n3_0_85 airplane_cfbeg) 1) 
    (= (not_occupied seg_c2_c3_0_100) 2) 
    (= (blocked seg_n4_n5_3_0_86 airplane_dfboy) 4) 
    (= (not_blocked seg_n4_n5_3_0_86 airplane_cfbeg) 5) 
    (= (blocked seg_n_n4_0_100 airplane_cfbeg) 5) 
    (= (not_blocked seg_c6_c7_0_100 airplane_dfboy) 5) 
    (= (at-segment airplane_cfbeg seg_n2_n3_2_0_86) 1) 
    (= (blocked seg_09help_0_100 airplane_dfboy) 1) 
    (= (blocked seg_c5_c6_0_50 airplane_dfboy) 3) 
 )
 (:bound 19)
 )
