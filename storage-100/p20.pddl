...
(:init
 ...
 (:utility 
    ...
    (= (at hoist1 depot1-2-2) 3) 
    (= (clear container-0-3) 3) 
    (= (clear container-1-0) 2) 
    (= (at hoist2 depot1-1-3) 2) 
    (= (on crate9 depot1-2-2) 2) 
    (= (at hoist1 depot2-2-4) 5) 
    (= (on crate8 depot0-2-2) 5) 
    (= (at hoist0 container-1-1) 4) 
    (= (on crate1 container-1-2) 4) 
    (= (on crate6 depot2-1-3) 4) 
    (= (on crate7 depot2-1-4) 5) 
    (= (on crate1 depot1-1-1) 3) 
    (= (in crate8 depot1) 3) 
    (= (clear depot0-1-2) 4) 
    (= (in depot0-2-2 depot0) 5) 
    (= (in crate7 container0) 2) 
    (= (on crate4 depot1-1-3) 5) 
    (= (at hoist0 container-1-0) 5) 
    (= (on crate4 depot0-1-3) 3) 
    (= (in crate9 container1) 1) 
    (= (clear depot2-1-3) 4) 
    (= (on crate6 depot2-1-2) 3) 
    (= (clear depot1-2-3) 1) 
