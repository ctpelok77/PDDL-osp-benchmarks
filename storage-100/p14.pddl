...
(:init
 ...
 (:utility 
    ...
    (= (in crate3 depot1) 10) 
    (= (in crate4 depot1) 10) 
    (= (on crate4 depot1-2-3) 5) 
    (= (in depot0-1-3 depot0) 2) 
    (= (lifting hoist0 crate0) 3) 
    (= (in crate2 depot1) 5) 
    (= (in crate3 container0) 3) 
    (= (at hoist0 depot1-1-3) 1) 
    (= (in container-0-3 container0) 4) 
    (= (at hoist1 depot0-2-1) 2) 
 )
 (:bound 19)
 )
