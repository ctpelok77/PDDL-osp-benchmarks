...
(:init
 ...
 (:utility 
    ...
    (= (at hoist0 depot4-2-3) 4) 
    (= (on crate8 depot2-2-2) 2) 
    (= (at hoist0 depot4-3-2) 4) 
    (= (at hoist4 depot3-2-1) 2) 
    (= (at hoist2 container-0-3) 3) 
    (= (at hoist3 container-2-2) 2) 
    (= (on crate15 container-1-3) 4) 
    (= (on crate3 container-0-1) 5) 
    (= (on crate3 depot2-1-4) 4) 
    (= (in depot4-2-1 depot4) 5) 
    (= (on crate4 depot2-2-1) 3) 
    (= (at hoist4 container-1-1) 1) 
    (= (on crate18 depot1-2-1) 3) 
    (= (on crate4 depot1-1-4) 3) 
    (= (on crate17 container-3-3) 5) 
    (= (on crate2 depot1-1-3) 4) 
    (= (on crate6 depot3-1-2) 3) 
    (= (at hoist3 depot3-2-2) 4) 
    (= (on crate15 depot0-1-4) 4) 
    (= (on crate16 depot3-2-1) 1) 
    (= (on crate14 container-2-2) 5) 
    (= (clear container-1-1) 4) 
    (= (at hoist1 container-0-2) 5) 
    (= (on crate14 container-3-3) 3) 
    (= (on crate6 depot2-1-4) 3) 
    (= (on crate9 depot4-2-1) 1) 
    (= (on crate2 depot4-1-3) 3) 
    (= (on crate3 depot4-3-2) 2) 
    (= (on crate7 container-2-2) 5) 
    (= (in container-2-1 container2) 5) 
    (= (available hoist2) 1) 
    (= (lifting hoist2 crate6) 1) 
    (= (on crate15 depot0-1-3) 1) 
    (= (on crate0 depot4-1-1) 5) 
    (= (on crate2 depot4-1-2) 4) 
    (= (at hoist2 container-2-3) 5) 
    (= (at hoist2 container-3-2) 1) 
    (= (lifting hoist2 crate11) 4) 
    (= (on crate3 depot4-2-2) 1) 
    (= (in crate17 container2) 2) 
    (= (on crate3 container-2-2) 3) 
    (= (on crate2 container-2-2) 1) 
    (= (on crate6 depot1-1-3) 2) 
    (= (on crate1 container-3-1) 1) 
    (= (clear container-3-3) 2) 
    (= (in crate0 container0) 2) 
    (= (at hoist1 depot3-2-2) 4) 
    (= (lifting hoist4 crate15) 5) 
    (= (on crate2 depot4-1-1) 4) 
    (= (in depot1-2-2 depot1) 2) 
    (= (in depot0-1-1 depot0) 2) 
    (= (on crate2 depot4-3-3) 1) 
    (= (on crate9 container-1-1) 5) 
    (= (on crate3 depot3-2-2) 2) 
    (= (on crate2 container-0-3) 5) 
    (= (at hoist1 container-1-3) 4) 
    (= (at hoist0 depot2-2-2) 1) 
    (= (on crate7 depot1-1-4) 3) 
    (= (on crate1 container-3-0) 5) 
    (= (on crate2 depot0-2-3) 1) 
    (= (on crate3 container-3-2) 3) 
    (= (on crate4 container-0-3) 4) 
    (= (at hoist2 depot4-1-3) 1) 
    (= (on crate16 depot4-1-2) 4) 
    (= (on crate11 container-2-2) 3) 
    (= (on crate16 container-1-0) 3) 
    (= (in crate1 depot1) 5) 
    (= (at hoist1 depot2-2-1) 1) 
    (= (on crate8 container-0-3) 5) 
    (= (on crate18 depot1-2-2) 2) 
    (= (on crate8 container-2-1) 2) 
    (= (on crate17 container-4-1) 3) 
    (= (at hoist4 depot3-1-4) 4) 
    (= (on crate17 depot3-2-3) 2) 
    (= (at hoist4 container-2-3) 1) 
    (= (on crate11 container-1-1) 4) 
    (= (at hoist0 depot3-1-4) 3) 
    (= (at hoist2 depot1-2-2) 5) 
    (= (on crate18 depot3-2-2) 5) 
    (= (lifting hoist4 crate10) 2) 
    (= (at hoist2 depot3-1-1) 3) 
    (= (at hoist4 container-0-0) 1) 
    (= (on crate12 depot0-1-1) 2) 
    (= (lifting hoist2 crate15) 2) 
    (= (on crate8 container-2-3) 3) 
    (= (in container-3-0 container3) 1) 
    (= (on crate7 depot4-3-1) 5) 
 )
 (:bound 114)
 )
