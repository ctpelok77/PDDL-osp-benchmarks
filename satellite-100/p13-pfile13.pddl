...
(:init
 ...
 (:utility 
    (= (pointing satellite1 Phenomenon5) 10) 
    (= (pointing satellite2 Planet11) 10) 
    (= (pointing satellite4 Planet11) 10) 
    ...
    (= (pointing satellite1 planet25) 2) 
    (= (have_image groundstation3 image3) 5) 
    (= (have_image phenomenon27 image3) 2) 
    (= (have_image planet6 image4) 4) 
    (= (pointing satellite2 star0) 3) 
    (= (pointing satellite1 groundstation2) 4) 
    (= (have_image planet28 image4) 4) 
    (= (pointing satellite2 phenomenon5) 3) 
    (= (have_image planet23 thermograph0) 1) 
    (= (pointing satellite3 planet8) 2) 
    (= (have_image star19 thermograph1) 5) 
    (= (pointing satellite4 planet16) 1) 
    (= (have_image star19 image4) 2) 
    (= (have_image star19 image3) 4) 
    (= (have_image groundstation3 image4) 1) 
    (= (have_image groundstation2 image4) 1) 
 )
 (:bound 58)
 )
