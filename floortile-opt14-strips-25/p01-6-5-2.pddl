(define (problem p01-652)
 ...
 (:utility 
    ...
    (= (robot-at robot1 tile_1-2) 2) 
    (= (robot-at robot2 tile_3-4) 3) 
    (= (clear tile_2-2) 2) 
    (= (painted tile_3-5 black) 1) 
    (= (robot-at robot1 tile_6-4) 5) 
    (= (robot-at robot1 tile_0-4) 4) 
    (= (robot-at robot2 tile_6-5) 4) 
 )
 (:bound 43)
 (:use-cost-metric)
 )
