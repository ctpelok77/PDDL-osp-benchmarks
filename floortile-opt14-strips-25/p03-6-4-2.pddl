(define (problem p03-642)
 ...
 (:utility 
    ...
    (= (painted tile_3-4 white) 5) 
    (= (painted tile_5-3 black) 2) 
    (= (robot-at robot2 tile_6-1) 1) 
    (= (robot-at robot2 tile_0-2) 4) 
    (= (robot-at robot2 tile_6-3) 3) 
    (= (robot-at robot2 tile_5-3) 5) 
 )
 (:bound 29)
 (:use-cost-metric)
 )
