...
(= (total-cost) 0)
 ...
 (:utility 
    ...
    (= (passenger-at p1 n1) 10) 
    (= (passenger-at p2 n9) 10) 
    (= (passenger-at p3 n0) 10) 
    (= (passenger-at p4 n1) 10) 
    (= (passenger-at p5 n6) 10) 
    (= (passenger-at p6 n10) 10) 
    (= (passenger-at p6 n4) 3) 
    (= (lift-at slow1-0 n7) 4) 
    (= (lift-at slow0-0 n3) 4) 
    (= (boarded p5 slow0-0) 2) 
    (= (lift-at fast1 n3) 3) 
    (= (passenger-at p1 n5) 2) 
    (= (passenger-at p4 n3) 5) 
 )
 (:bound 131)
 (:use-cost-metric)
 )
