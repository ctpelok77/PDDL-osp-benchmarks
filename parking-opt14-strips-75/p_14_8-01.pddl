(define   (problem parking)
 ...
 (:utility 
    ...
    (= (behind-car car_11 car_13) 5) 
    (= (at-curb-num car_02 curb_3) 1) 
    (= (car-clear car_10) 3) 
    (= (at-curb-num car_13 curb_7) 4) 
    (= (at-curb-num car_05 curb_2) 3) 
    (= (at-curb-num car_00 curb_4) 1) 
    (= (behind-car car_07 car_02) 1) 
    (= (at-curb-num car_02 curb_7) 4) 
    (= (at-curb-num car_03 curb_6) 2) 
    (= (at-curb-num car_08 curb_3) 5) 
    (= (at-curb car_04) 2) 
    (= (at-curb-num car_07 curb_2) 2) 
    (= (at-curb car_08) 4) 
    (= (behind-car car_13 car_04) 5) 
    (= (behind-car car_03 car_05) 3) 
    (= (behind-car car_04 car_10) 5) 
 )
 (:bound 17)
 (:use-cost-metric)
 )
