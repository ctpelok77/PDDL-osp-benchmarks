(define   (problem parking)
 ...
 (:utility 
    ...
    (= (behind-car car_09 car_03) 5) 
    (= (behind-car car_10 car_02) 2) 
    (= (behind-car car_01 car_05) 4) 
    (= (behind-car car_17 car_13) 5) 
    (= (at-curb-num car_01 curb_4) 2) 
    (= (at-curb-num car_06 curb_4) 3) 
    (= (behind-car car_09 car_07) 2) 
    (= (behind-car car_14 car_05) 1) 
    (= (at-curb-num car_11 curb_8) 3) 
    (= (at-curb-num car_12 curb_1) 5) 
    (= (behind-car car_15 car_15) 1) 
    (= (behind-car car_13 car_11) 5) 
    (= (behind-car car_04 car_10) 1) 
    (= (behind-car car_00 car_01) 2) 
    (= (behind-car car_09 car_10) 5) 
    (= (at-curb-num car_00 curb_2) 1) 
    (= (at-curb-num car_17 curb_4) 4) 
    (= (car-clear car_04) 3) 
    (= (at-curb-num car_03 curb_9) 5) 
    (= (behind-car car_07 car_04) 1) 
    (= (behind-car car_06 car_00) 4) 
    (= (at-curb-num car_14 curb_6) 1) 
    (= (behind-car car_08 car_12) 4) 
    (= (at-curb-num car_12 curb_6) 3) 
    (= (curb-clear curb_9) 2) 
    (= (behind-car car_15 car_12) 4) 
 )
 (:bound 21)
 (:use-cost-metric)
 )
