...
(:init
 ...
 (:utility 
    ...
    (= (hasimage sheet9 front image-1b) 2) 
    (= (hasimage sheet8 back image-2) 3) 
    (= (hasimage sheet3 front image-8) 2) 
    (= (hasimage sheet3 front image-5) 2) 
    (= (location sheet7 lime_entry-lc1_exittoime) 4) 
    (= (available lime-rsrc) 1) 
    (= (notprintedwith sheet1 back black) 4) 
    (= (location sheet4 fe1_exit-hw1_leftentry) 5) 
    (= (notprintedwith sheet4 front color) 1) 
    (= (hasimage sheet1 back image-7) 4) 
    (= (hasimage sheet5 front image-8) 3) 
    (= (hasimage sheet5 back image-1) 1) 
    (= (location sheet8 hw1_rightexit-sys_entry) 4) 
    (= (hasimage sheet7 back image-1b) 5) 
    (= (hasimage sheet2 back image-8) 3) 
    (= (location sheet9 uime_exit-uc1_entryfromime) 1) 
    (= (location sheet2 hw1_toprightentry-uc1_exit) 2) 
    (= (location sheet2 uc1_exittoime-uime_entry) 5) 
 )
 (:bound 1782948)
 (:use-cost-metric)
 )
