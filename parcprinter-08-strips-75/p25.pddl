...
(:init
 ...
 (:utility 
    ...
    (= (sideup sheet1 front) 2) 
    (= (hasimage sheet1 back image-1) 2) 
    (= (location sheet5 hw1_toprightentry-uc1_exit) 5) 
    (= (location sheet5 some_feeder_tray) 1) 
    (= (location sheet2 uc1_entry-hw1_topleftexit) 4) 
    (= (stackedin sheet3 sys_outputtray) 3) 
    (= (notprintedwith sheet2 front black) 5) 
