(define (problem prob)
 ...
 (:utility 
    ...
    (= (contains shot3 cocktail6) 10) 
    (= (contains shot4 cocktail5) 10) 
    (= (contains shot5 cocktail7) 10) 
    (= (contains shot6 cocktail1) 10) 
    (= (contains shot7 cocktail4) 10) 
    (= (contains shot8 ingredient2) 10) 
    (= (used shot6 ingredient1) 4) 
    (= (contains shot7 cocktail7) 1) 
    (= (contains shot9 cocktail2) 5) 
    (= (holding left shot1) 3) 
    (= (contains shot8 cocktail5) 2) 
