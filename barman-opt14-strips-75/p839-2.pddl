(define (problem prob)
 ...
 (:utility 
    ...
    (= (contains shot2 cocktail8) 10) 
    (= (contains shot3 cocktail1) 10) 
    (= (contains shot4 cocktail2) 10) 
    (= (contains shot5 cocktail3) 10) 
    (= (contains shot6 cocktail5) 10) 
    (= (contains shot7 cocktail7) 10) 
    (= (contains shot8 cocktail6) 10) 
    (= (used shot2 ingredient1) 5) 
    (= (contains shot2 cocktail6) 2) 
    (= (contains shot5 ingredient1) 3) 
    (= (holding left shot2) 3) 
    (= (contains shot9 ingredient3) 5) 
    (= (empty shot4) 4) 
    (= (contains shot7 ingredient1) 2) 
    (= (contains shot5 cocktail7) 1) 
    (= (contains shot1 cocktail8) 4) 
 )
 (:bound 81)
 )
