...
(:init
 ...
 (:utility 
    ...
    (= (visited loc-x7-y5) 10) 
    (= (visited loc-x7-y6) 10) 
    (= (visited loc-x7-y7) 10) 
    (= (visited loc-x7-y8) 10) 
    (= (visited loc-x8-y1) 10) 
    (= (visited loc-x8-y2) 10) 
    (= (visited loc-x8-y3) 10) 
    (= (visited loc-x8-y6) 10) 
    (= (visited loc-x8-y8) 10) 
    (= (at-robot loc-x5-y8) 2) 
    (= (visited loc-x8-y5) 1) 
    (= (at-robot loc-x8-y4) 3) 
    (= (at-robot loc-x7-y3) 4) 
    (= (at-robot loc-x0-y3) 5) 
 )
 (:bound 15)
 )
