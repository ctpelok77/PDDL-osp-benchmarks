...
(:init
 ...
 (:utility 
    ...
    (= (not_blocked seg_a02_0_100 airplane_dfboy) 2) 
    (= (not_occupied seg_n2_n3_0_85) 4) 
    (= (blocked seg_n2_n3_4_0_85 airplane_cfbeg) 5) 
    (= (not_blocked seg_n4_n5_4_0_85 airplane_cfbeg) 3) 
    (= (blocked seg_27help_0_100 airplane_dfboy) 2) 
    (= (not_blocked seg_n_n4_0_100 airplane_dfboy) 4) 
    (= (not_blocked seg_b_27_0_100 airplane_cfbeg) 1) 
    (= (not_blocked seg_27help_0_100 airplane_cfbeg) 2) 
    (= (blocked seg_b02_0_100 airplane_daewh) 4) 
    (= (at-segment airplane_cfbeg seg_27_0_150) 5) 
    (= (blocked seg_c5_c_b02_0_100 airplane_cfbeg) 4) 
    (= (not_blocked seg_n2_n3_1_0_86 airplane_daewh) 1) 
    (= (at-segment airplane_cfbeg seg_n4_n5_3_0_86) 1) 
    (= (airborne airplane_dfboy seg_09_0_150) 3) 
    (= (not_blocked seg_n4_n5_0_86 airplane_cfbeg) 5) 
    (= (occupied seg_c6_c7_0_100) 2) 
    (= (occupied seg_c4_c5_0_50) 5) 
    (= (not_blocked seg_c_c2_1_0_83 airplane_dfboy) 3) 
    (= (blocked seg_n6_b_0_100 airplane_dfboy) 3) 
    (= (blocked seg_c5_c_a02_0_100 airplane_dfboy) 2) 
    (= (not_occupied seg_n1_a_0_100) 3) 
    (= (not_occupied seg_n2_n3_1_0_86) 1) 
 )
 (:bound 46)
 )
