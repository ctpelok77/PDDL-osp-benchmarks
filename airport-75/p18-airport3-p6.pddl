...
(:init
 ...
 (:utility 
    ...
    (= (is-parked airplane_cfbeg seg_a01_0_100) 5) 
    (= (blocked seg_c5_c_b02_0_100 airplane_dfboy) 3) 
    (= (at-segment airplane_holgi seg_n2_n3_1_0_86) 1) 
    (= (occupied seg_n4_n5_6_0_86) 3) 
    (= (not_blocked seg_c2_c3_0_100 airplane_daewh) 1) 
    (= (blocked seg_n4_n5_5_0_86 airplane_horst) 5) 
    (= (not_blocked seg_c5_c_a02_0_100 airplane_wurst) 4) 
    (= (at-segment airplane_daewh seg_rwy_0_1300) 2) 
    (= (not_occupied seg_c_c2_0_100) 4) 
    (= (blocked seg_c3_c4_0_50 airplane_dfboy) 4) 
    (= (at-segment airplane_holgi seg_n2_n3_2_0_86) 2) 
    (= (blocked seg_n2_n3_3_0_86 airplane_cfbeg) 5) 
    (= (not_blocked seg_c_c2_0_100 airplane_horst) 3) 
    (= (blocked seg_b02_0_100 airplane_daewh) 5) 
    (= (at-segment airplane_holgi seg_09_0_150) 3) 
    (= (blocked seg_09_0_150 airplane_horst) 3) 
    (= (blocked seg_n4_n5_1_0_85 airplane_horst) 5) 
    (= (not_blocked seg_rwy_0_1300 airplane_wurst) 2) 
    (= (not_blocked seg_n2_n3_6_0_86 airplane_cfbeg) 3) 
    (= (at-segment airplane_horst seg_c3_c4_0_50) 3) 
    (= (blocked seg_n2_n3_5_0_86 airplane_cfbeg) 3) 
    (= (blocked seg_b01_0_100 airplane_daewh) 1) 
    (= (blocked seg_n2_n3_0_85 airplane_horst) 1) 
    (= (not_blocked seg_a01_0_100 airplane_horst) 5) 
    (= (blocked seg_n2_n3_6_0_86 airplane_cfbeg) 1) 
    (= (blocked seg_c_c2_0_100 airplane_daewh) 5) 
    (= (at-segment airplane_wurst seg_a01_0_100) 2) 
    (= (at-segment airplane_cfbeg seg_09_0_150) 1) 
    (= (not_blocked seg_n2_n3_3_0_86 airplane_holgi) 5) 
    (= (blocked seg_n2_n3_4_0_85 airplane_wurst) 3) 
    (= (blocked seg_n2_n3_2_0_86 airplane_dfboy) 2) 
    (= (not_blocked seg_c3_c_a01_0_100 airplane_holgi) 1) 
    (= (at-segment airplane_cfbeg seg_b02_0_100) 1) 
    (= (is-pushing airplane_wurst) 4) 
    (= (at-segment airplane_cfbeg seg_n4_n5_5_0_86) 2) 
    (= (blocked seg_27help_0_100 airplane_cfbeg) 4) 
    (= (not_blocked seg_n2_n3_1_0_86 airplane_holgi) 2) 
    (= (blocked seg_a_09_0_100 airplane_dfboy) 1) 
    (= (blocked seg_c3_c_b01_0_100 airplane_holgi) 4) 
    (= (blocked seg_n4_n5_3_0_86 airplane_dfboy) 4) 
    (= (blocked seg_a02_0_100 airplane_daewh) 4) 
    (= (not_blocked seg_c3_c4_0_50 airplane_cfbeg) 2) 
    (= (occupied seg_n6_b_0_100) 5) 
    (= (at-segment airplane_daewh seg_n2_n3_5_0_86) 4) 
 )
 (:bound 80)
 )
