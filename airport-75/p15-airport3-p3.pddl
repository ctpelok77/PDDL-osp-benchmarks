...
(:init
 ...
 (:utility 
    ...
    (= (blocked seg_a_09_0_100 airplane_dfboy) 5) 
    (= (not_blocked seg_n_n4_0_100 airplane_dfboy) 4) 
    (= (not_blocked seg_09thresh_0_100 airplane_wurst) 3) 
    (= (blocked seg_n_n4_0_100 airplane_cfbeg) 4) 
    (= (at-segment airplane_cfbeg seg_rwy_0_1300) 1) 
    (= (at-segment airplane_dfboy seg_n4_n5_6_0_86) 3) 
    (= (at-segment airplane_wurst seg_n1_a_0_100) 2) 
    (= (not_blocked seg_27help_0_100 airplane_dfboy) 1) 
    (= (not_blocked seg_n5_n6_0_100 airplane_cfbeg) 1) 
    (= (at-segment airplane_wurst seg_c3_c_a01_0_100) 3) 
    (= (blocked seg_09help_0_100 airplane_dfboy) 1) 
    (= (at-segment airplane_wurst seg_c5_c_a02_0_100) 2) 
    (= (blocked seg_n2_n3_6_0_86 airplane_cfbeg) 5) 
    (= (not_blocked seg_n5_n6_0_100 airplane_dfboy) 4) 
    (= (blocked seg_n2_n3_1_0_86 airplane_wurst) 4) 
    (= (blocked seg_a02_0_100 airplane_cfbeg) 2) 
    (= (not_blocked seg_n2_n3_5_0_86 airplane_dfboy) 5) 
    (= (airborne airplane_wurst seg_09_0_150) 5) 
    (= (at-segment airplane_wurst seg_27_0_150) 4) 
    (= (airborne airplane_cfbeg seg_09_0_150) 2) 
    (= (at-segment airplane_wurst seg_c5_c6_0_50) 5) 
    (= (blocked seg_n6_b_0_100 airplane_cfbeg) 3) 
    (= (not_blocked seg_n4_n5_1_0_85 airplane_cfbeg) 3) 
    (= (not_blocked seg_c3_c_b01_0_100 airplane_wurst) 1) 
 )
 (:bound 43)
 )
