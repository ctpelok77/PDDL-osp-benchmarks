...
(:objects
	...
	;; HDAC1-pRb-E2F4-DP12 - complex ;; DUPLICATE
	...
	;; pRbp2-Jun-c-Fos - complex ;; DUPLICATE
	c-Fos - complex
	pRbp2-Jun - complex
...
(:init
 ...
 (:utility 
    ...
    (= (goal25) 10) 
    (= (goal26) 10) 
    (= (available p27p1-cdk2p2-cycep1) 5) 
    (= (available prbp1-e2f13-dp12p1) 5) 
    (= (available hdac1-p130-e2f5-dp12-ge2) 1) 
    (= (available mdm2-e2f13p1-dp12p1) 1) 
    (= (available dmp1) 4) 
    (= (available prbp1p2-jun-c-fos-gercc1) 3) 
    (= (available hdac1-p130-e2f4-dp12) 3) 
    (= (available e2f6-dp12p1) 4) 
    (= (available pcna-p21-cdk46-cycd) 3) 
    (= (chosen sp1) 5) 
    (= (available p21-cdk2p2-cyca) 4) 
    (= (available p21-cdk2-cyce) 2) 
    (= (available p21-cdk2p2-cyce) 4) 
    (= (available p57p1-cdk46-cycd) 1) 
    (= (num-subs l20) 2) 
    (= (available prb-e2f13p1-dp12p1) 1) 
    (= (available dp12p1) 3) 
    (= (available hdac1-prb-e2f13p1-dp12p1) 4) 
    (= (available p57-cdk46p1p2-cycdp1) 2) 
    (= (available e2f13) 5) 
    (= (available p27p1-cdk2p1-cyce) 3) 
    (= (available hdac1-p130-e2f5p1-dp12) 1) 
    (= (available prbp1-jun) 2) 
 )
 (:bound 194)
 )
