...
(:init
 ...
 (:utility 
    ...
    (= (goal30) 10) 
    (= (goal31) 10) 
    (= (available pcna-p21-cdk2p1-cycep1) 3) 
    (= (available raf1-prb-e2f13p1-dp12p1) 5) 
    (= (chosen prbp1-e2f4p1-dp12) 4) 
    (= (available p27-cdk2p1-cyce) 2) 
    (= (available dmp1-cycdp1) 1) 
    (= (available mdm2-e2f13p1-dp12p1) 4) 
    (= (chosen pcna) 1) 
    (= (available prbp1p2) 4) 
    (= (chosen p300) 1) 
    (= (available pcna-p21-cdk46p2-cycd) 5) 
    (= (chosen e2f5-dp12p1) 4) 
    (= (chosen hbp1) 3) 
    (= (num-subs l20) 5) 
    (= (available skp2-skp1-cdk2p2-cyca) 5) 
    (= (available prb-ap2) 1) 
    (= (available e2f13p1) 3) 
    (= (available p27p1-cdk2p1-cyce) 2) 
    (= (available p53p1-dp12) 5) 
    (= (num-subs l9) 3) 
    (= (available p130-e2f5-dp12p1) 3) 
    (= (chosen dp12) 2) 
    (= (available prbp2-ap2-ge-c) 2) 
    (= (available cdk2) 2) 
 )
 (:bound 222)
 )
