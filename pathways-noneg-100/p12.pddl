...
(:init
 ...
 (:utility 
    ...
    (= (goal16) 10) 
    (= (chosen p68) 1) 
    (= (available prbp1p2-ap2-ge-c) 2) 
    (= (available skp2-skp1) 4) 
    (= (available ap2) 2) 
    (= (available wee1p1) 1) 
    (= (available skp2p1) 5) 
    (= (chosen cycb) 3) 
    (= (available cdk1p1-cks1) 3) 
    (= (available skp2-skp1-cdk2-cyca) 4) 
    (= (available gcdc25a) 4) 
    (= (available skp2-cdk2p1p2-cyca) 5) 
    (= (available p27-cdk2p1p2-cycep1) 5) 
    (= (available c-myc-max) 3) 
 )
 (:bound 111)
 )
