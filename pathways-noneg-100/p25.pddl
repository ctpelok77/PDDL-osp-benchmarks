...
(:init
 ...
 (:utility 
    ...
    (= (available pcna-p21-cdk46p1-cycd) 5) 
    (= (available cdk1p3-cks1) 3) 
    (= (available wee1) 1) 
    (= (available pcna-p21-cdk2p2-cycep1) 4) 
    (= (chosen pcna) 2) 
    (= (available p21-cdk46-cycd) 1) 
    (= (available cych) 2) 
    (= (available pcna-p21-cdk2p1-cyce) 3) 
    (= (available ap2) 1) 
    (= (chosen p53) 1) 
    (= (chosen hdac1-prbp1-e2f4-dp12) 5) 
    (= (available ecadherin) 4) 
    (= (num-subs l22) 3) 
    (= (available e2f13p1) 3) 
    (= (available cdk2p2-cyce) 4) 
    (= (available p53p1-dp12p1) 2) 
    (= (available p57p1-cdk46p1-cycdp1) 4) 
    (= (available ge2) 5) 
    (= (chosen hdac1-p130-e2f4p1-dp12) 5) 
    (= (available p57p1-cdk46p1p2-cycdp1) 3) 
    (= (available m1433-cdc25cp2) 1) 
    (= (available cks1) 4) 
 )
 (:bound 205)
 )
