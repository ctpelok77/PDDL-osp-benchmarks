...
(:init
 ...
 (:utility 
    ...
    (= (goal20) 10) 
    (= (goal21) 10) 
    (= (available p27-cdk46p1-cycdp1) 1) 
    (= (available raf1-prb-e2f13p1-dp12p1) 2) 
    (= (chosen e2f6) 5) 
    (= (available p27-cdk46p1p2-cycd) 2) 
    (= (available cdk2p1p2-cyca) 4) 
    (= (available p21-cdk46p1-cycdp1) 4) 
    (= (available p27p1-cdk46p1-cycdp1) 3) 
    (= (available hdac1-p130-e2f4p1-dp12) 5) 
    (= (available p53-dp12) 1) 
    (= (chosen sp1) 2) 
    (= (available prbp1-jun-c-fos) 1) 
    (= (available raf1-prbp1-e2f13-dp12p1-ge2) 5) 
    (= (available cycdp1) 2) 
    (= (available cdc25cp2) 3) 
    (= (available p21-cdk2-cyca) 3) 
    (= (available c-tak1) 3) 
    (= (num-subs l14) 1) 
    (= (available hdac1-prb-e2f4p1-dp12) 1) 
    (= (available cycep1) 5) 
    (= (available p21-cdk2p1p2-cyce) 4) 
    (= (available p16-cdk46p1p2) 5) 
    (= (available p53p1) 2) 
 )
 (:bound 152)
 )
