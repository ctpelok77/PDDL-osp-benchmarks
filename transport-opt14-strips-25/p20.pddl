...
(define (problem transport-three-cities-sequential-20nodes-1000size-4degree-100mindistance-3trucks-7packages-2014seed)
 ...
 (:utility 
    ...
    (= (at package-5 city-2-loc-14) 1) 
    (= (at package-6 city-2-loc-19) 2) 
    (= (at package-6 city-1-loc-5) 3) 
    (= (at package-4 city-2-loc-8) 3) 
    (= (at truck-1 city-3-loc-14) 4) 
    (= (at truck-1 city-1-loc-10) 2) 
    (= (in package-6 truck-3) 1) 
    (= (at package-4 city-2-loc-2) 5) 
    (= (at package-7 city-3-loc-14) 2) 
    (= (at truck-3 city-3-loc-9) 3) 
    (= (at package-4 city-1-loc-18) 1) 
    (= (at package-6 city-2-loc-9) 4) 
    (= (at package-7 city-1-loc-16) 3) 
    (= (at package-5 city-3-loc-4) 1) 
    (= (at truck-1 city-2-loc-18) 4) 
    (= (capacity truck-2 capacity-4) 1) 
    (= (at package-4 city-1-loc-11) 3) 
    (= (at package-1 city-1-loc-8) 5) 
    (= (at package-1 city-2-loc-4) 5) 
    (= (capacity truck-3 capacity-1) 5) 
    (= (at package-3 city-2-loc-17) 5) 
    (= (at package-2 city-3-loc-18) 2) 
    (= (at package-4 city-1-loc-19) 1) 
    (= (at package-7 city-2-loc-18) 2) 
    (= (at package-7 city-1-loc-2) 3) 
    (= (at package-4 city-2-loc-12) 1) 
    (= (at truck-3 city-2-loc-3) 5) 
    (= (at truck-1 city-1-loc-4) 4) 
    (= (in package-5 truck-3) 2) 
    (= (at package-4 city-3-loc-14) 2) 
    (= (at package-1 city-1-loc-9) 4) 
 )
 (:bound 534)
 (:use-cost-metric)
 )
