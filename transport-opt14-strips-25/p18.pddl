...
(define (problem transport-three-cities-sequential-20nodes-1000size-4degree-100mindistance-3trucks-6packages-2014seed)
 ...
 (:utility 
    (= (at package-1 city-1-loc-11) 10) 
    (= (at package-2 city-2-loc-5) 10) 
    (= (at package-3 city-2-loc-17) 10) 
    (= (at package-4 city-1-loc-9) 10) 
    (= (at package-5 city-1-loc-12) 10) 
    (= (at package-6 city-1-loc-5) 10) 
    (= (at truck-1 city-2-loc-6) 2) 
    (= (at package-2 city-2-loc-11) 1) 
    (= (at package-4 city-2-loc-8) 5) 
    (= (at truck-3 city-2-loc-19) 2) 
    (= (at package-5 city-3-loc-20) 3) 
    (= (at truck-2 city-3-loc-11) 3) 
    (= (at package-4 city-1-loc-18) 1) 
    (= (at package-3 city-3-loc-2) 1) 
    (= (at truck-3 city-3-loc-15) 1) 
    (= (at package-6 city-2-loc-16) 2) 
    (= (at package-6 city-3-loc-7) 4) 
    (= (at truck-2 city-1-loc-8) 3) 
    (= (at package-5 city-2-loc-1) 4) 
    (= (at package-2 city-1-loc-14) 4) 
    (= (at truck-2 city-2-loc-11) 5) 
    (= (at package-1 city-1-loc-13) 5) 
    (= (at package-2 city-1-loc-5) 4) 
    (= (at package-3 city-1-loc-4) 4) 
    (= (at package-6 city-1-loc-2) 4) 
    (= (at truck-3 city-1-loc-4) 5) 
    (= (at package-2 city-3-loc-20) 3) 
    (= (at truck-1 city-3-loc-5) 2) 
    (= (at package-4 city-3-loc-13) 1) 
    (= (at truck-2 city-1-loc-14) 1) 
    (= (at package-1 city-2-loc-1) 3) 
    (= (at package-2 city-3-loc-9) 5) 
    (= (at package-4 city-3-loc-16) 3) 
    (= (at package-3 city-1-loc-2) 5) 
 )
 (:bound 432)
 (:use-cost-metric)
 )
