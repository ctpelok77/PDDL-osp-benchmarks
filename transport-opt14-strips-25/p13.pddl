...
(define (problem transport-three-cities-sequential-5nodes-1000size-2degree-100mindistance-2trucks-4packages-2014seed)
 ...
 (:utility 
    ...
    (= (at package-2 city-1-loc-3) 10) 
    (= (at package-3 city-3-loc-3) 10) 
    (= (at package-4 city-1-loc-2) 10) 
    (= (at package-1 city-3-loc-5) 3) 
    (= (at truck-2 city-3-loc-5) 2) 
    (= (at package-3 city-3-loc-1) 5) 
    (= (at package-2 city-2-loc-1) 4) 
    (= (at package-2 city-3-loc-4) 1) 
 )
 (:bound 148)
 (:use-cost-metric)
 )
