...
(define (problem transport-two-cities-sequential-20nodes-1000size-4degree-100mindistance-3trucks-6packages-2014seed)
 ...
 (:utility 
    ...
    (= (at package-2 city-2-loc-10) 10) 
    (= (at package-3 city-2-loc-9) 10) 
    (= (at package-4 city-2-loc-12) 10) 
    (= (at package-5 city-2-loc-3) 10) 
    (= (at package-6 city-2-loc-14) 10) 
    (= (at package-6 city-1-loc-7) 2) 
    (= (at package-1 city-1-loc-13) 1) 
    (= (at package-2 city-1-loc-20) 1) 
    (= (at truck-3 city-1-loc-18) 2) 
    (= (at truck-2 city-2-loc-7) 5) 
    (= (at truck-3 city-2-loc-4) 3) 
    (= (at package-1 city-1-loc-14) 5) 
    (= (at truck-1 city-1-loc-11) 4) 
    (= (at package-4 city-2-loc-17) 5) 
    (= (at package-3 city-1-loc-10) 3) 
    (= (at package-1 city-2-loc-18) 1) 
    (= (at truck-1 city-2-loc-13) 4) 
    (= (at package-1 city-1-loc-7) 2) 
    (= (at package-1 city-1-loc-6) 4) 
    (= (at package-1 city-2-loc-4) 1) 
    (= (at package-5 city-1-loc-5) 4) 
    (= (at package-5 city-1-loc-3) 2) 
    (= (at package-6 city-2-loc-12) 3) 
    (= (at package-1 city-1-loc-11) 5) 
 )
 (:bound 704)
 (:use-cost-metric)
 )
