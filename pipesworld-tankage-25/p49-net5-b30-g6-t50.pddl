...
(define (problem p49-net5-b30-g6_rt0_instance)
 ...
 (:utility 
    ...
    (= (normal S15) 10) 
    (= (follow b20 b19) 5) 
    (= (occupied ta5-2-lco) 5) 
    (= (last b19 s34) 3) 
    (= (follow b17 b5) 5) 
    (= (follow b25 b5) 2) 
    (= (not-occupied ta1-2-oca1) 4) 
    (= (follow b1 b10) 3) 
    (= (occupied ta4-3-rat-a) 4) 
    (= (follow b5 b16) 1) 
    (= (on b27 a5) 2) 
    (= (follow b9 b7) 5) 
    (= (follow b23 b17) 2) 
    ...
    (= (follow b19 b27) 5) 
    (= (follow b27 b21) 3) 
    (= (occupied ta1-2-lco) 2) 
    (= (follow b7 b9) 2) 
    (= (follow b25 b22) 1) 
    (= (occupied ta1-2-oca1) 5) 
    (= (follow b7 b21) 1) 
    (= (follow b27 b8) 4) 
    (= (on b3 a1) 2) 
    (= (follow b8 b27) 5) 
