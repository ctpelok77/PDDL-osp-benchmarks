(define (problem scanalyzer3d-44)
 ...
 (:utility 
    ...
    (= (on car-in-7 seg-out-1) 4) 
    (= (on car-in-6 seg-out-8) 2) 
    (= (on car-in-9 seg-in-6) 2) 
    (= (on car-out-1 seg-in-5) 5) 
    (= (on car-in-1 seg-out-7) 3) 
    (= (on car-out-4 seg-out-7) 3) 
    (= (on car-out-4 seg-in-6) 1) 
    (= (on car-in-3 seg-in-1) 2) 
    (= (on car-in-4 seg-in-8) 3) 
    (= (on car-out-9 seg-in-8) 4) 
    (= (on car-out-8 seg-out-6) 1) 
    (= (on car-out-3 seg-out-4) 5) 
    (= (on car-out-7 seg-in-3) 4) 
    (= (on car-in-6 seg-out-5) 1) 
    (= (on car-out-8 seg-out-4) 5) 
 )
 (:bound 40)
 (:use-cost-metric)
 )
