...
(:init
 ...
 (:utility 
    ...
    (= (loaded goods5 truck3 level0) 4) 
    (= (loaded goods5 truck2 level0) 4) 
    (= (loaded goods2 truck2 level0) 1) 
    (= (ready-to-load goods3 market1 level0) 4) 
    (= (at truck1 depot1) 1) 
    (= (loaded goods5 truck1 level1) 2) 
    (= (loaded goods4 truck3 level1) 2) 
    (= (loaded goods4 truck3 level0) 5) 
    (= (at truck2 market2) 1) 
    (= (on-sale goods3 market2 level0) 5) 
    (= (ready-to-load goods6 market1 level0) 2) 
 )
 (:bound 31)
 )
