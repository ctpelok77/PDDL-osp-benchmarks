...
(:init
 ...
 (:utility 
    ...
    (= (ready-to-load goods2 market1 level3) 5) 
    (= (loaded goods1 truck1 level2) 3) 
    (= (loaded goods1 truck2 level1) 4) 
    (= (at truck2 market3) 2) 
    (= (stored goods4 level0) 4) 
    (= (loaded goods6 truck2 level3) 3) 
    (= (ready-to-load goods4 market1 level2) 1) 
    (= (on-sale goods6 market1 level0) 5) 
    (= (ready-to-load goods2 market3 level1) 2) 
    (= (ready-to-load goods2 market1 level1) 1) 
 )
 (:bound 33)
 )
