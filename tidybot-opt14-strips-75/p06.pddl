(define 
  ...
  (:init 
   ...
   (object-pos object2 x1 y4)
   (object-pos object3 x1 y6)
 ...
 (:utility 
    ...
    (= (base-pos pr2 x3 y8) 4) 
    (= (base-obstacle x1 y5) 1) 
    (= (base-obstacle x2 y1) 2) 
    (= (gripper-obstacle x3 y4) 5) 
    (= (cart-pos cart x5 y7) 2) 
    (= (gripper-obstacle x7 y5) 5) 
    (= (cart-pos cart x1 y3) 2) 
    (= (base-pos pr2 x1 y3) 3) 
    (= (base-obstacle x8 y4) 1) 
    (= (base-pos pr2 x5 y5) 1) 
    (= (base-obstacle x1 y3) 1) 
    (= (gripper-obstacle x6 y0) 3) 
    (= (object-pos object1 x5 y2) 4) 
    (= (base-pos pr2 x8 y2) 3) 
    (= (cart-pos cart x7 y2) 5) 
    (= (gripper-obstacle x1 y8) 2) 
    (= (on-cart object1 cart) 3) 
    (= (base-obstacle x2 y0) 4) 
    (= (base-obstacle x5 y6) 4) 
 )
 (:bound 48)
 )
