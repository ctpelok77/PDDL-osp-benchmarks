(define 
  ...
  (:init 
   ...
   (object-goal object1 x3 y5)
   (object-goal object2 x4 y4)
   (object-goal object3 x4 y5)
   (object-goal object3 x2 y1)
   ...
   (object-pos object1 x2 y1)
   (object-pos object2 x3 y5)
 ...
 (:utility 
    ...
    (= (object-pos object0 x4 y5) 1) 
    (= (base-pos pr2 x1 y5) 3) 
    (= (base-obstacle x6 y8) 5) 
    (= (base-obstacle x2 y6) 5) 
    (= (base-pos pr2 x4 y8) 3) 
    (= (cart-pos cart x2 y7) 4) 
    (= (gripper-obstacle x6 y4) 1) 
    (= (base-pos pr2 x3 y7) 2) 
    (= (cart-pos cart x5 y4) 2) 
    (= (base-pos pr2 x5 y2) 3) 
    (= (base-obstacle x4 y3) 2) 
    (= (base-obstacle x2 y3) 2) 
    (= (cart-pos cart x5 y7) 1) 
    (= (object-pos object2 x5 y1) 4) 
    (= (cart-pos cart x2 y2) 3) 
    (= (object-pos object2 x3 y5) 5) 
    (= (base-obstacle x5 y5) 1) 
    (= (base-pos pr2 x4 y3) 4) 
 )
 (:bound 52)
 )
