(define 
 ...
 (:utility 
    ...
    (= (gripper-obstacle x1 y1) 5) 
    (= (base-pos pr2 x0 y7) 4) 
    (= (base-obstacle x0 y8) 3) 
    (= (gripper-obstacle x0 y5) 2) 
    (= (base-obstacle x6 y5) 3) 
    (= (base-pos pr2 x8 y8) 1) 
    (= (base-obstacle x2 y4) 2) 
    (= (base-pos pr2 x3 y7) 4) 
    (= (on-cart object1 cart) 4) 
    (= (gripper-obstacle x7 y3) 1) 
    (= (gripper-obstacle x4 y5) 3) 
    (= (base-obstacle x0 y5) 2) 
    (= (base-pos pr2 x4 y2) 5) 
    (= (object-pos object0 x5 y3) 2) 
    (= (gripper-obstacle x5 y5) 5) 
    (= (base-pos pr2 x6 y6) 5) 
    (= (cart-pos cart x8 y1) 1) 
    (= (cart-pos cart x6 y8) 3) 
 )
 (:bound 28)
 )
