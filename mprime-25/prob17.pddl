(define (problem strips-mprime-x-17)
 ...
 (:utility 
    (= (craves abrasion wonderbread) 10) 
    (= (craves achievement haroset) 2) 
    (= (craves boils-1 endive) 3) 
    (= (craves hangover yogurt) 4) 
    (= (craves laceration-8 mutton) 1) 
    (= (craves jealousy shrimp) 1) 
    (= (craves entertainment yogurt) 4) 
    (= (fears angina lubricity) 3) 
    (= (craves satisfaction potato) 1) 
    (= (craves anger yogurt) 2) 
    (= (craves intoxication rice) 3) 
    (= (fears boils intoxication) 3) 
    (= (fears anxiety entertainment) 5) 
    (= (fears abrasion rest) 5) 
    (= (craves anxiety endive) 3) 
    (= (fears boils-1 satisfaction) 2) 
    (= (craves jealousy turkey) 3) 
    (= (craves love marzipan) 5) 
    (= (fears grief achievement) 4) 
    (= (craves prostatitis turkey) 5) 
    (= (locale marzipan goias) 3) 
    (= (fears jealousy-2 entertainment) 3) 
    (= (fears abrasion-4 rest) 5) 
    (= (craves anxiety mutton) 4) 
    (= (locale onion alsace) 1) 
    (= (craves grief onion) 1) 
    (= (craves abrasion turkey) 4) 
    (= (locale wurst bosnia) 4) 
    (= (craves satisfaction endive) 5) 
    (= (craves jealousy wurst) 1) 
    (= (craves abrasion endive) 2) 
    (= (craves satiety wurst) 5) 
    (= (craves boils-1 onion) 4) 
    (= (craves rest turkey) 1) 
    (= (craves laceration haroset) 4) 
    (= (craves dread yogurt) 2) 
    (= (fears laceration-8 satisfaction) 1) 
    (= (craves love wonderbread) 5) 
    (= (fears hangover intoxication) 2) 
 )
 (:bound 1)
 )
