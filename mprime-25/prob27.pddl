(define (problem strips-mprime-x-27)
 ...
 (:utility 
    (= (craves grief guava) 10) 
    (= (craves boils guava) 10) 
    (= (locale scallion quebec) 4) 
    (= (locale scallion bavaria) 5) 
    (= (locale pork arizona) 4) 
    (= (locale scallion manitoba) 5) 
    (= (harmony love uranus) 2) 
    (= (locale guava moravia) 1) 
    (= (locale muffin bavaria) 2) 
    (= (locale scallion guanabara) 3) 
    (= (harmony satisfaction earth) 1) 
 )
 (:bound 1)
 )
