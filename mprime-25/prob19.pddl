(define (problem strips-mprime-x-19)
 ...
 (:utility 
    ...
    (= (craves learning lamb) 1) 
    (= (fears laceration achievement) 1) 
    (= (locale cantelope manitoba) 3) 
    (= (locale bacon oregon) 3) 
    (= (craves sciatica cantelope) 2) 
    (= (craves laceration marzipan) 1) 
    (= (craves anger bacon) 5) 
    (= (craves loneliness beef) 4) 
    (= (craves anxiety marzipan) 3) 
    (= (locale haroset goias) 4) 
    (= (craves grief beef) 2) 
    (= (craves sciatica bacon) 3) 
    (= (fears laceration aesthetics) 2) 
    (= (fears jealousy expectation) 2) 
    (= (fears laceration entertainment) 3) 
    (= (craves grief cantelope) 4) 
    (= (craves abrasion beef) 5) 
    (= (craves laceration tofu) 2) 
    (= (fears depression aesthetics) 5) 
    (= (craves boils beef) 1) 
    (= (craves anxiety flounder) 1) 
    (= (craves anxiety haroset) 3) 
    (= (harmony learning uranus) 4) 
    (= (craves anxiety lemon) 5) 
    (= (craves loneliness marzipan) 2) 
    (= (craves lubricity lamb) 5) 
    (= (craves anger cantelope) 4) 
    (= (craves lubricity flounder) 5) 
 )
 (:bound 1)
 )
