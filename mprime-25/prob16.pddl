(define (problem strips-mprime-x-16)
 ...
 (:utility 
    ...
    (= (locale guava bosnia) 3) 
    (= (harmony satiety earth) 2) 
    (= (craves angina guava) 2) 
    (= (locale chicken manitoba) 1) 
    (= (locale chocolate alsace) 4) 
    (= (craves achievement baguette) 4) 
    (= (craves boils baguette) 2) 
    (= (craves angina bacon) 4) 
    (= (craves achievement pepper) 5) 
    (= (craves prostatitis pepper) 1) 
    (= (locale wonderbread manitoba) 5) 
    (= (craves triumph bacon) 5) 
    (= (craves learning chocolate) 1) 
    (= (locale rice bosnia) 1) 
    (= (craves learning arugula) 4) 
    (= (craves excitement bacon) 3) 
 )
 (:bound 1)
 )
