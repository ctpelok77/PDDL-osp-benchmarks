...
(define (problem p154-microban-sequential)
 ...
 (:utility 
    ...
    (= (clear pos-28-03) 3) 
    (= (clear pos-17-10) 1) 
    (= (at stone-01 pos-03-13) 2) 
    (= (clear pos-28-13) 5) 
    (= (at player-01 pos-14-08) 4) 
    (= (at player-01 pos-19-08) 5) 
    (= (at player-01 pos-14-14) 5) 
    (= (at player-01 pos-20-10) 3) 
    (= (at player-01 pos-12-16) 4) 
    (= (at player-01 pos-27-16) 2) 
    (= (clear pos-12-16) 1) 
    (= (clear pos-20-16) 4) 
    (= (at player-01 pos-13-14) 5) 
    (= (clear pos-05-11) 1) 
    (= (at player-01 pos-28-11) 3) 
    (= (at player-01 pos-07-04) 2) 
    (= (at player-01 pos-18-06) 2) 
    (= (clear pos-06-04) 3) 
    (= (clear pos-26-08) 4) 
    (= (at player-01 pos-03-02) 2) 
    (= (at player-01 pos-22-16) 1) 
 )
 (:bound 2)
 (:use-cost-metric)
 )
