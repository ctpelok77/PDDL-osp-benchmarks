...
(define (problem p118-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-03) 10) 
    (= (at-goal stone-04) 10) 
    (= (at stone-02 pos-05-03) 3) 
    (= (at player-01 pos-07-06) 1) 
    (= (clear pos-05-02) 5) 
    (= (at player-01 pos-04-08) 4) 
    (= (at stone-02 pos-03-02) 4) 
    (= (at player-01 pos-08-09) 1) 
    (= (at stone-02 pos-02-04) 1) 
    (= (at stone-04 pos-08-09) 2) 
    (= (clear pos-05-08) 2) 
    (= (clear pos-10-09) 3) 
    (= (at stone-03 pos-09-06) 5) 
    (= (at stone-04 pos-05-09) 4) 
 )
 (:bound 44)
 (:use-cost-metric)
 )
