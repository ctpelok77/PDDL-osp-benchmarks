...
(define (problem p128-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-03) 10) 
    (= (at-goal stone-04) 10) 
    (= (at player-01 pos-09-02) 4) 
    (= (at stone-04 pos-10-02) 5) 
    (= (at stone-03 pos-04-03) 1) 
    (= (at stone-04 pos-05-04) 3) 
    (= (clear pos-04-04) 2) 
    (= (at stone-02 pos-08-03) 1) 
    (= (at stone-02 pos-05-06) 2) 
    (= (at stone-04 pos-05-06) 3) 
    (= (at stone-02 pos-02-03) 5) 
 )
 (:bound 19)
 (:use-cost-metric)
 )
