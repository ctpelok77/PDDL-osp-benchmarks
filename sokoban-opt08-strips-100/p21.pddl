...
(define (problem p107-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-10) 10) 
    (= (at-goal stone-11) 10) 
    (= (at stone-05 pos-4-2) 5) 
    (= (at stone-07 pos-3-5) 3) 
    (= (at stone-02 pos-4-5) 1) 
    (= (at stone-04 pos-3-6) 1) 
    (= (at player-01 pos-2-2) 4) 
    (= (at player-01 pos-5-3) 5) 
    (= (at stone-10 pos-2-6) 4) 
    (= (at stone-02 pos-7-5) 2) 
    (= (at stone-09 pos-5-2) 5) 
    (= (at stone-10 pos-2-2) 1) 
    (= (at stone-09 pos-7-2) 5) 
    (= (at stone-02 pos-7-7) 4) 
    (= (at stone-08 pos-6-2) 3) 
    (= (at stone-09 pos-6-5) 1) 
    (= (at stone-10 pos-3-5) 3) 
    (= (at stone-03 pos-6-2) 3) 
    (= (at player-01 pos-5-4) 4) 
    (= (at stone-08 pos-7-2) 5) 
    (= (at stone-02 pos-6-5) 2) 
    (= (at stone-02 pos-2-2) 2) 
    (= (at stone-06 pos-6-5) 1) 
    (= (at stone-04 pos-4-7) 2) 
    (= (at stone-03 pos-3-5) 3) 
 )
 (:bound 10)
 (:use-cost-metric)
 )
