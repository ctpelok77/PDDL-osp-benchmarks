...
(define (problem p096-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-02) 10) 
    (= (at-goal stone-03) 10) 
    (= (at stone-02 pos-06-10) 4) 
    (= (at stone-03 pos-07-09) 1) 
    (= (at stone-03 pos-06-02) 2) 
    (= (clear pos-08-06) 4) 
    (= (clear pos-11-01) 3) 
    (= (at stone-03 pos-06-07) 5) 
    (= (at player-01 pos-05-03) 1) 
    (= (at stone-03 pos-07-02) 2) 
    (= (at stone-03 pos-07-03) 3) 
 )
 (:bound 37)
 (:use-cost-metric)
 )
