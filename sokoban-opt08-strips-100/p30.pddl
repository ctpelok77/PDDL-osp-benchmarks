...
(define (problem p146-microban-sequential)
 ...
 (:utility 
    ...
    (= (at-goal stone-11) 10) 
    (= (at-goal stone-12) 10) 
    (= (at stone-01 pos-6-3) 2) 
    (= (at stone-02 pos-4-5) 3) 
    (= (at stone-02 pos-5-5) 3) 
    (= (at stone-09 pos-8-6) 2) 
    (= (at stone-03 pos-8-7) 3) 
    (= (at stone-08 pos-4-8) 3) 
    (= (at stone-10 pos-7-6) 1) 
    (= (at stone-09 pos-7-6) 4) 
    (= (at stone-06 pos-6-2) 5) 
    (= (at stone-01 pos-3-5) 4) 
    (= (at stone-01 pos-7-8) 5) 
    (= (at stone-06 pos-7-6) 2) 
    (= (at stone-11 pos-6-2) 4) 
    (= (at stone-04 pos-7-7) 2) 
    (= (at stone-09 pos-7-2) 5) 
    (= (at stone-12 pos-5-4) 2) 
    (= (at stone-07 pos-3-6) 1) 
    (= (at stone-03 pos-2-7) 1) 
    (= (at stone-03 pos-5-4) 3) 
    (= (at stone-01 pos-5-7) 1) 
    (= (at stone-11 pos-3-5) 1) 
    (= (at stone-09 pos-4-6) 4) 
    (= (at stone-03 pos-3-2) 4) 
    (= (at stone-05 pos-3-7) 2) 
    (= (at stone-05 pos-6-7) 5) 
    (= (at stone-04 pos-8-4) 4) 
    (= (at stone-02 pos-2-4) 5) 
    (= (at stone-02 pos-3-4) 5) 
    (= (at stone-10 pos-5-2) 3) 
    (= (at stone-07 pos-7-5) 3) 
    (= (at stone-12 pos-4-6) 1) 
 )
 (:bound 14)
 (:use-cost-metric)
 )
