(define (problem p03-652)
 ...
 (:utility 
    ...
    (= (robot-at robot2 tile_2-3) 3) 
    (= (painted tile_4-4 black) 5) 
    (= (robot-at robot1 tile_5-5) 5) 
    (= (robot-at robot1 tile_2-4) 1) 
    (= (robot-at robot1 tile_3-3) 4) 
    (= (painted tile_0-5 black) 2) 
    (= (robot-at robot2 tile_3-1) 1) 
 )
 (:bound 138)
 (:use-cost-metric)
 )
