(define 
 ...
 (:utility 
    ...
    (= (cart-pos cart x1 y7) 3) 
    (= (gripper-obstacle x5 y3) 4) 
    (= (gripper-obstacle x6 y4) 5) 
    (= (base-obstacle x3 y3) 2) 
    (= (base-obstacle x1 y2) 1) 
    (= (base-obstacle x1 y0) 4) 
    (= (gripper-obstacle x0 y1) 5) 
    (= (object-pos object0 x4 y2) 1) 
    (= (cart-pos cart x0 y0) 2) 
    (= (object-pos object3 x4 y3) 3) 
    (= (cart-pos cart x3 y5) 5) 
    (= (base-obstacle x7 y5) 3) 
    (= (base-obstacle x0 y2) 4) 
    (= (gripper-rel pr2 xrel0 yrel-1) 1) 
 )
 (:bound 7)
 )
