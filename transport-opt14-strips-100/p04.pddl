...
(define (problem transport-city-sequential-15nodes-1000size-3degree-100mindistance-3trucks-5packages-2014seed)
 ...
 (:utility 
    (= (at package-1 city-loc-11) 10) 
    (= (at package-2 city-loc-10) 10) 
    (= (at package-3 city-loc-5) 10) 
    (= (at package-4 city-loc-12) 10) 
    (= (at package-5 city-loc-9) 10) 
    (= (at truck-1 city-loc-2) 2) 
    (= (capacity truck-2 capacity-4) 1) 
    (= (at truck-2 city-loc-11) 1) 
    (= (capacity truck-2 capacity-1) 5) 
    (= (at truck-2 city-loc-13) 2) 
    (= (in package-4 truck-1) 3) 
    (= (at package-1 city-loc-5) 4) 
 )
 (:bound 250)
 (:use-cost-metric)
 )
