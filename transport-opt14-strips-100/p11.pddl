...
(define (problem transport-two-cities-sequential-18nodes-1000size-4degree-100mindistance-3trucks-6packages-2014seed)
 ...
 (:utility 
    ...
    (= (at package-2 city-2-loc-2) 10) 
    (= (at package-3 city-2-loc-4) 10) 
    (= (at package-4 city-2-loc-8) 10) 
    (= (at package-5 city-2-loc-2) 10) 
    (= (at package-6 city-2-loc-13) 10) 
    (= (at package-5 city-2-loc-9) 3) 
    (= (at truck-3 city-2-loc-14) 4) 
    (= (at package-1 city-2-loc-1) 2) 
    (= (at package-4 city-1-loc-11) 1) 
    (= (at package-6 city-1-loc-9) 4) 
    (= (at package-6 city-1-loc-16) 4) 
    (= (in package-6 truck-1) 1) 
    (= (at package-2 city-2-loc-9) 2) 
    (= (at truck-3 city-2-loc-5) 2) 
    (= (capacity truck-2 capacity-0) 5) 
    (= (at package-4 city-2-loc-2) 1) 
    (= (at package-5 city-1-loc-17) 5) 
    (= (at truck-2 city-1-loc-7) 3) 
    (= (at package-6 city-1-loc-14) 5) 
    (= (at package-2 city-2-loc-4) 1) 
    (= (at package-5 city-2-loc-6) 4) 
    (= (at package-4 city-1-loc-12) 3) 
 )
 (:bound 1745)
 (:use-cost-metric)
 )
