...
(define (problem transport-three-cities-sequential-10nodes-1000size-2degree-100mindistance-2trucks-4packages-2014seed)
 ...
 (:utility 
    ...
    (= (at package-3 city-3-loc-5) 10) 
    (= (at package-4 city-3-loc-10) 10) 
    (= (at package-4 city-1-loc-4) 5) 
    (= (at truck-2 city-2-loc-8) 2) 
    (= (at package-2 city-1-loc-5) 5) 
    (= (at package-1 city-1-loc-3) 1) 
    (= (at package-4 city-3-loc-6) 1) 
    (= (at package-2 city-3-loc-9) 2) 
    (= (at truck-2 city-2-loc-3) 3) 
    (= (at package-1 city-1-loc-4) 3) 
    (= (at package-4 city-1-loc-8) 4) 
 )
 (:bound 526)
 (:use-cost-metric)
 )
