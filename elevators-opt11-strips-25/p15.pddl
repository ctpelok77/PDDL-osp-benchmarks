...
(= (total-cost) 0)
 ...
 (:utility 
    (= (passenger-at p0 n6) 10) 
    (= (passenger-at p1 n8) 10) 
    (= (passenger-at p2 n2) 10) 
    (= (passenger-at p3 n7) 10) 
    (= (passenger-at p4 n5) 10) 
    (= (passenger-at p5 n4) 10) 
    (= (passenger-at p6 n8) 10) 
    (= (boarded p4 slow0-0) 5) 
    (= (passengers slow1-0 n0) 2) 
    (= (passenger-at p5 n1) 4) 
    (= (passenger-at p3 n6) 1) 
    (= (passenger-at p0 n0) 3) 
 )
 (:bound 19)
 (:use-cost-metric)
 )
