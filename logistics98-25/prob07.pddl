(define (problem strips-log-x-7)
   ...
   (:init (obj package10)
          ...
          (at package1 city8-1))
 (:utility 
    (= (at package10 city9-1) 10) 
    (= (at package9 city9-2) 10) 
    (= (at package8 city1-2) 10) 
    (= (at package7 city5-1) 10) 
    (= (at package6 city10-2) 10) 
    (= (at package5 city7-1) 10) 
    (= (at package7 city2-1) 5) 
    (= (in package5 truck4) 2) 
    (= (at package10 city11-2) 1) 
    (= (at package7 city7-2) 3) 
    (= (at plane4 city1-2) 1) 
    (= (at package7 city9-2) 3) 
    (= (at package8 city7-1) 1) 
    (= (at plane6 city11-2) 3) 
    (= (at package6 city1-1) 5) 
    (= (in package2 truck1) 5) 
    (= (at package6 city7-2) 4) 
    (= (at package9 city5-1) 4) 
    (= (in package1 plane5) 2) 
    (= (at truck11 city11-1) 4) 
    (= (in package10 plane6) 3) 
    (= (at package8 city9-2) 2) 
    (= (at package1 city5-1) 4) 
    (= (at plane4 city5-2) 1) 
    (= (at package4 city11-2) 5) 
    (= (at plane1 city8-2) 5) 
    (= (in package4 truck8) 2) 
    (= (in package9 plane6) 1) 
    (= (at package2 city1-2) 4) 
 )
 (:bound 8)
 )
