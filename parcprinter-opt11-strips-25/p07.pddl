...
(:init
 ...
 (:utility 
    ...
    (= (location sheet3 colorcontainer_exittoime-colorprinter_entry) 5) 
    (= (location sheet2 finisher2_entry-finisher1_exit) 2) 
    (= (notprintedwith sheet4 front color) 3) 
    (= (notprintedwith sheet2 front color) 1) 
    (= (hasimage sheet5 back image-2) 4) 
    (= (hasimage sheet2 back image-2) 4) 
    (= (hasimage sheet3 back image-3) 2) 
