...
(:init
 ...
 (:utility 
    ...
    (= (notprintedwith sheet1 back black) 4) 
    (= (location sheet2 ube_entry-uc1_offramp) 1) 
    (= (notprintedwith sheet3 back color) 3) 
    (= (hasimage sheet3 front image-2) 2) 
    (= (notprintedwith sheet2 back black) 5) 
 )
 (:bound 173266)
 (:use-cost-metric)
 )
