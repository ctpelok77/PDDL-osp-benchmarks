...
(at_square square3 f1-1f)
 ...
 (:utility 
    ...
    (= (clear f1-2f) 10) 
    (= (clear f1-3f) 10) 
    (= (at_square square2 f2-0f) 1) 
    (= (at_right_l rightl0 f3-2f f2-2f f2-3f) 3) 
    (= (at_square square3 f1-2f) 3) 
    (= (at_right_l rightl0 f0-2f f1-2f f1-3f) 5) 
    (= (at_right_l rightl0 f1-1f f2-1f f2-0f) 5) 
    (= (at_right_l rightl0 f1-3f f1-2f f1-3f) 3) 
    (= (at_right_l rightl0 f2-1f f2-2f f1-2f) 2) 
    (= (at_right_l rightl0 f0-1f f0-2f f0-1f) 1) 
    (= (at_right_l rightl0 f2-0f f1-0f f0-0f) 4) 
    (= (at_right_l rightl0 f2-2f f1-2f f2-2f) 5) 
    (= (at_square square0 f0-1f) 2) 
 )
 (:bound 5)
 (:use-cost-metric)
 )
