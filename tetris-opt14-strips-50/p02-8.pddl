(define (problem Tetris-8-4-888467)
(:domain tetris)
(:objects  
...
(at_square square2 f3-2f)
 ...
 (:utility 
    ...
    (= (at_right_l rightl1 f6-1f f6-2f f5-2f) 1) 
    (= (at_right_l rightl0 f5-1f f5-2f f5-3f) 4) 
    (= (at_right_l rightl0 f6-3f f6-2f f5-2f) 5) 
    (= (at_right_l rightl0 f4-3f f4-2f f5-2f) 3) 
    (= (clear f6-2f) 3) 
    (= (at_two straight0 f3-0f f3-1f) 1) 
    (= (at_right_l rightl0 f1-2f f1-1f f1-2f) 3) 
    (= (at_right_l rightl0 f7-1f f7-2f f7-3f) 4) 
    (= (at_right_l rightl1 f6-0f f6-1f f6-0f) 5) 
    (= (at_right_l rightl1 f2-1f f3-1f f3-0f) 1) 
    (= (at_right_l rightl0 f2-1f f2-2f f2-1f) 4) 
    (= (at_right_l rightl1 f3-2f f3-1f f3-2f) 5) 
    (= (at_right_l rightl0 f6-0f f7-0f f6-0f) 4) 
    (= (at_right_l rightl0 f5-2f f5-1f f5-0f) 5) 
    (= (clear f6-0f) 2) 
    (= (at_right_l rightl0 f2-0f f2-1f f2-0f) 2) 
    (= (at_right_l rightl1 f3-3f f4-3f f3-3f) 1) 
    (= (at_right_l rightl0 f7-3f f7-2f f6-2f) 4) 
    (= (at_right_l rightl1 f3-1f f4-1f f5-1f) 1) 
    (= (at_right_l rightl0 f0-1f f0-2f f1-2f) 5) 
    (= (at_two straight0 f5-2f f5-1f) 2) 
    (= (at_square square1 f2-1f) 3) 
    (= (at_right_l rightl0 f0-0f f1-0f f1-1f) 5) 
    (= (at_square square2 f0-2f) 1) 
    (= (at_right_l rightl1 f5-0f f5-1f f6-1f) 2) 
    (= (at_two straight0 f5-0f f6-0f) 2) 
    (= (at_right_l rightl1 f1-0f f0-0f f0-1f) 4) 
    (= (at_right_l rightl1 f0-1f f1-1f f2-1f) 5) 
    (= (at_right_l rightl0 f5-1f f4-1f f4-0f) 5) 
    (= (at_right_l rightl1 f1-1f f1-2f f0-2f) 3) 
    (= (at_right_l rightl0 f1-3f f1-2f f1-1f) 3) 
    (= (at_right_l rightl1 f5-1f f6-1f f5-1f) 4) 
    (= (at_right_l rightl0 f3-1f f3-0f f4-0f) 1) 
    (= (at_right_l rightl1 f0-2f f1-2f f1-3f) 4) 
    (= (at_right_l rightl1 f0-1f f0-0f f1-0f) 5) 
    (= (at_right_l rightl0 f6-2f f5-2f f5-1f) 3) 
    (= (at_right_l rightl0 f3-3f f2-3f f2-2f) 3) 
    (= (at_right_l rightl0 f6-1f f5-1f f5-2f) 5) 
    (= (at_two straight0 f1-2f f0-2f) 1) 
    (= (at_right_l rightl1 f6-2f f6-3f f5-3f) 1) 
    (= (at_right_l rightl1 f2-2f f3-2f f2-2f) 2) 
    (= (at_two straight0 f7-1f f6-1f) 1) 
    (= (at_right_l rightl0 f3-2f f4-2f f4-3f) 2) 
    (= (at_right_l rightl0 f5-2f f5-1f f6-1f) 2) 
    (= (at_right_l rightl1 f1-2f f0-2f f1-2f) 4) 
 )
 (:bound 19)
 (:use-cost-metric)
 )
