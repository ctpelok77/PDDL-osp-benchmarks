(define (problem Tetris-4-4-2565673)
(:domain tetris)
(:objects  
...
(at_square square0 f0-0f)
 ...
 (:utility 
    ...
    (= (clear f1-3f) 10) 
    (= (clear f3-3f) 5) 
    (= (at_right_l rightl0 f0-3f f1-3f f1-2f) 1) 
    (= (clear f3-0f) 3) 
    (= (at_two straight0 f1-1f f1-2f) 2) 
    (= (at_right_l rightl0 f1-3f f0-3f f0-2f) 5) 
    (= (at_square square0 f3-3f) 2) 
    (= (at_right_l rightl0 f0-1f f0-2f f0-1f) 2) 
    (= (at_right_l rightl0 f2-1f f3-1f f3-2f) 3) 
    (= (at_two straight0 f2-1f f3-1f) 1) 
    (= (at_right_l rightl0 f1-2f f1-3f f0-3f) 3) 
    (= (at_right_l rightl0 f1-2f f1-3f f2-3f) 5) 
 )
 (:bound 5)
 (:use-cost-metric)
 )
