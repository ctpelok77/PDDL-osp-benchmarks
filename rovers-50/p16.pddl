...
(:init
 ...
 (:utility 
    ...
    (= (have_image rover2 objective0 high_res) 2) 
    (= (communicated_image_data objective3 low_res) 3) 
    (= (at rover0 waypoint2) 5) 
    (= (have_image rover0 objective1 high_res) 3) 
    (= (have_image rover2 objective3 high_res) 1) 
    (= (at rover1 waypoint0) 5) 
    (= (have_image rover2 objective3 low_res) 4) 
