(define (problem prob)
 ...
 (:utility 
    (= (contains shot1 cocktail4) 10) 
    (= (contains shot2 cocktail2) 10) 
    (= (contains shot3 cocktail3) 10) 
    (= (contains shot4 cocktail1) 10) 
    (= (contains shot5 cocktail5) 10) 
    (= (ontable shot3) 2) 
    (= (used shot3 ingredient2) 1) 
    (= (used shot5 ingredient3) 5) 
    (= (contains shot3 ingredient1) 4) 
    (= (holding left shot2) 3) 
 )
 (:bound 84)
 (:use-cost-metric)
 )
