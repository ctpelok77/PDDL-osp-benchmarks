(define (problem prob)
 ...
 (:utility 
    (= (contains shot1 cocktail2) 10) 
    (= (contains shot2 cocktail1) 10) 
    (= (contains shot3 cocktail3) 10) 
    (= (contains shot4 cocktail4) 10) 
    (= (used shot3 ingredient3) 4) 
    (= (contains shot3 cocktail2) 2) 
    (= (contains shot2 ingredient1) 5) 
    (= (contains shot4 cocktail1) 1) 
 )
 (:bound 60)
 (:use-cost-metric)
 )
