(define (problem prob)
 ...
 (:utility 
    (= (contains shot1 cocktail7) 10) 
    (= (contains shot2 cocktail6) 10) 
    (= (contains shot3 cocktail3) 10) 
    (= (contains shot4 cocktail2) 10) 
    (= (contains shot5 cocktail4) 10) 
    (= (contains shot6 cocktail1) 10) 
    (= (contains shot7 cocktail5) 10) 
    (= (contains shot8 cocktail3) 10) 
    (= (shaker-level shaker1 l0) 4) 
    (= (contains shot8 cocktail1) 2) 
    (= (contains shot3 cocktail7) 5) 
    (= (clean shot8) 3) 
    (= (contains shot5 cocktail6) 3) 
    (= (contains shot8 cocktail7) 2) 
    (= (contains shot6 cocktail3) 1) 
    (= (contains shot4 ingredient3) 1) 
 )
 (:bound 118)
 (:use-cost-metric)
 )
