(define (problem prob)
 ...
 (:utility 
    (= (contains shot1 cocktail6) 10) 
    (= (contains shot2 cocktail1) 10) 
    (= (contains shot3 cocktail7) 10) 
    (= (contains shot4 cocktail4) 10) 
    (= (contains shot5 cocktail2) 10) 
    (= (contains shot6 cocktail3) 10) 
    (= (contains shot7 cocktail5) 10) 
    (= (contains shot8 cocktail1) 10) 
    (= (clean shot4) 2) 
    (= (clean shot5) 2) 
    (= (contains shot8 cocktail3) 3) 
    (= (contains shot4 cocktail2) 5) 
    (= (empty shot7) 1) 
    (= (contains shaker1 cocktail5) 4) 
    (= (holding right shot2) 1) 
    (= (holding left shot5) 5) 
 )
 (:bound 119)
 (:use-cost-metric)
 )
