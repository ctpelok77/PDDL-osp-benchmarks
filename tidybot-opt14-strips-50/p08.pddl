(define 
 ...
 (:utility 
    ...
    (= (cart-pos cart x1 y7) 4) 
    (= (base-pos pr2 x3 y8) 2) 
    (= (base-pos pr2 x8 y0) 1) 
    (= (base-pos pr2 x4 y3) 3) 
    (= (gripper-obstacle x7 y3) 5) 
    (= (cart-pos cart x8 y0) 5) 
    (= (base-obstacle x1 y2) 3) 
    (= (base-obstacle x1 y6) 1) 
    (= (base-obstacle x3 y1) 3) 
    (= (cart-pos cart x4 y2) 2) 
    (= (cart-pos cart x8 y1) 5) 
    (= (gripper-obstacle x4 y4) 1) 
    (= (gripper-obstacle x6 y0) 2) 
    (= (base-pos pr2 x6 y5) 4) 
    (= (gripper-obstacle x1 y7) 5) 
    (= (base-pos pr2 x6 y6) 2) 
    (= (base-obstacle x4 y1) 4) 
    (= (gripper-obstacle x6 y8) 3) 
 )
 (:bound 12)
 )
