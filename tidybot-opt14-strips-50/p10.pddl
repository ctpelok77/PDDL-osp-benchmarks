(define 
 ...
 (:utility 
    ...
    (= (cart-pos cart x2 y4) 3) 
    (= (base-pos pr2 x9 y4) 4) 
    (= (cart-pos cart x0 y4) 2) 
    (= (gripper-obstacle x5 y0) 2) 
    (= (gripper-obstacle x8 y0) 3) 
    (= (gripper-obstacle x5 y9) 2) 
    (= (gripper-obstacle x8 y8) 5) 
    (= (object-pos object3 x4 y1) 4) 
    (= (base-pos pr2 x5 y7) 3) 
    (= (object-pos object1 x7 y3) 4) 
    (= (base-pos pr2 x4 y8) 1) 
    (= (gripper-obstacle x6 y5) 5) 
    (= (base-pos pr2 x8 y7) 1) 
    (= (base-pos pr2 x9 y1) 3) 
    (= (base-pos pr2 x9 y9) 1) 
    (= (base-obstacle x9 y8) 1) 
    (= (cart-pos cart x9 y3) 1) 
    (= (base-obstacle x2 y7) 2) 
    (= (gripper-obstacle x8 y9) 5) 
    (= (cart-pos cart x4 y7) 5) 
    (= (cart-pos cart x7 y2) 2) 
    (= (gripper-obstacle x6 y2) 3) 
    (= (base-obstacle x9 y2) 5) 
 )
 (:bound 23)
 )
