(define (problem prob016)
 ...
 (:utility 
    ...
    (= (painted tile_3-4 white) 2) 
    (= (robot-at robot1 tile_1-2) 3) 
    (= (painted tile_6-1 white) 5) 
    (= (clear tile_2-1) 3) 
    (= (painted tile_1-2 white) 4) 
    (= (robot-at robot2 tile_1-1) 4) 
    (= (robot-at robot1 tile_0-5) 2) 
    (= (robot-at robot1 tile_0-2) 1) 
    (= (robot-at robot2 tile_5-5) 1) 
 )
 (:bound 99)
 (:use-cost-metric)
 )
