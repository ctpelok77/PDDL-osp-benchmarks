...
(:init
 ...
 (:utility 
    ...
    (= (visited loc-x0-y3) 10) 
    (= (visited loc-x0-y6) 10) 
    (= (visited loc-x0-y7) 10) 
    (= (visited loc-x0-y9) 10) 
    (= (visited loc-x1-y1) 10) 
    (= (visited loc-x1-y2) 10) 
    (= (visited loc-x1-y8) 10) 
    (= (visited loc-x1-y9) 10) 
    (= (visited loc-x2-y0) 10) 
    (= (visited loc-x2-y1) 10) 
    (= (visited loc-x2-y3) 10) 
    (= (visited loc-x2-y6) 10) 
    (= (visited loc-x2-y9) 10) 
    (= (visited loc-x2-y10) 10) 
    (= (visited loc-x3-y1) 10) 
    (= (visited loc-x3-y4) 10) 
    (= (visited loc-x3-y5) 10) 
    (= (visited loc-x3-y6) 10) 
    (= (visited loc-x3-y9) 10) 
    (= (visited loc-x3-y10) 10) 
    (= (visited loc-x4-y0) 10) 
    (= (visited loc-x4-y2) 10) 
    (= (visited loc-x4-y9) 10) 
    (= (visited loc-x4-y10) 10) 
    (= (visited loc-x5-y2) 10) 
    (= (visited loc-x5-y3) 10) 
    (= (visited loc-x5-y4) 10) 
    (= (visited loc-x5-y5) 10) 
    (= (visited loc-x5-y6) 10) 
    (= (visited loc-x5-y7) 10) 
    (= (visited loc-x5-y8) 10) 
    (= (visited loc-x5-y9) 10) 
    (= (visited loc-x6-y2) 10) 
    (= (visited loc-x6-y4) 10) 
    (= (visited loc-x6-y7) 10) 
    (= (visited loc-x6-y9) 10) 
    (= (visited loc-x6-y10) 10) 
    (= (visited loc-x7-y0) 10) 
    (= (visited loc-x7-y1) 10) 
    (= (visited loc-x7-y4) 10) 
    (= (visited loc-x7-y6) 10) 
    (= (visited loc-x7-y7) 10) 
    (= (visited loc-x7-y9) 10) 
    (= (visited loc-x8-y1) 10) 
    (= (visited loc-x8-y2) 10) 
    (= (visited loc-x9-y0) 10) 
    (= (visited loc-x9-y1) 10) 
    (= (visited loc-x9-y4) 10) 
    (= (visited loc-x9-y5) 10) 
    (= (visited loc-x9-y6) 10) 
    (= (visited loc-x9-y7) 10) 
    (= (visited loc-x9-y8) 10) 
    (= (visited loc-x10-y0) 10) 
    (= (visited loc-x10-y1) 10) 
    (= (visited loc-x10-y5) 10) 
    (= (visited loc-x10-y8) 10) 
    (= (visited loc-x10-y10) 10) 
    (= (visited loc-x6-y6) 4) 
    (= (visited loc-x10-y3) 3) 
    (= (visited loc-x8-y6) 4) 
    (= (visited loc-x6-y5) 2) 
    (= (at-robot loc-x9-y1) 3) 
    (= (visited loc-x10-y4) 1) 
    (= (at-robot loc-x7-y6) 5) 
    (= (visited loc-x0-y4) 5) 
    (= (at-robot loc-x0-y2) 1) 
 )
 (:bound 76)
 )
