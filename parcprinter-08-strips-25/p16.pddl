...
(:init
 ...
 (:utility 
    ...
    (= (location sheet1 ube_entry-uc1_offramp) 4) 
    (= (location sheet6 ube_entry-uc1_offramp) 4) 
    (= (location sheet2 uc2_exit-om_topentry) 1) 
    (= (location sheet1 rh1_entry-rh2_exit) 4) 
    (= (stackedin sheet4 sys_outputtray) 5) 
    (= (location sheet3 ure_entry-uc2_offramp) 3) 
    (= (sideup sheet3 back) 5) 
    (= (hasimage sheet6 front image-4) 2) 
    (= (location sheet5 ure_entry-uc2_offramp) 2) 
