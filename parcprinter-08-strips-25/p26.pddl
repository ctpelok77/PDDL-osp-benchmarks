...
(:init
 ...
 (:utility 
    ...
    (= (hasimage sheet1 front image-4) 5) 
    (= (location sheet2 some_finisher_tray) 3) 
    (= (location sheet6 lc1_entryfromime-lime_exit) 1) 
    (= (hasimage sheet2 back image-1) 2) 
    (= (hasimage sheet4 front image-5) 1) 
    (= (hasimage sheet1 back image-1) 4) 
    (= (location sheet1 lc1_entry-hw1_bottomleftexit) 2) 
    (= (hasimage sheet4 back image-5) 5) 
