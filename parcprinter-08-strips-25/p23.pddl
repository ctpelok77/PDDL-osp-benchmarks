...
(:init
 ...
 (:utility 
    ...
    (= (location sheet3 lc1_entry-hw1_bottomleftexit) 4) 
    (= (location sheet1 hw1_rightexit-sys_entry) 1) 
    (= (location sheet2 hw1_toprightentry-uc1_exit) 2) 
    (= (hasimage sheet2 back image-3) 3) 
 )
 (:bound 129808)
 (:use-cost-metric)
 )
