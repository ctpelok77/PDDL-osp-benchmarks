(define (problem prob)
 ...
 (:utility 
    ...
    (= (contains shot4 cocktail7) 10) 
    (= (contains shot5 cocktail2) 10) 
    (= (contains shot6 cocktail5) 10) 
    (= (contains shot7 cocktail4) 10) 
    (= (contains shot8 cocktail5) 10) 
    (= (used shot5 ingredient2) 1) 
    (= (contains shot9 cocktail1) 3) 
    (= (shaked shaker1) 5) 
    (= (clean shot1) 3) 
    (= (contains shot2 cocktail1) 2) 
    (= (clean shot7) 5) 
    (= (empty shot4) 4) 
    (= (contains shot6 ingredient3) 1) 
 )
 (:bound 165)
 (:use-cost-metric)
 )
