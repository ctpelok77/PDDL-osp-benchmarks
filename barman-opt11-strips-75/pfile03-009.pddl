(define (problem prob)
 ...
 (:utility 
    ...
    (= (contains shot5 cocktail2) 10) 
    (= (contains shot6 cocktail5) 4) 
    (= (used shot6 ingredient3) 2) 
    (= (holding right shaker1) 3) 
    (= (contains shot6 ingredient3) 5) 
    (= (shaker-level shaker1 l0) 1) 
 )
 (:bound 125)
 (:use-cost-metric)
 )
